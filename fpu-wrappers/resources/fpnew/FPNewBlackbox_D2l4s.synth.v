...
module \$paramod$1676dce864d6cda67593db3429a82f0f4bb60067\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
...
module \$paramod$194e0b1344c64ac894d3e715de23cd7b3a8561f0\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module \$paramod$4dffaaa76975fa9a810a1a53bbd409e4982e6ede\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D2l4s.preprocessed.v:327$476.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D2l4s.preprocessed.v:327$477.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D2l4s.preprocessed.v:347$474.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D2l4s.preprocessed.v:347$475.inp ;
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D2l4s.preprocessed.v:327$476.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D2l4s.preprocessed.v:327$477.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D2l4s.preprocessed.v:347$474.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D2l4s.preprocessed.v:347$475.inp  = 2'hx;
endmodule
...
module \$paramod$62b97f2c24fbd0ec64efd8c0255d5867594e9cd9\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:149$564.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:149$565.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$548.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$549.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$558.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$559.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$560.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$561.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$562.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$563.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$548.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$549.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$549.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$548.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$548.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$549.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:149$564.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:149$565.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$548.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$549.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$558.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$559.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$560.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$561.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$562.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l4s.preprocessed.v:169$563.inp  = 3'hx;
endmodule

module \$paramod$6df21e777e38b1c911958408dc4fd875e1749c59\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module \$paramod$ace0bb273e33e071db93037b00cf4a4ca66d7c53\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  \$paramod$194e0b1344c64ac894d3e715de23cd7b3a8561f0\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$1676dce864d6cda67593db3429a82f0f4bb60067\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$6df21e777e38b1c911958408dc4fd875e1749c59\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
...
module \$paramod$b98c969b385f9b76e90607a7264386a8d8d3ec7c\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  ...
  assign _067_ = ~ mid_pipe_valid_q[2];
  assign _068_ = ~ mid_pipe_valid_q[1];
  assign _069_ = ~ out_pipe_valid_q[1];
  assign in_ready_o = inp_pipe_ready[1] | _061_;
  assign mid_pipe_ready[1] = mid_pipe_ready[2] | _067_;
  assign inp_pipe_ready[1] = mid_pipe_ready[1] | _068_;
  ...
  assign _085_ = mid_pipe_ready[1] ? mid_pipe_valid_q[1] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _085_;
  assign _086_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;

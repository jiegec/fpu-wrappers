...
module \$paramod$32a9ce21dcdff4652f961a4328d348857701444d\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
module \$paramod$4dffaaa76975fa9a810a1a53bbd409e4982e6ede\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:327$532.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:327$533.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:347$530.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:347$531.inp ;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:327$532.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:327$533.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:347$530.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:347$531.inp  = 2'hx;
endmodule

module \$paramod$5fc8e36ef852e993af4743f062099315ab9e964f\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module \$paramod$62b97f2c24fbd0ec64efd8c0255d5867594e9cd9\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:149$620.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:149$621.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$604.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$605.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$614.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$615.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$616.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$617.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$618.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$619.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$604.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$605.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$605.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$604.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$604.$result [1:0], \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$605.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:149$620.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:149$621.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$604.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$605.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$614.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$615.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$616.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$617.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$618.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l4s.preprocessed.v:169$619.inp  = 3'hx;
endmodule

module \$paramod$847057edfcaa275c6d9605e2e01e7b012d93c69c\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module \$paramod$ace0bb273e33e071db93037b00cf4a4ca66d7c53\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$214.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$55.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:8042$230.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:8042$246.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:8042$262.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:8042$278.op ;
  ...
  assign _12_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$55.$result ;
  assign _13_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$55.$result  == 2'h1;
  assign _14_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$55.$result  == 2'h2;
  assign _15_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$55.$result  == 2'h3;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$55.$result  = _47_(2'h2, 6'h07, { _21_, _19_, _17_ });
  assign _21_ = | _20_;
  ...
  assign _22_ = _74_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$55.$result  +: 1];
  ...
  \$paramod$b0596b107e48a2781f760f3a65a064359e406575\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$847057edfcaa275c6d9605e2e01e7b012d93c69c\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$5fc8e36ef852e993af4743f062099315ab9e964f\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$32a9ce21dcdff4652f961a4328d348857701444d\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:7996$214.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:8042$230.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:8042$246.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:8042$262.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l4s.preprocessed.v:8042$278.op  = 4'hx;
...
module \$paramod$b0596b107e48a2781f760f3a65a064359e406575\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [135:0] arbiter_output;
...
, busy_o);
  ...
  assign _002_ = flush_i ? 1'h0 : _087_;
  assign _088_ = mid_pipe_ready[1] ? mid_pipe_valid_q[1] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _088_;
...
module \$paramod$e489c3953e0097259b4caf051da3f9a41b58bb35\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire [4:0] _00_;
  wire [4:0] _01_;
  output busy_o;
  wire busy_o;

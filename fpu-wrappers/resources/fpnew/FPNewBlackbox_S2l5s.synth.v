...
, busy_o);
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[30:23] }) + $signed({ 9'h000, _068_ });
  ...
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _113_ <= 7'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _113_ <= addend_shamt;
  assign mid_pipe_add_shamt_q[13:7] = _113_;
  reg [9:0] _114_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _114_ <= 10'h000;
    else if (\gen_inside_pipeline[0].reg_ena ) _114_ <= sv2v_tmp_B4C85;
  assign mid_pipe_tent_exp_q[19:10] = _114_;
  ...
  assign mid_pipe_exp_diff_q[19:10] = _117_;
  ...
  assign mid_pipe_exp_prod_q[19:10] = _121_;
  ...
  reg [31:0] _142_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _142_ <= 32'd0;
    else if (\gen_output_pipeline[0].reg_ena ) _142_ <= result_d;
  assign out_pipe_result_q[31:0] = _142_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[1].reg_ena ) _147_ <= mid_pipe_spec_res_q[63:32];
  assign mid_pipe_spec_res_q[31:0] = _147_;
  ...
  reg [75:0] _151_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _151_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[1].reg_ena ) _151_ <= mid_pipe_sum_q[151:76];
  assign mid_pipe_sum_q[75:0] = _151_;
  ...
  reg [6:0] _153_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _153_ <= 7'h00;
    else if (\gen_inside_pipeline[1].reg_ena ) _153_ <= mid_pipe_add_shamt_q[13:7];
  assign mid_pipe_add_shamt_q[6:0] = _153_;
  reg [9:0] _154_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _154_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _154_ <= mid_pipe_tent_exp_q[19:10];
  assign mid_pipe_tent_exp_q[9:0] = _154_;
  reg [9:0] _155_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _155_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _155_ <= mid_pipe_exp_diff_q[19:10];
  assign mid_pipe_exp_diff_q[9:0] = _155_;
  reg [9:0] _156_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _156_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _156_ <= mid_pipe_exp_prod_q[19:10];
  assign mid_pipe_exp_prod_q[9:0] = _156_;
  ...
  assign mid_pipe_spec_res_q[63:32] = _162_;
  ...
  reg [75:0] _166_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _166_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _166_ <= mid_pipe_sum_q[227:152];
  assign mid_pipe_sum_q[151:76] = _166_;
  ...
  assign _043_ = sum_raw[76] == tentative_sign;
  ...
  assign _047_ = $signed(exponent_difference) <= $signed(32'd4294967247);
  assign _048_ = $signed(exponent_difference) <= $signed(32'd26);
  assign _049_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd0);
  assign _050_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd2);
  ...
  assign _065_ = ~ inp_pipe_valid_q[2];
  assign _066_ = ~ inp_pipe_valid_q[1];
  assign _067_ = ~ inp_pipe_operands_q[31];
  assign _068_ = ~ info_c[7];
  assign _069_ = ~ addend_after_shift;
  assign _070_ = ~ sticky_before_add;
  assign _071_ = ~ sum_raw[76];
  assign _072_ = ~ mid_pipe_valid_q[1];
  assign _073_ = ~ mid_pipe_valid_q[2];
  assign _074_ = ~ out_pipe_valid_q[1];
  assign inp_pipe_ready[1] = inp_pipe_ready[2] | _065_;
  assign in_ready_o = inp_pipe_ready[1] | _066_;
  ...
  assign _016_ = _046_ ? sum_shifted[74:50] : { 1'h0, sum_shifted[74:51] };
  assign _020_ = _046_ ? { sum_shifted[49:0], 1'h0 } : sum_shifted[50:0];
  assign _015_ = _046_ ? _085_[9:0] : 10'h000;
  ...
  assign _009_ = _058_ ? _029_[9:0] : 10'h000;
  assign _008_ = _058_ ? _030_[6:0] : _031_[6:0];
  assign normalized_exponent = _063_ ? _009_ : mid_pipe_tent_exp_q[9:0];
  assign norm_shamt = _063_ ? _008_ : mid_pipe_add_shamt_q[6:0];
  assign _005_ = _048_ ? _083_[6:0] : 7'h00;
  assign addend_shamt = _047_ ? 7'h4c : _005_;
  assign _024_ = info_c[4] ? { operand_c[31], 31'h7f800000 } : 32'd2143289344;
  assign _023_ = _061_ ? { tentative_sign, 31'h7f800000 } : _024_;
  assign _022_ = _054_ ? 1'h1 : 1'h0;
  assign _021_ = _054_ ? 32'd2143289344 : _023_;
  ...
  assign special_result = _060_ ? 32'd2143289344 : _012_;
  function [0:0] _252_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign operand_a[31] = _252_(1'h1, { _067_, 1'h0, inp_pipe_operands_q[31] }, { _078_, _077_, _038_ });
  function [30:0] _253_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[22:0] } = _253_(31'h00800001, { 31'h3f800000, inp_pipe_operands_q[30:0] }, { _077_, _041_ });
  assign _010_ = _042_ ? 32'd0 : 32'd2147483648;
  ...
  assign operand_c = _257_(32'd2155872257, { _095_, inp_pipe_operands_q[94:64], _010_ }, { _039_, _076_ });
  assign operand_b = _040_ ? inp_pipe_operands_q[63:32] : 32'd2155872257;
  function [7:0] _259_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign _082_ = _027_ - 32'd127;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _083_ = $signed(32'd27) - $signed(exponent_difference);
  assign _084_ = $signed(mid_pipe_exp_prod_q[9:0]) - $signed({ 1'h0, leading_zero_count });
  ...
  assign { _088_[31:10], exponent_product } = _062_ ? 32'd4294967171 : _082_;
  ...
  assign { _089_[76], mid_pipe_sum_q[227:152] } = _055_ ? _064_ : sum_raw;
  ...
  assign { _093_[31:8], pre_round_abs[30:23] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign _095_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[2];
  ...
  assign _088_[9:0] = exponent_product;
  assign _089_[75:0] = mid_pipe_sum_q[227:152];
  assign _093_[7:0] = pre_round_abs[30:23];
...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:149$610.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:149$611.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$594.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$595.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$604.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$605.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$606.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$607.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$608.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$609.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$594.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$595.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$595.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$594.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:149$610.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:149$611.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$594.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$595.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$604.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$605.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$606.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$607.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$608.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:169$609.inp  = 3'hx;
endmodule
...
module \$paramod$829ef56d5fabd335ef3b4094b396e39334808d26\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
...
module \$paramod$ab1efca8a0cbeafc5bf81c45c518064b6d31017e\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$213.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$55.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8042$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8042$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8042$261.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8042$277.op ;
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$55.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$55.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$55.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$55.$result  == 2'h3;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$55.$result  = _42_(2'h2, 6'h07, { _18_, _16_, _14_ });
  ...
  wire [3:0] _65_ = opgrp_in_ready;
  assign _19_ = _65_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$55.$result  +: 1];
  ...
  \$paramod$829ef56d5fabd335ef3b4094b396e39334808d26\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$cb9467c37c4d1ac83063508f11ef334932f36dd4\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f58e7793fd81b00e91fdf6cfe000474c30af1eb6\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$c20500f8f6bcfe694fd0a0687290ce80d03567f0\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:7996$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8042$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8042$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8042$261.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8042$277.op  = 4'hx;
...
module \$paramod$c20500f8f6bcfe694fd0a0687290ce80d03567f0\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:327$522.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:327$523.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:347$520.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:347$521.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:327$522.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:327$523.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:347$520.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:347$521.inp  = 2'hx;
endmodule

module \$paramod$cb9467c37c4d1ac83063508f11ef334932f36dd4\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$e308f221f121699b77c199cfc7b13dbf3a9f0d99\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire [4:0] _00_;
  wire [4:0] _01_;
  output busy_o;
  wire busy_o;
...
module \$paramod$f58e7793fd81b00e91fdf6cfe000474c30af1eb6\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;

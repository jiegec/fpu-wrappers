...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:149$610.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:149$611.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$594.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$595.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$604.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$605.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$606.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$607.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$608.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$609.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$594.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$595.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$595.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$594.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:149$610.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:149$611.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$594.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$595.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$604.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$605.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$606.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$607.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$608.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:169$609.inp  = 3'hx;
endmodule
...
module \$paramod$3e69ae42a82eb627a459bb2c169150331a66d5b6\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$213.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$55.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:8042$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:8042$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:8042$261.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:8042$277.op ;
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$55.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$55.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$55.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$55.$result  == 2'h3;
  assign _18_ = | _17_;
  assign _14_ = | _13_;
  assign _16_ = | _15_;
  function [1:0] _41_;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$55.$result  = _41_(2'h2, 6'h07, { _18_, _16_, _14_ });
  ...
  assign _19_ = _64_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$55.$result  +: 1];
  ...
  \$paramod$e58322ab06873da189f7fd1e84ce34d279cd5080\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$e1fb9b5c918861a1f7d2f593c7ae6cbe7de856b0\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$bb671b4a7d5eb1798c3aa710bfda8c8989383bed\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$9946e8f22ff7fcaf9794e609c1a0fcf33d18a37c\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:7996$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:8042$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:8042$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:8042$261.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l2s.preprocessed.v:8042$277.op  = 4'hx;
...
, busy_o);
  ...
  assign _026_ = $signed(_075_) + $signed(32'd1);
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _099_ <= inp_pipe_tag_q[1:0];
  assign mid_pipe_tag_q[1:0] = _099_;
  ...
  reg [191:0] _101_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _101_ <= 192'h000000000000000000000000000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _101_ <= operands_i;
  assign inp_pipe_operands_q[191:0] = _101_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[0].reg_ena ) _103_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[2:0] = _103_;
  reg [2:0] _104_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _104_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _104_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[2:0] = _104_;
  reg [63:0] _105_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _105_ <= 64'h0000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _105_ <= special_result;
  assign mid_pipe_spec_res_q[63:0] = _105_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _107_ <= inp_pipe_rnd_mode_q[2:0];
  assign mid_pipe_rnd_mode_q[2:0] = _107_;
  ...
  reg [162:0] _109_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _109_ <= 163'h00000000000000000000000000000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _109_ <= mid_pipe_sum_q[325:163];
  assign mid_pipe_sum_q[162:0] = _109_;
  ...
  reg [7:0] _111_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _111_ <= 8'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _111_ <= addend_shamt;
  assign mid_pipe_add_shamt_q[7:0] = _111_;
  reg [12:0] _112_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _112_ <= 13'h0000;
    else if (\gen_inside_pipeline[0].reg_ena ) _112_ <= sv2v_tmp_B4C85;
  assign mid_pipe_tent_exp_q[12:0] = _112_;
  reg [12:0] _113_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _113_ <= 13'h0000;
    else if (\gen_inside_pipeline[0].reg_ena ) _113_ <= exponent_difference;
  assign mid_pipe_exp_diff_q[12:0] = _113_;
  reg [12:0] _114_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _114_ <= 13'h0000;
    else if (\gen_inside_pipeline[0].reg_ena ) _114_ <= exponent_product;
  assign mid_pipe_exp_prod_q[12:0] = _114_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[0].reg_ena ) _119_ <= tag_i;
  assign inp_pipe_tag_q[1:0] = _119_;
  ...
  reg [3:0] _121_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _121_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _121_ <= op_i;
  assign inp_pipe_op_q[3:0] = _121_;
  ...
  assign _031_ = | { inp_pipe_ready[1], flush_i };
  assign _032_ = | { _070_, _067_ };
  assign _033_ = | { _070_, _069_, _068_ };
  assign _034_ = | { _070_, _069_, _068_, _067_ };
  assign _035_ = | { _070_, _069_, _067_ };
  ...
  assign inp_pipe_ready[1] = out_ready_i | _065_;
  assign sticky_after_norm = _071_ | mid_pipe_sticky_q[1];
  assign regular_status[2] = of_before_round | of_after_round;
  assign _066_ = _072_ | of_before_round;
  assign regular_status[0] = _066_ | of_after_round;
  ...
  assign _012_ = _040_ ? _076_[12:0] : 13'h0000;
  ...
  assign _006_ = _052_ ? _026_[12:0] : 13'h0000;
  assign _005_ = _052_ ? _027_[7:0] : _028_[7:0];
  assign normalized_exponent = _057_ ? _006_ : mid_pipe_tent_exp_q[12:0];
  assign norm_shamt = _057_ ? _005_ : mid_pipe_add_shamt_q[7:0];
  assign _002_ = _042_ ? _074_[7:0] : 8'h00;
  assign addend_shamt = _041_ ? 8'ha3 : _002_;
  ...
  assign operand_a[63] = _197_(1'h1, { _060_, 1'h0, inp_pipe_operands_q[63] }, { _069_, _068_, _032_ });
  function [62:0] _198_;
    input [62:0] a;
    input [125:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[10:0], mantissa_a[51:0] } = _198_(63'h0010000000000001, { 63'h3ff0000000000000, inp_pipe_operands_q[62:0] }, { _068_, _035_ });
  assign _007_ = _036_ ? 64'h0000000000000000 : 64'h8000000000000000;
  ...
  assign info_a = _201_(8'hff, { 8'h81, info_q[7:0] }, { _068_, _035_ });
  function [63:0] _202_;
    input [63:0] a;
    input [127:0] b;
    input [1:0] s;
  ...
  assign operand_c = _202_(64'h8010000000000001, { _083_, inp_pipe_operands_q[190:128], _007_ }, { _033_, _067_ });
  assign operand_b = _034_ ? inp_pipe_operands_q[127:64] : 64'h8010000000000001;
  function [7:0] _204_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign info_c = _204_(8'hff, { info_q[23:16], 8'h21 }, { _033_, _067_ });
  assign _067_ = inp_pipe_op_q[3:0] == 4'h3;
  assign _068_ = inp_pipe_op_q[3:0] == 4'h2;
  assign _069_ = inp_pipe_op_q[3:0] == 4'h1;
  assign _070_ = ! inp_pipe_op_q[3:0];
  ...
  assign _071_ = | sum_sticky_bits;
  assign _072_ = | round_sticky_bits;
  ...
  assign _073_ = _024_ - 32'd1023;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _074_ = $signed(32'd56) - $signed(exponent_difference);
  assign _075_ = $signed(mid_pipe_exp_prod_q[12:0]) - $signed({ 1'h0, leading_zero_count });
  assign _076_ = $signed(normalized_exponent) - $signed(32'd1);
  assign _077_ = in_ready_o ? in_valid_i : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _077_;
  assign { _078_[31:13], exponent_product } = _056_ ? 32'd4294966275 : _073_;
  ...
  assign { _079_[163], mid_pipe_sum_q[325:163] } = _049_ ? _058_ : sum_raw;
  assign _080_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign final_sign = _050_ ? 1'h1 : _080_;
  assign _081_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _081_;
  assign { _082_[31:11], pre_round_abs[62:52] } = of_before_round ? 32'd2046 : { 21'h000000, final_exponent[10:0] };
  ...
  assign _083_ = inp_pipe_operands_q[191] ^ inp_pipe_op_mod_q[1];
  ...
  assign _078_[12:0] = exponent_product;
  assign _079_[162:0] = mid_pipe_sum_q[325:163];
  assign _082_[10:0] = pre_round_abs[62:52];
...
module \$paramod$9946e8f22ff7fcaf9794e609c1a0fcf33d18a37c\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
module \$paramod$bb671b4a7d5eb1798c3aa710bfda8c8989383bed\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:327$522.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:327$523.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:347$520.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:347$521.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:327$522.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:327$523.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:347$520.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l2s.preprocessed.v:347$521.inp  = 2'hx;
endmodule
...
module \$paramod$cc0f7b5c8fb758833f557d4642de83ff5400f9dd\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
...
module \$paramod$e1fb9b5c918861a1f7d2f593c7ae6cbe7de856b0\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$e58322ab06873da189f7fd1e84ce34d279cd5080\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [71:0] arbiter_output;

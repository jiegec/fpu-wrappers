...
module \$paramod$02e04bbeeeaf583de6181f89ff73b1456bc1c8ee\fpnew_divsqrt_multi_1A2E7_2C16F (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, dst_fmt_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire _002_;
  wire [1:0] _003_;
  ...
  assign _016_ = inp_pipe_valid_q[2] & _027_;
  assign _017_ = _016_ & in_ready;
  assign div_valid = _017_ & _032_;
  assign _018_ = inp_pipe_valid_q[2] & _029_;
  assign _019_ = _018_ & in_ready;
  assign sqrt_valid = _019_ & _032_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[1].reg_ena ) _053_ <= inp_pipe_op_q[7:4];
  assign inp_pipe_op_q[3:0] = _053_;
  reg [2:0] _054_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _054_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _054_ <= inp_pipe_rnd_mode_q[5:3];
  assign inp_pipe_rnd_mode_q[2:0] = _054_;
  reg [2:0] _055_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _055_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _055_ <= inp_pipe_dst_fmt_q[5:3];
  assign inp_pipe_dst_fmt_q[2:0] = _055_;
  always @(posedge clk_i)
    if (hold_result) held_status_q <= unit_status;
  reg [63:0] _057_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _057_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[1].reg_ena ) _057_ <= inp_pipe_operands_q[127:64];
  assign inp_pipe_operands_q[63:0] = _057_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[1].reg_ena ) _065_ <= inp_pipe_tag_q[3:2];
  assign inp_pipe_tag_q[1:0] = _065_;
  ...
  reg [4:0] _067_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _067_ <= 5'h00;
    else if (\gen_input_pipeline[1].reg_ena ) _067_ <= inp_pipe_aux_q[9:5];
  assign inp_pipe_aux_q[4:0] = _067_;
  assign _020_ = { _033_, out_ready_i, flush_i } != 3'h4;
  assign _021_ = { _034_, unit_done, flush_i } != 3'h4;
  assign _022_ = { _035_, _028_, flush_i } != 3'h4;
  assign _023_ = | { inp_pipe_ready[1], flush_i };
  assign _024_ = | { in_ready_o, flush_i };
  assign _025_ = & { _020_, _021_, _022_ };
  assign _026_ = | { _034_, _033_ };
  assign _027_ = inp_pipe_op_q[3:0] == 4'h4;
  assign _028_ = inp_pipe_valid_q[2] && unit_ready;
  assign _029_ = inp_pipe_op_q[3:0] != 4'h4;
  assign _030_ = ~ inp_pipe_valid_q[1];
  assign _031_ = ~ inp_pipe_valid_q[2];
  assign _032_ = ~ flush_i;
  assign in_ready_o = inp_pipe_ready[1] | _030_;
  assign inp_pipe_ready[1] = in_ready | _031_;
  assign op_starting = div_valid | sqrt_valid;
  assign state_d = flush_i ? 2'h0 : _003_;
  assign out_valid_o = flush_i ? 1'h0 : _002_;
  assign unit_busy = flush_i ? 1'h0 : _004_;
  assign _015_ = out_ready_i ? _014_ : 2'hx;
  assign _010_ = out_ready_i ? _012_ : 1'h0;
  assign _014_ = _028_ ? 2'h1 : 2'h0;
  assign _012_ = _028_ ? 1'h1 : 1'h0;
  assign _013_ = out_ready_i ? _014_ : 2'h2;
  assign _009_ = out_ready_i ? 1'h0 : 1'h1;
  ...
  assign _003_ = _098_(2'h0, { _008_, _011_, _015_ }, { _035_, _034_, _033_ });
  function [0:0] _099_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign in_ready = _099_(1'h0, { 1'h1, _006_, _010_ }, { _035_, _034_, _033_ });
  ...
  assign _002_ = _104_(1'h0, { _007_, 1'h1 }, { _034_, _033_ });
  ...
  assign divsqrt_fmt = _107_(2'h2, 6'h07, { _038_, _037_, _036_ });
  assign _036_ = inp_pipe_dst_fmt_q[2:0] == 3'h4;
  assign _037_ = inp_pipe_dst_fmt_q[2:0] == 3'h1;
  assign _038_ = ! inp_pipe_dst_fmt_q[2:0];
  assign busy_o = | { unit_busy, inp_pipe_valid_q[1:2], out_valid_o, in_valid_i };
  assign _039_ = in_ready_o ? in_valid_i : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _039_;
  assign _040_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
...
module \$paramod$07c8329810b9235665e01db11720b3f251ee32cc\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire [6:0] _002_;
  wire [9:0] _003_;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[30:23] }) + $signed({ 9'h000, _060_ });
  ...
  assign _027_ = $signed(32'd26) + $signed(exponent_product);
  assign _028_ = $signed(normalized_exponent) + $signed(32'd1);
  assign \gen_input_pipeline[0].reg_ena  = in_ready_o & in_valid_i;
  assign \gen_input_pipeline[1].reg_ena  = inp_pipe_ready[1] & inp_pipe_valid_q[1];
  assign inject_carry_in = effective_subtraction & _062_;
  assign regular_status[1] = uf_after_round & regular_status[0];
  reg [1:0] _096_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _096_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _096_ <= tag_i;
  assign inp_pipe_tag_q[3:2] = _096_;
  reg \inp_pipe_valid_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[1]  <= 1'h0;
    else if (_029_) \inp_pipe_valid_q_reg[1]  <= _001_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[1] ;
  reg [95:0] _098_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _098_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _098_ <= operands_i;
  assign inp_pipe_operands_q[191:96] = _098_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[0].reg_ena ) _101_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[5:3] = _101_;
  reg [2:0] _102_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _102_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _102_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[5:3] = _102_;
  reg [3:0] _103_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _103_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _103_ <= op_i;
  assign inp_pipe_op_q[7:4] = _103_;
  ...
  reg [1:0] _105_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _105_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _105_ <= inp_pipe_tag_q[3:2];
  assign inp_pipe_tag_q[1:0] = _105_;
  ...
  reg [3:0] _107_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _107_ <= 4'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _107_ <= inp_pipe_op_q[7:4];
  assign inp_pipe_op_q[3:0] = _107_;
  reg [2:0] _108_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _108_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _108_ <= inp_pipe_rnd_mode_q[5:3];
  assign inp_pipe_rnd_mode_q[2:0] = _108_;
  reg [2:0] _109_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _109_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _109_ <= inp_pipe_is_boxed_q[5:3];
  assign inp_pipe_is_boxed_q[2:0] = _109_;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_030_) \inp_pipe_valid_q_reg[0]  <= _000_;
  assign inp_pipe_valid_q[2] = \inp_pipe_valid_q_reg[0] ;
  reg [95:0] _111_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _111_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[1].reg_ena ) _111_ <= inp_pipe_operands_q[191:96];
  assign inp_pipe_operands_q[95:0] = _111_;
  assign _029_ = | { in_ready_o, flush_i };
  assign _030_ = | { inp_pipe_ready[1], flush_i };
  assign _031_ = | { _068_, _065_ };
  assign _032_ = | { _068_, _067_, _066_ };
  assign _033_ = | { _068_, _067_, _065_ };
  assign _034_ = | { _068_, _067_, _066_, _065_ };
  ...
  assign _042_ = $signed(exponent_difference) <= $signed(32'd2);
  ...
  assign _047_ = effective_subtraction && _063_;
  assign _048_ = effective_subtraction && _035_;
  assign _049_ = effective_subtraction && _042_;
  ...
  assign _059_ = ~ inp_pipe_operands_q[31];
  assign _060_ = ~ info_c[7];
  assign _061_ = ~ addend_after_shift;
  assign _062_ = ~ sticky_before_add;
  assign _063_ = ~ sum_raw[76];
  assign in_ready_o = inp_pipe_ready[1] | _057_;
  assign inp_pipe_ready[1] = out_ready_i | _058_;
  assign sticky_after_norm = _069_ | sticky_before_add;
  ...
  assign normalized_exponent = _055_ ? _006_ : mid_pipe_tent_exp_q;
  assign norm_shamt = _055_ ? _005_ : addend_shamt;
  ...
  assign special_status_q[4] = _052_ ? 1'h1 : _009_;
  assign result_is_special_q = _052_ ? 1'h1 : _007_;
  assign special_result_q = _052_ ? 32'd2143289344 : _008_;
  function [0:0] _185_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign operand_a[31] = _185_(1'h1, { _059_, 1'h0, inp_pipe_operands_q[31] }, { _067_, _066_, _031_ });
  function [30:0] _186_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[22:0] } = _186_(31'h00800001, { 31'h3f800000, inp_pipe_operands_q[30:0] }, { _066_, _033_ });
  ...
  assign info_a = _188_(8'hff, { 8'h81, info_q[7:0] }, { _066_, _033_ });
  function [31:0] _189_;
    input [31:0] a;
    input [63:0] b;
    input [1:0] s;
  ...
  assign operand_c = _189_(32'd2155872257, { _081_, inp_pipe_operands_q[94:64], 32'h80000000 }, { _032_, _065_ });
  assign operand_b = _034_ ? inp_pipe_operands_q[63:32] : 32'd2155872257;
  function [7:0] _191_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign info_c = _191_(8'hff, { info_q[23:16], 8'h21 }, { _032_, _065_ });
  ...
  assign busy_o = | { inp_pipe_valid_q[1:2], in_valid_i };
  ...
  assign _073_ = $signed(exponent_product) - $signed({ 1'h0, leading_zero_count });
  assign _074_ = $signed(normalized_exponent) - $signed(32'd1);
  assign _075_ = in_ready_o ? in_valid_i : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _075_;
  assign _076_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _076_;
  assign { _077_[31:10], exponent_product } = _054_ ? 32'd4294967171 : _071_;
  assign mid_pipe_tent_exp_q = _037_ ? exponent_addend : exponent_product;
  assign addend_shifted = effective_subtraction ? _061_ : addend_after_shift;
  assign { _078_[76], sum_q[75:51], sum_lower } = _047_ ? _056_ : sum_raw;
  assign _079_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign pre_round_sign = _048_ ? 1'h1 : _079_;
  ...
  assign _081_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[2];
  ...
  assign _077_[9:0] = exponent_product;
  assign _078_[75:0] = { sum_q[75:51], sum_lower };
  assign _080_[7:0] = pre_round_abs[30:23];
  assign addend_shamt_q = addend_shamt;
  assign aux_o = inp_pipe_aux_q[2];
  ...
  assign { inp_pipe_ready[0], inp_pipe_ready[2] } = { in_ready_o, out_ready_i };
  assign inp_pipe_rnd_mode_q[8:6] = rnd_mode_i;
  assign inp_pipe_tag_q[5:4] = tag_i;
  assign inp_pipe_valid_q[0] = in_valid_i;
  ...
  assign mid_pipe_aux_q = inp_pipe_aux_q[2];
  ...
  assign mid_pipe_valid_q = inp_pipe_valid_q[2];
  assign operand_a[30:0] = { exponent_a[7:0], mantissa_a[22:0] };
  assign out_pipe_aux_q = inp_pipe_aux_q[2];
  assign out_pipe_ready = out_ready_i;
  assign out_pipe_result_q = result_o;
  assign out_pipe_status_q = status_o;
  assign out_pipe_tag_q = inp_pipe_tag_q[1:0];
  assign out_pipe_valid_q = inp_pipe_valid_q[2];
  assign out_valid_o = inp_pipe_valid_q[2];
  ...
  assign sv2v_tmp_25EE6 = inp_pipe_valid_q[2];
  ...
  assign sv2v_tmp_9E262 = inp_pipe_aux_q[2];
...
module \$paramod$07c8329810b9235665e01db11720b3f251ee32cc\fpnew_noncomp_8EF6A_8033C (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, class_mask_o, is_class_o, tag_o, aux_o, out_valid_o, out_ready_i
, busy_o);
  wire _000_;
  wire _001_;
  wire [31:0] _002_;
  ...
  assign _016_ = operand_a_smaller & _031_;
  reg [3:0] _058_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _058_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _058_ <= op_i;
  assign inp_pipe_op_q[7:4] = _058_;
  reg [1:0] _059_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _059_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _059_ <= inp_pipe_tag_q[3:2];
  assign inp_pipe_tag_q[1:0] = _059_;
  reg [63:0] _060_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _060_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[1].reg_ena ) _060_ <= inp_pipe_operands_q[127:64];
  ...
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[1]  <= 1'h0;
    else if (_017_) \inp_pipe_valid_q_reg[1]  <= _001_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[1] ;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_018_) \inp_pipe_valid_q_reg[0]  <= _000_;
  assign inp_pipe_valid_q[2] = \inp_pipe_valid_q_reg[0] ;
  reg [3:0] _067_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _067_ <= 4'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _067_ <= inp_pipe_op_q[7:4];
  assign inp_pipe_op_q[3:0] = _067_;
  reg \inp_pipe_aux_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_aux_q_reg[1]  <= 1'h0;
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_aux_q_reg[1]  <= aux_i;
  ...
  assign inp_pipe_tag_q[3:2] = _069_;
  reg [2:0] _070_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _070_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _070_ <= inp_pipe_rnd_mode_q[5:3];
  assign inp_pipe_rnd_mode_q[2:0] = _070_;
  reg \inp_pipe_op_mod_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[1]  <= 1'h0;
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_op_mod_q_reg[1]  <= op_mod_i;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[1].reg_ena ) _073_ <= inp_pipe_is_boxed_q[3:2];
  assign inp_pipe_is_boxed_q[1:0] = _073_;
  assign _017_ = | { in_ready_o, flush_i };
  assign _018_ = | { inp_pipe_ready[1], flush_i };
  assign _019_ = | { _034_, is_class_o };
  assign _020_ = | { _038_, _037_, _036_ };
  assign _021_ = | { _033_, is_class_o };
  assign _022_ = | { _038_, _037_ };
  assign _023_ = inp_pipe_operands_q[31:0] == inp_pipe_operands_q[63:32];
  assign _024_ = info_q[5] && info_q[13];
  assign _025_ = info_q[3] && info_q[11];
  assign operands_equal = _023_ || _024_;
  assign _026_ = inp_pipe_operands_q[31] || inp_pipe_operands_q[63];
  assign _027_ = inp_pipe_operands_q[31:0] < inp_pipe_operands_q[63:32];
  assign _028_ = ~ inp_pipe_valid_q[1];
  assign _029_ = ~ inp_pipe_valid_q[2];
  assign _030_ = ~ \sign_injections.sign_b ;
  assign _031_ = ~ { 31'h00000000, operands_equal };
  assign in_ready_o = inp_pipe_ready[1] | _028_;
  assign inp_pipe_ready[1] = out_ready_i | _029_;
  ...
  assign extension_bit_o = _093_(1'h1, { sgnj_extension_bit, 1'h0 }, { _034_, _021_ });
  function [4:0] _094_;
    input [4:0] a;
    input [14:0] b;
    input [2:0] s;
  ...
  assign status_o = _094_(5'h1f, { signalling_nan, 4'h0, cmp_status[4], 9'h000 }, { _035_, _033_, _019_ });
  ...
  assign result_o = _096_(32'd2155872257, { sgnj_result, minmax_result, cmp_result }, { _034_, _035_, _033_ });
  assign _033_ = inp_pipe_op_q[3:0] == 4'h8;
  assign _035_ = inp_pipe_op_q[3:0] == 4'h7;
  assign _034_ = inp_pipe_op_q[3:0] == 4'h6;
  assign _014_ = info_q[3] ? _048_ : 10'h200;
  assign _011_ = info_q[4] ? _047_ : _014_;
  assign _007_ = info_q[5] ? _046_ : _011_;
  assign _003_ = info_q[6] ? _045_ : _007_;
  assign class_mask_o = info_q[7] ? _044_ : _003_;
  assign _015_ = any_operand_nan ? { 31'h00000000, inp_pipe_op_mod_q[2] } : _052_;
  assign _012_ = any_operand_nan ? 32'd0 : _051_;
  assign _009_ = any_operand_nan ? 1'h1 : 1'h0;
  assign _008_ = any_operand_nan ? 32'd0 : _050_;
  ...
  assign cmp_result = signalling_nan ? 32'd0 : _004_;
  function [31:0] _113_;
    input [31:0] a;
    input [63:0] b;
    input [1:0] s;
  ...
  assign _013_ = _113_(32'd2155872257, { _042_, _043_ }, { _038_, _037_ });
  assign _010_ = info_q[11] ? inp_pipe_operands_q[31:0] : _013_;
  assign _006_ = info_q[3] ? inp_pipe_operands_q[63:32] : _010_;
  assign minmax_result = _025_ ? 32'd2143289344 : _006_;
  function [0:0] _117_;
    input [0:0] a;
    input [3:0] b;
    input [3:0] s;
  ...
  assign sgnj_result[31] = _117_(1'h1, { \sign_injections.sign_b , _030_, _049_, inp_pipe_operands_q[31] }, { _038_, _037_, _036_, _039_ });
  function [30:0] _118_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign _002_ = info_q[0] ? inp_pipe_operands_q[31:0] : 32'd2143289344;
  ...
  assign _041_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _041_;
  assign sgnj_extension_bit = inp_pipe_op_mod_q[2] ? sgnj_result[31] : 1'h1;
  assign _042_ = operand_a_smaller ? inp_pipe_operands_q[31:0] : inp_pipe_operands_q[63:32];
  assign _043_ = operand_a_smaller ? inp_pipe_operands_q[63:32] : inp_pipe_operands_q[31:0];
  assign _044_ = inp_pipe_operands_q[31] ? 10'h002 : 10'h040;
  assign _045_ = inp_pipe_operands_q[31] ? 10'h004 : 10'h020;
  assign _046_ = inp_pipe_operands_q[31] ? 10'h008 : 10'h010;
  assign _047_ = inp_pipe_operands_q[31] ? 10'h001 : 10'h080;
  assign _048_ = info_q[2] ? 10'h100 : 10'h200;
  assign operand_a_smaller = _027_ ^ _026_;
  assign _049_ = \sign_injections.sign_a  ^ \sign_injections.sign_b ;
  assign _050_ = _032_ ^ inp_pipe_op_mod_q[2];
  assign _051_ = _016_ ^ inp_pipe_op_mod_q[2];
  assign _052_ = operands_equal ^ inp_pipe_op_mod_q[2];
...
module \$paramod$0abd922b2ab5f3b162771b89b7e3197e8c24dec5\fpnew_opgroup_multifmt_slice_607F1_85D30 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire [31:0] _01_;
  wire [31:0] _02_;
  ...
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$2762.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$3945.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$3946.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7334$3947.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7334$3948.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$3176.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$3273.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$3760.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$3857.fmt ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$2762.$result  = _04_ + 32'd1;
  ...
  assign { _10_[63:32], \gen_num_lanes[1].active_lane.local_operands [31:0] } = operands_i[63:0] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$2762.$result ;
  assign { _11_[63:32], \gen_num_lanes[1].active_lane.local_operands [63:32] } = operands_i[127:64] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$2762.$result ;
  ...
  \$paramod$02e04bbeeeaf583de6181f89ff73b1456bc1c8ee\fpnew_divsqrt_multi_1A2E7_2C16F  \gen_num_lanes[0].active_lane.genblk1.lane_instance.i_fpnew_divsqrt_multi  (
  ...
  \$paramod$02e04bbeeeaf583de6181f89ff73b1456bc1c8ee\fpnew_divsqrt_multi_1A2E7_2C16F  \gen_num_lanes[1].active_lane.genblk1.lane_instance.i_fpnew_divsqrt_multi  (
    .aux_i({ 1'h0, vectorial_op_i, dst_fmt_i }),
    .aux_o(lane_aux[9:5]),
    .busy_o(lane_busy[1]),
    .clk_i(clk_i),
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$3945.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$3946.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7334$3947.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7334$3948.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$3176.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$3273.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$3760.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$3857.fmt  = 3'hx;
...
module \$paramod$1920ca3060440c468488a8192f6d005c2fdc6b9b\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  ...
  \$paramod$7c054cda7d3c86e382e451209fea420c1127c886\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:149$2535.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:149$2536.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2519.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2520.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2529.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2530.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2531.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2532.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2533.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2534.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2519.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2520.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2520.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2519.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2519.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2520.$result [1:0], idx_o };
  ...
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:149$2535.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:149$2536.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2519.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2520.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2529.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2530.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2531.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2532.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2533.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_2s.preprocessed.v:169$2534.inp  = 3'hx;
endmodule

module \$paramod$30a489e4226fb0a6c544c8f850d0f0dd23ab95dd\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$198.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$41.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7876$214.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7876$230.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7876$246.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7876$262.op ;
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$41.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$41.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$41.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$41.$result  == 2'h3;
  assign _14_ = | _13_;
  assign _18_ = | _17_;
  assign _16_ = | _15_;
  function [1:0] _41_;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$41.$result  = _41_(2'h2, 6'h07, { _18_, _16_, _14_ });
  ...
  assign _19_ = _64_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$41.$result  +: 1];
  ...
  \$paramod$1920ca3060440c468488a8192f6d005c2fdc6b9b\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f45cc25665e03c14ce9b2710de7de06f7e669d59\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$6fae073894555b4931e15ca4a9aab3c704503d00\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f49dc98a644d12ca99f717d383b93a1e7a247bc1\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7827$198.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7876$214.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7876$230.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7876$246.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_2s.preprocessed.v:7876$262.op  = 4'hx;
...
module \$paramod$6fae073894555b4931e15ca4a9aab3c704503d00\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  wire [71:0] arbiter_output;
  ...
  wire [4:0] _6_ = { 4'h0, fmt_in_ready[0] };
  assign _1_ = _6_[dst_fmt_i +: 1];
  \$paramod$cec5845a3e24ee312fb62f8c897f5d6f88d36c86\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .extension_bit_o(fmt_outputs[2]),
    .flush_i(flush_i),
...
module \$paramod$7c054cda7d3c86e382e451209fea420c1127c886\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
  ...
  assign lane_status[4:0] = \gen_num_lanes[0].active_lane.out_valid  ? \gen_num_lanes[0].active_lane.op_status  : 5'h00;
  assign lane_status[9:5] = lane_out_valid[1] ? \gen_num_lanes[1].active_lane.op_status  : 5'h00;
  \$paramod$07c8329810b9235665e01db11720b3f251ee32cc\fpnew_fma_FC83A_5615B  \gen_num_lanes[0].active_lane.lane_instance.i_fma  (
  ...
  \$paramod$07c8329810b9235665e01db11720b3f251ee32cc\fpnew_fma_FC83A_5615B  \gen_num_lanes[1].active_lane.lane_instance.i_fma  (
    .aux_i(vectorial_op_i),
...
module \$paramod$c018ca64838a04266aa1121e4eee244f2f8117aa\fpnew_cast_multi_BB75A_A18A7 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o
, out_ready_i, busy_o);
  wire [31:0] _000_;
  wire _001_;
  wire _002_;
  ...
  wire [4:0] fp_status;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3749$4304.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3749$4439.fmt ;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3776$4305.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3776$4440.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_2s.preprocessed.v:3985$4313.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_2s.preprocessed.v:3986$4314.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_2s.preprocessed.v:3976$4307.ifmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_2s.preprocessed.v:3970$4306.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_2s.preprocessed.v:3990$4315.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_2s.preprocessed.v:3995$4316.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_2s.preprocessed.v:3997$4317.fmt ;
  wire \gen_input_pipeline[0].reg_ena ;
  wire \gen_input_pipeline[1].reg_ena ;
  ...
  wire [1:0] tag_o;
  wire uf_after_round;
  assign _018_ = _022_ + 32'd1;
  assign _020_ = _023_ + 32'd1;
  assign _019_ = _021_ + 32'd1;
  assign _022_ = { _046_[31:6], 6'h00 } + 32'd31;
  assign _023_ = { _047_[31:6], 6'h00 } + 32'd63;
  assign _021_ = { _046_[31:6], 6'h00 } + 32'd63;
  assign _024_ = { 26'h0000000, inp_pipe_src_fmt_q[2:0], 3'h0 } + 32'd6;
  assign _025_ = src_exp + { 8'h00, src_subnormal[0] };
  assign fp_input_exp = _088_ + src_offset;
  assign { _026_[31:9], destination_exp_q } = $signed(input_exp) + $signed(\fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3776$4305.$result );
  assign _027_ = _092_ + inp_pipe_op_mod_q[2];
  assign _028_ = _090_[4:0] + 32'd1;
  assign _029_ = _090_[4:0] + 32'd2;
  assign _030_ = _029_ + _000_;
  assign \gen_input_pipeline[0].reg_ena  = in_ready_o & in_valid_i;
  assign \gen_input_pipeline[1].reg_ena  = inp_pipe_ready[1] & inp_pipe_valid_q[1];
  assign int_sign = int_value[23] & _053_;
  assign _031_ = src_is_int & mant_is_zero;
  assign fp_result_is_special = _054_ & _059_;
  assign _032_ = input_sign_q & inp_pipe_op_mod_q[2];
  assign _033_ = _032_ & _056_;
  assign fp_regular_status[4] = src_is_int & _063_;
  assign fp_regular_status[2] = _054_ & _034_;
  assign fp_regular_status[1] = uf_after_round & fp_regular_status[0];
  assign _034_ = _057_ & _063_;
  reg [4:0] _123_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _123_ <= 5'h00;
    else if (\gen_input_pipeline[1].reg_ena ) _123_ <= inp_pipe_aux_q[9:5];
  assign inp_pipe_aux_q[4:0] = _123_;
  reg [4:0] _124_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _124_ <= 5'h00;
    else if (\gen_input_pipeline[0].reg_ena ) _124_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[9:5] = _124_;
  reg \inp_pipe_op_mod_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[1]  <= 1'h0;
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_op_mod_q_reg[1]  <= op_mod_i;
  ...
  reg [2:0] _126_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _126_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _126_ <= src_fmt_i;
  assign inp_pipe_src_fmt_q[5:3] = _126_;
  reg [1:0] _127_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _127_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _127_ <= inp_pipe_tag_q[3:2];
  assign inp_pipe_tag_q[1:0] = _127_;
  reg [1:0] _128_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _128_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _128_ <= inp_pipe_int_fmt_q[3:2];
  assign inp_pipe_int_fmt_q[1:0] = _128_;
  reg \inp_pipe_valid_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[1]  <= 1'h0;
    else if (_035_) \inp_pipe_valid_q_reg[1]  <= _002_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[1] ;
  reg [2:0] _130_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _130_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _130_ <= inp_pipe_dst_fmt_q[5:3];
  assign inp_pipe_dst_fmt_q[2:0] = _130_;
  reg [2:0] _131_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _131_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _131_ <= dst_fmt_i;
  assign inp_pipe_dst_fmt_q[5:3] = _131_;
  reg [2:0] _132_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _132_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _132_ <= inp_pipe_src_fmt_q[5:3];
  assign inp_pipe_src_fmt_q[2:0] = _132_;
  reg [1:0] _133_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _133_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _133_ <= int_fmt_i;
  assign inp_pipe_int_fmt_q[3:2] = _133_;
  reg [2:0] _134_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _134_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _134_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[5:3] = _134_;
  reg [1:0] _135_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _135_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _135_ <= tag_i;
  assign inp_pipe_tag_q[3:2] = _135_;
  reg [4:0] _136_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _136_ <= 5'h00;
    else if (\gen_input_pipeline[0].reg_ena ) _136_ <= aux_i;
  assign inp_pipe_aux_q[9:5] = _136_;
  reg [3:0] _137_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _137_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _137_ <= op_i;
  assign inp_pipe_op_q[7:4] = _137_;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_036_) \inp_pipe_valid_q_reg[0]  <= _001_;
  assign inp_pipe_valid_q[2] = \inp_pipe_valid_q_reg[0] ;
  reg [31:0] _139_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _139_ <= 32'd0;
    else if (\gen_input_pipeline[1].reg_ena ) _139_ <= inp_pipe_operands_q[63:32];
  assign inp_pipe_operands_q[31:0] = _139_;
  reg [4:0] _140_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _140_ <= 5'h00;
    else if (\gen_input_pipeline[1].reg_ena ) _140_ <= inp_pipe_is_boxed_q[9:5];
  assign inp_pipe_is_boxed_q[4:0] = _140_;
  reg [2:0] _141_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _141_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _141_ <= inp_pipe_rnd_mode_q[5:3];
  assign inp_pipe_rnd_mode_q[2:0] = _141_;
  reg [3:0] _142_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _142_ <= 4'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _142_ <= inp_pipe_op_q[7:4];
  assign inp_pipe_op_q[3:0] = _142_;
  reg \inp_pipe_op_mod_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[0]  <= 1'h0;
    else if (\gen_input_pipeline[1].reg_ena ) \inp_pipe_op_mod_q_reg[0]  <= inp_pipe_op_mod_q[1];
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[0].reg_ena ) _144_ <= operands_i;
  assign inp_pipe_operands_q[63:32] = _144_;
  assign _035_ = | { in_ready_o, flush_i };
  assign _036_ = | { inp_pipe_ready[1], flush_i };
  ...
  assign _037_ = $signed(input_exp) >= $signed(_027_);
  assign _038_ = $signed(destination_exp_q) >= $signed(_093_);
  assign _039_ = $signed(destination_exp_q) >= $signed(_049_);
  assign _040_ = _054_ && info_q[4];
  assign _041_ = _044_ && _039_;
  assign _042_ = _038_ || _040_;
  assign _043_ = $signed(input_exp) < $signed(32'd4294967295);
  assign _044_ = $signed(destination_exp_q) < $signed(32'd1);
  assign _045_ = $signed(destination_exp_q) < $signed(_049_);
  assign _015_[31:3] = inp_pipe_int_fmt_q[1:0] * 29'h00000003;
  assign _016_[31:3] = inp_pipe_src_fmt_q[2:0] * 29'h00000003;
  assign _017_ = inp_pipe_src_fmt_q[2:0] * 32'd9;
  assign _048_ = - int_value;
  assign _049_ = - $signed(_000_);
  assign _050_ = - rounded_abs;
  assign _051_ = ~ inp_pipe_valid_q[1];
  assign _052_ = ~ inp_pipe_valid_q[2];
  assign _053_ = ~ inp_pipe_op_mod_q[2];
  assign _055_ = ~ info_q[0];
  assign _056_ = ~ rounded_int_res_zero;
  assign _054_ = ~ src_is_int;
  assign _057_ = ~ info_q[4];
  assign in_ready_o = inp_pipe_ready[1] | _051_;
  assign inp_pipe_ready[1] = out_ready_i | _052_;
  assign _058_ = info_q[5] | info_q[3];
  assign _059_ = _058_ | _055_;
  assign _060_ = info_q[3] | info_q[4];
  assign _061_ = _060_ | of_before_round;
  assign _062_ = _061_ | _055_;
  assign int_result_is_special = _062_ | _033_;
  assign _063_ = of_before_round | of_after_round;
  assign _064_ = _070_ | _034_;
  assign _014_ = _045_ ? _030_[4:0] : _090_[4:0];
  assign _012_ = _045_ ? 9'h000 : destination_exp_q;
  assign _013_ = _041_ ? _095_[4:0] : _014_;
  assign _009_ = _041_ ? 9'h000 : _012_;
  assign _010_ = _042_ ? 1'h1 : 1'h0;
  assign _007_ = _042_ ? 49'h1ffffffffffff : { input_mant, 25'h0000000 };
  assign _004_ = _042_ ? _094_[8:0] : _009_;
  assign _011_ = _042_ ? _090_[4:0] : _013_;
  assign _008_ = _043_ ? 5'h01 : _091_[4:0];
  assign _006_ = _037_ ? 1'h1 : 1'h0;
  assign _003_ = _037_ ? 5'h00 : _008_;
  function [31:0] _195_;
    input [31:0] a;
    input [127:0] b;
    input [3:0] s;
  ...
  assign _065_ = _195_(32'hxxxxxxxx, 128'h00000008000000100000002000000040, { _069_, _068_, _067_, _066_ });
  assign _066_ = inp_pipe_int_fmt_q[1:0] == 2'h3;
  assign _067_ = inp_pipe_int_fmt_q[1:0] == 2'h2;
  assign _068_ = inp_pipe_int_fmt_q[1:0] == 2'h1;
  assign _069_ = ! inp_pipe_int_fmt_q[1:0];
  assign _005_ = dst_is_int_q ? _065_ : 32'hxxxxxxxx;
  assign of_before_round = dst_is_int_q ? _006_ : _010_;
  assign denorm_shamt = dst_is_int_q ? _003_ : _011_;
  assign preshift_mant = dst_is_int_q ? { input_mant, 25'h0000000 } : _007_;
  assign final_exp = dst_is_int_q ? destination_exp_q : _004_;
  ...
  assign busy_o = | { inp_pipe_valid_q[1:2], in_valid_i };
  wire [95:0] _270_ = 96'hffffffffffffffffffffffff;
  assign int_value = _270_[$signed({ _015_[31:3], 3'h0 }) +: 24];
  wire [119:0] _271_ = { 96'hffffffffffffffffffffffff, fmt_mantissa[23], inp_pipe_operands_q[22:0] };
  assign _071_ = _271_[$signed({ _016_[31:3], 3'h0 }) +: 24];
  wire [44:0] _272_ = { 37'h1ffffffffe, inp_pipe_operands_q[30:23] };
  assign src_exp = _272_[$signed(_017_) +: 9];
  wire [39:0] _273_ = { 32'hffffffff, fmt_mantissa[23], info[6:0] };
  assign src_subnormal[0] = _273_[$signed(_024_) +: 1];
  wire [44:0] _274_ = 45'h1ffffffffe00;
  assign src_offset = _274_[$signed(_017_) +: 9];
  wire [4:0] _275_ = { 4'hf, inp_pipe_operands_q[31] };
  assign _072_ = _275_[inp_pipe_src_fmt_q[2:0] +: 1];
  wire [39:0] _276_ = { 32'hffffffff, fmt_mantissa[23], info[6:0] };
  assign info_q = _276_[$signed({ 26'h0000000, inp_pipe_src_fmt_q[2:0], 3'h0 }) +: 8];
  wire [319:0] _277_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _000_ = _277_[$signed(_080_) +: 32];
  wire [159:0] _278_ = { 129'h1fffffffffffffffffffffffffffffffe, final_exp[7:0], destination_mant[47:25] };
  assign _074_ = _278_[$signed({ 24'h000000, inp_pipe_dst_fmt_q[2:0], 5'h00 }) +: 32];
  wire [4:0] _279_ = { 4'hf, fmt_uf_after_round[0] };
  assign uf_after_round = _279_[inp_pipe_dst_fmt_q[2:0] +: 1];
  wire [4:0] _280_ = { 4'hf, fmt_of_after_round[0] };
  assign of_after_round = _280_[inp_pipe_dst_fmt_q[2:0] +: 1];
  wire [159:0] _281_ = { 128'hffffffffffffffffffffffffffffffff, \gen_special_results[0].active_format.special_results.special_res  };
  assign fp_special_result = _281_[$signed({ 24'h000000, inp_pipe_dst_fmt_q[2:0], 5'h00 }) +: 32];
  wire [127:0] _282_ = 128'hffffffffffffffffffffffffffffffff;
  assign int_special_result = _282_[$signed({ 25'h0000000, inp_pipe_int_fmt_q[1:0], 5'h00 }) +: 32];
  wire [159:0] _283_ = { 128'hffffffffffffffffffffffffffffffff, fmt_result[31:0] };
  assign _075_ = _283_[$signed({ 24'h000000, inp_pipe_dst_fmt_q[2:0], 5'h00 }) +: 32];
  wire [319:0] _284_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _076_ = _284_[$signed(_082_) +: 32];
  wire [319:0] _285_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _073_ = _285_[$signed(_081_) +: 32];
  assign _077_ = $signed(32'd1) << _085_;
  assign _078_ = $signed(32'd1) << _086_;
  assign input_mant = encoded_mant << renorm_shamt;
  assign _079_ = $signed(32'd1) << _073_;
  assign destination_mant = preshift_mant >> denorm_shamt;
  assign _080_ = _018_ - 32'd32;
  assign _082_ = _020_ - 32'd32;
  assign _081_ = _019_ - 32'd32;
  assign { _084_[31:26], _047_[31:6] } = 32'd4 - inp_pipe_src_fmt_q[2:0];
  assign _085_ = _076_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3749$4304.$result  = $signed(_077_) - $signed(32'd1);
  assign { _083_[31:26], _046_[31:6] } = 32'd4 - inp_pipe_dst_fmt_q[2:0];
  assign _086_ = _073_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3776$4305.$result  = $signed(_078_) - $signed(32'd1);
  assign _087_ = _025_ - \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3749$4304.$result [8:0];
  assign _088_ = _087_ - { 1'h0, renorm_shamt };
  assign { _089_[31:9], int_input_exp } = 32'd23 - { 1'h0, renorm_shamt };
  assign _090_ = 32'd23 - _000_;
  assign _091_ = 32'd4294967295 - input_exp;
  assign _092_ = _005_ - 32'd1;
  assign _093_ = $signed(_079_) - $signed(32'd1);
  assign _094_ = $signed(_079_) - $signed(32'd2);
  assign _095_ = _028_ - destination_exp_q;
  assign _096_ = in_ready_o ? in_valid_i : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _096_;
  assign _097_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _097_;
  assign int_mantissa = int_sign ? _048_ : int_value;
  assign encoded_mant = src_is_int ? int_mantissa : _071_;
  assign input_sign_q = src_is_int ? int_sign : _072_;
  ...
  assign pre_round_abs = dst_is_int_q ? int_special_result : _074_;
  assign fmt_result[31:0] = _031_ ? 32'd0 : { rounded_sign, rounded_abs[30:0] };
  assign rounded_int_res = rounded_sign ? _050_ : rounded_abs;
  assign \gen_special_results[0].active_format.special_results.special_res  = info_q[5] ? { input_sign_q, 31'h00000000 } : 32'd2143289344;
  assign fp_regular_status[0] = src_is_int ? _070_ : _064_;
  ...
  assign _026_[8:0] = destination_exp_q;
  assign _046_[5:0] = 6'h00;
  assign _047_[5:0] = 6'h00;
  assign _083_[25:0] = _046_[31:6];
  assign _084_[25:0] = _047_[31:6];
  assign _089_[8:0] = int_input_exp;
  ...
  assign \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3749$4439.fmt  = 3'hx;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3776$4440.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_2s.preprocessed.v:3985$4313.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_2s.preprocessed.v:3986$4314.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_2s.preprocessed.v:3976$4307.ifmt  = 2'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_2s.preprocessed.v:3970$4306.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_2s.preprocessed.v:3990$4315.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_2s.preprocessed.v:3995$4316.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_2s.preprocessed.v:3997$4317.fmt  = 3'hx;
  ...
  assign mid_pipe_op_mod_q = inp_pipe_op_mod_q[2];
  assign mid_pipe_ready = out_ready_i;
  assign mid_pipe_rnd_mode_q = inp_pipe_rnd_mode_q[2:0];
  ...
  assign op_mod_q2 = inp_pipe_op_mod_q[2];
  ...
  assign result_d = result_o;
  assign rnd_mode_q = inp_pipe_rnd_mode_q[2:0];
  assign src_bias = \fpnew_pkg_bias$func$FPNewBlackbox_2s.preprocessed.v:3749$4304.$result [8:0];
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_2s.preprocessed.v:327$496.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_2s.preprocessed.v:327$497.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_2s.preprocessed.v:347$494.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_2s.preprocessed.v:347$495.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_2s.preprocessed.v:327$496.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_2s.preprocessed.v:327$497.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_2s.preprocessed.v:347$494.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_2s.preprocessed.v:347$495.inp  = 2'hx;
endmodule

module \$paramod$cec5845a3e24ee312fb62f8c897f5d6f88d36c86\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  \$paramod$07c8329810b9235665e01db11720b3f251ee32cc\fpnew_noncomp_8EF6A_8033C  \gen_num_lanes[0].active_lane.genblk1.genblk1.lane_instance.i_noncomp  (
    .aux_i(vectorial_op_i),
    .aux_o(result_is_vector),
    .busy_o(lane_busy[0]),
  ...
  \$paramod$07c8329810b9235665e01db11720b3f251ee32cc\fpnew_noncomp_8EF6A_8033C  \gen_num_lanes[1].active_lane.genblk1.genblk1.lane_instance.i_noncomp  (
    .aux_i(vectorial_op_i),
    .aux_o(lane_vectorial[1]),
    .busy_o(lane_busy[1]),
...
module \$paramod$eba65ebba05e9239123d3bd496f954bcf08894b6\fpnew_opgroup_multifmt_slice_607F1_85D30 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _000_;
  wire [31:0] _001_;
  wire [31:0] _002_;
  ...
  wire flush_i;
  wire [319:0] fmt_slice_result;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$2180.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$2181.fmt ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$588.$result ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$589.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7334$2182.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7334$2183.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1003.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1100.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1197.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1775.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1872.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1969.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7473$1270.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7473$2042.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_2s.preprocessed.v:7470$1231.ifmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_2s.preprocessed.v:7470$2003.ifmt ;
  wire \gen_num_lanes[0].active_lane.in_valid ;
  wire [95:0] \gen_num_lanes[0].active_lane.local_operands ;
  wire [31:0] \gen_num_lanes[0].active_lane.op_result ;
  wire [4:0] \gen_num_lanes[0].active_lane.op_status ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$588.$result  = _012_ + 32'd1;
  assign _015_ = _034_ + _035_;
  assign _013_ = { _024_[31:6], 6'h00 } + 32'd63;
  assign _014_ = { _024_[31:6], 6'h00 } + 32'd31;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$589.$result  = _015_ + 32'd1;
  assign _016_ = \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$589.$result  + 32'd16;
  assign lane_out_valid[1] = \gen_num_lanes[1].active_lane.out_valid  & lane_aux[3];
  assign \gen_num_lanes[1].active_lane.in_valid  = in_valid_i & vectorial_op_i;
  assign \gen_num_lanes[1].active_lane.out_ready  = out_ready_i & lane_aux[3];
  ...
  assign is_up_cast = \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$588.$result  > \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$589.$result ;
  ...
  assign _036_ = operands_i[63:0] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$589.$result ;
  ...
  \$paramod$c018ca64838a04266aa1121e4eee244f2f8117aa\fpnew_cast_multi_BB75A_A18A7  \gen_num_lanes[0].active_lane.genblk1.genblk1.genblk1.lane_instance.i_fpnew_cast_multi  (
  ...
  \$paramod$c018ca64838a04266aa1121e4eee244f2f8117aa\fpnew_cast_multi_BB75A_A18A7  \gen_num_lanes[1].active_lane.genblk1.genblk1.genblk1.lane_instance.i_fpnew_cast_multi  (
    .aux_i({ dst_fmt_is_int, vectorial_op_i, dst_fmt }),
    .aux_o(lane_aux[9:5]),
    .busy_o(lane_busy[1]),
    .clk_i(clk_i),
  ...
  assign \boxed_2op.sv2v_autoblock_4.fmt  = 32'd5;
  assign { fmt_slice_result[319:288], fmt_slice_result[286:0] } = { extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, \gen_num_lanes[1].local_result , \gen_num_lanes[0].local_result  };
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$2180.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7333$2181.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7334$2182.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7334$2183.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1003.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1100.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1197.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1775.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1872.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7466$1969.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7473$1270.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_2s.preprocessed.v:7473$2042.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_2s.preprocessed.v:7470$1231.ifmt  = 2'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_2s.preprocessed.v:7470$2003.ifmt  = 2'hx;
  assign \gen_num_lanes[0].active_lane.in_valid  = in_valid_i;
...
module \$paramod$f45cc25665e03c14ce9b2710de7de06f7e669d59\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire _01_;
  wire _02_;
  ...
  \$paramod$0abd922b2ab5f3b162771b89b7e3197e8c24dec5\fpnew_opgroup_multifmt_slice_607F1_85D30  \gen_merged_slice.i_multifmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .extension_bit_o(fmt_outputs[2]),
...
module \$paramod$f49dc98a644d12ca99f717d383b93a1e7a247bc1\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire _01_;
  wire _02_;
  ...
  assign _03_ = _12_[$signed({ _00_[31:1], 1'h0 }) +: 2];
  assign { _04_[31], _00_[31:1] } = 32'd4 - dst_fmt_i;
  \$paramod$eba65ebba05e9239123d3bd496f954bcf08894b6\fpnew_opgroup_multifmt_slice_607F1_85D30  \gen_merged_slice.i_multifmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .extension_bit_o(fmt_outputs[2]),
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$30a489e4226fb0a6c544c8f850d0f0dd23ab95dd\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
...
module norm_div_sqrt_mvp(Mant_in_DI, Exp_in_DI, Sign_in_DI, Div_enable_SI, Sqrt_enable_SI, Inf_a_SI, Inf_b_SI, Zero_a_SI, Zero_b_SI, NaN_a_SI, NaN_b_SI, SNaN_SI, RM_SI, Full_precision_SI, FP32_SI, FP64_SI, FP16_SI, FP16ALT_SI, Result_DO, Fflags_SO);
  ...
  assign Mant_roundUp_S = _280_(1'h0, { _120_, _097_, _098_ }, { _139_, _138_, _137_ });

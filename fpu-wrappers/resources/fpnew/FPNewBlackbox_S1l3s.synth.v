...
module \$paramod$6a56daa284ee7ecf4b17ad071518a3d0a64707d6\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8190$212.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8190$55.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$109.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$144.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$179.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$228.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$244.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$260.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$276.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$74.$result ;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$179.$result  = \$auto$proc_rom.cc:150:do_switch$1399 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$144.$result  = \$auto$proc_rom.cc:150:do_switch$1403 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$109.$result  = \$auto$proc_rom.cc:150:do_switch$1407 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$74.$result  = \$auto$proc_rom.cc:150:do_switch$1411 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8190$55.$result  = \$auto$proc_rom.cc:150:do_switch$1415 [op_i];
  ...
  assign _06_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$74.$result ;
  assign _07_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$109.$result  == 2'h1;
  assign _08_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$144.$result  == 2'h2;
  assign _09_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$179.$result  == 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _44_ = opgrp_in_ready;
  assign _10_ = _44_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8190$55.$result  +: 1];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8190$212.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$228.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$244.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$260.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:8239$276.op  = 4'hx;

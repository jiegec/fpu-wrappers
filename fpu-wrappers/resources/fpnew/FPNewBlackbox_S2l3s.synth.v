...
module \$paramod$130450b7bdaed3da03d8530b370ed8b6c750cf73\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
...
module \$paramod$173f883ca1221c933f20fe13d408d080883e4a9f\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire [4:0] _00_;
  wire [4:0] _01_;
  output busy_o;
  wire busy_o;
...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:149$610.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:149$611.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$594.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$595.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$604.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$605.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$606.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$607.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$608.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$609.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$594.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$595.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$595.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$594.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:149$610.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:149$611.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$594.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$595.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$604.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$605.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$606.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$607.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$608.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:169$609.inp  = 3'hx;
endmodule
...
module \$paramod$402a5a6afcbfdc0626f6fe033715fa5ea3ed2c68\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$6786d63d422f99df3ae22d09f704ebfc7ceacc30\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$213.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$55.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:8042$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:8042$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:8042$261.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:8042$277.op ;
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$55.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$55.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$55.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$55.$result  == 2'h3;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$55.$result  = _42_(2'h2, 6'h07, { _18_, _16_, _14_ });
  ...
  assign _19_ = _65_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$55.$result  +: 1];
  ...
  \$paramod$130450b7bdaed3da03d8530b370ed8b6c750cf73\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$8e6321f3b21b74c2d3f1c7bf1edf08754071e2b8\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$ff80363d4194fac9f9973525d2acb852ed856f40\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$402a5a6afcbfdc0626f6fe033715fa5ea3ed2c68\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:7996$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:8042$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:8042$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:8042$261.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l3s.preprocessed.v:8042$277.op  = 4'hx;
...
, busy_o);
  ...
  reg [95:0] _106_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _106_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _106_ <= operands_i;
  assign inp_pipe_operands_q[95:0] = _106_;
  ...
  assign out_pipe_result_q[31:0] = _131_;
  ...
  assign _013_ = _042_ ? _079_[9:0] : 10'h000;
  ...
  assign _007_ = _054_ ? _027_[9:0] : 10'h000;
  assign _006_ = _054_ ? _028_[6:0] : _029_[6:0];
  assign normalized_exponent = _059_ ? _007_ : mid_pipe_tent_exp_q[9:0];
  assign norm_shamt = _059_ ? _006_ : mid_pipe_add_shamt_q[6:0];
  assign _003_ = _044_ ? _077_[6:0] : 7'h00;
  assign addend_shamt = _043_ ? 7'h4c : _003_;
  ...
  assign operand_a[31] = _211_(1'h1, { _062_, 1'h0, inp_pipe_operands_q[31] }, { _072_, _071_, _034_ });
  function [30:0] _212_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[22:0] } = _212_(31'h00800001, { 31'h3f800000, inp_pipe_operands_q[30:0] }, { _071_, _037_ });
  assign _008_ = _038_ ? 32'd0 : 32'd2147483648;
  ...
  assign operand_c = _216_(32'd2155872257, { _087_, inp_pipe_operands_q[94:64], _008_ }, { _035_, _070_ });
  ...
  assign _076_ = _025_ - 32'd127;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _077_ = $signed(32'd27) - $signed(exponent_difference);
  assign _078_ = $signed(mid_pipe_exp_prod_q[9:0]) - $signed({ 1'h0, leading_zero_count });
  ...
  assign { _081_[31:10], exponent_product } = _058_ ? 32'd4294967171 : _076_;
  ...
  assign { _082_[76], mid_pipe_sum_q[151:76] } = _051_ ? _060_ : sum_raw;
  ...
  assign { _085_[31:8], pre_round_abs[30:23] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign _087_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[1];
  ...
  assign _082_[75:0] = mid_pipe_sum_q[151:76];
  assign _085_[7:0] = pre_round_abs[30:23];
...
module \$paramod$8e6321f3b21b74c2d3f1c7bf1edf08754071e2b8\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:327$522.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:327$523.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:347$520.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:347$521.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:327$522.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:327$523.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:347$520.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l3s.preprocessed.v:347$521.inp  = 2'hx;
endmodule

module \$paramod$ff80363d4194fac9f9973525d2acb852ed856f40\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;

...
module \$paramod$016932e8d2bfb13ee311efa9d51f98d5c15c9e98\fpnew_cast_multi_BB75A_A18A7 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o
, out_ready_i, busy_o);
  wire [31:0] _000_;
  wire _001_;
  wire _002_;
  ...
  wire [4:0] fp_status;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3749$4342.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3749$4477.fmt ;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3776$4343.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3776$4478.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_4s.preprocessed.v:3985$4351.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_4s.preprocessed.v:3986$4352.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_4s.preprocessed.v:3976$4345.ifmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_4s.preprocessed.v:3970$4344.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_4s.preprocessed.v:3990$4353.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_4s.preprocessed.v:3995$4354.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_4s.preprocessed.v:3997$4355.fmt ;
  ...
  wire [39:0] info;
  wire [7:0] info_q;
  wire [24:0] inp_pipe_aux_q;
  wire [14:0] inp_pipe_dst_fmt_q;
  wire [9:0] inp_pipe_int_fmt_q;
  wire [24:0] inp_pipe_is_boxed_q;
  wire [0:4] inp_pipe_op_mod_q;
  wire [19:0] inp_pipe_op_q;
  wire [159:0] inp_pipe_operands_q;
  wire [0:4] inp_pipe_ready;
  wire [14:0] inp_pipe_rnd_mode_q;
  wire [14:0] inp_pipe_src_fmt_q;
  wire [9:0] inp_pipe_tag_q;
  wire [0:4] inp_pipe_valid_q;
  wire [8:0] input_exp;
  ...
  assign _027_ = src_exp + { 8'h00, src_subnormal[0] };
  assign fp_input_exp = _094_ + src_offset;
  assign { _028_[31:9], destination_exp_q } = $signed(input_exp) + $signed(\fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3776$4343.$result );
  assign _029_ = _098_ + inp_pipe_op_mod_q[4];
  assign _030_ = _096_[4:0] + 32'd1;
  assign _031_ = _096_[4:0] + 32'd2;
  ...
  assign _033_ = src_is_int & mant_is_zero;
  assign fp_result_is_special = _060_ & _065_;
  assign _034_ = input_sign_q & inp_pipe_op_mod_q[4];
  assign _035_ = _034_ & _062_;
  assign fp_regular_status[4] = src_is_int & _069_;
  assign fp_regular_status[2] = _060_ & _036_;
  assign fp_regular_status[1] = uf_after_round & fp_regular_status[0];
  assign _036_ = _063_ & _069_;
  reg [4:0] _133_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _133_ <= 5'h00;
    else if (\gen_input_pipeline[1].reg_ena ) _133_ <= inp_pipe_aux_q[19:15];
  assign inp_pipe_aux_q[14:10] = _133_;
  reg [4:0] _134_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _134_ <= 5'h00;
    else if (\gen_input_pipeline[0].reg_ena ) _134_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[19:15] = _134_;
  reg \inp_pipe_op_mod_q_reg[3] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[3]  <= 1'h0;
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_op_mod_q_reg[3]  <= op_mod_i;
  assign inp_pipe_op_mod_q[1] = \inp_pipe_op_mod_q_reg[3] ;
  reg [2:0] _136_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _136_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _136_ <= src_fmt_i;
  assign inp_pipe_src_fmt_q[11:9] = _136_;
  reg [1:0] _137_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _137_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _137_ <= inp_pipe_tag_q[7:6];
  assign inp_pipe_tag_q[5:4] = _137_;
  reg [1:0] _138_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _138_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _138_ <= inp_pipe_int_fmt_q[7:6];
  assign inp_pipe_int_fmt_q[5:4] = _138_;
  reg \inp_pipe_valid_q_reg[3] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[3]  <= 1'h0;
    else if (_037_) \inp_pipe_valid_q_reg[3]  <= _004_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[3] ;
  reg [2:0] _140_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _140_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _140_ <= inp_pipe_dst_fmt_q[11:9];
  assign inp_pipe_dst_fmt_q[8:6] = _140_;
  reg [2:0] _141_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _141_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _141_ <= dst_fmt_i;
  assign inp_pipe_dst_fmt_q[11:9] = _141_;
  reg [2:0] _142_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _142_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _142_ <= inp_pipe_src_fmt_q[11:9];
  assign inp_pipe_src_fmt_q[8:6] = _142_;
  reg [1:0] _143_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _143_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _143_ <= int_fmt_i;
  assign inp_pipe_int_fmt_q[7:6] = _143_;
  reg [2:0] _144_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _144_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _144_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[11:9] = _144_;
  reg [1:0] _145_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _145_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _145_ <= tag_i;
  assign inp_pipe_tag_q[7:6] = _145_;
  reg [4:0] _146_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _146_ <= 5'h00;
    else if (\gen_input_pipeline[0].reg_ena ) _146_ <= aux_i;
  assign inp_pipe_aux_q[19:15] = _146_;
  reg [3:0] _147_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _147_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _147_ <= op_i;
  assign inp_pipe_op_q[15:12] = _147_;
  reg \inp_pipe_valid_q_reg[2] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[2]  <= 1'h0;
    else if (_038_) \inp_pipe_valid_q_reg[2]  <= _003_;
  assign inp_pipe_valid_q[2] = \inp_pipe_valid_q_reg[2] ;
  reg [31:0] _149_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _149_ <= 32'd0;
    else if (\gen_input_pipeline[1].reg_ena ) _149_ <= inp_pipe_operands_q[127:96];
  assign inp_pipe_operands_q[95:64] = _149_;
  reg [4:0] _150_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _150_ <= 5'h00;
    else if (\gen_input_pipeline[1].reg_ena ) _150_ <= inp_pipe_is_boxed_q[19:15];
  assign inp_pipe_is_boxed_q[14:10] = _150_;
  reg [2:0] _151_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _151_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _151_ <= inp_pipe_rnd_mode_q[11:9];
  assign inp_pipe_rnd_mode_q[8:6] = _151_;
  reg [3:0] _152_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _152_ <= 4'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _152_ <= inp_pipe_op_q[15:12];
  assign inp_pipe_op_q[11:8] = _152_;
  reg \inp_pipe_op_mod_q_reg[2] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[2]  <= 1'h0;
    else if (\gen_input_pipeline[1].reg_ena ) \inp_pipe_op_mod_q_reg[2]  <= inp_pipe_op_mod_q[1];
  assign inp_pipe_op_mod_q[2] = \inp_pipe_op_mod_q_reg[2] ;
  reg [31:0] _154_;
  always @(posedge clk_i, negedge rst_ni)
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[3].reg_ena ) _155_ <= inp_pipe_aux_q[9:5];
  assign inp_pipe_aux_q[4:0] = _155_;
  reg [1:0] _156_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _156_ <= 2'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _156_ <= inp_pipe_tag_q[3:2];
  assign inp_pipe_tag_q[1:0] = _156_;
  reg [1:0] _157_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _157_ <= 2'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _157_ <= inp_pipe_int_fmt_q[3:2];
  assign inp_pipe_int_fmt_q[1:0] = _157_;
  reg [2:0] _158_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _158_ <= 3'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _158_ <= inp_pipe_dst_fmt_q[5:3];
  assign inp_pipe_dst_fmt_q[2:0] = _158_;
  reg [2:0] _159_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _159_ <= 3'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _159_ <= inp_pipe_src_fmt_q[5:3];
  assign inp_pipe_src_fmt_q[2:0] = _159_;
  reg \inp_pipe_op_mod_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[0]  <= 1'h0;
    else if (\gen_input_pipeline[3].reg_ena ) \inp_pipe_op_mod_q_reg[0]  <= inp_pipe_op_mod_q[3];
  assign inp_pipe_op_mod_q[4] = \inp_pipe_op_mod_q_reg[0] ;
  reg [3:0] _161_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _161_ <= 4'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _161_ <= inp_pipe_op_q[7:4];
  assign inp_pipe_op_q[3:0] = _161_;
  reg [2:0] _162_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _162_ <= 3'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _162_ <= inp_pipe_rnd_mode_q[5:3];
  assign inp_pipe_rnd_mode_q[2:0] = _162_;
  reg [4:0] _163_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _163_ <= 5'h00;
    else if (\gen_input_pipeline[3].reg_ena ) _163_ <= inp_pipe_is_boxed_q[9:5];
  assign inp_pipe_is_boxed_q[4:0] = _163_;
  reg [31:0] _164_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _164_ <= 32'd0;
    else if (\gen_input_pipeline[3].reg_ena ) _164_ <= inp_pipe_operands_q[63:32];
  assign inp_pipe_operands_q[31:0] = _164_;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_039_) \inp_pipe_valid_q_reg[0]  <= _001_;
  assign inp_pipe_valid_q[4] = \inp_pipe_valid_q_reg[0] ;
  reg [4:0] _166_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _166_ <= 5'h00;
    else if (\gen_input_pipeline[2].reg_ena ) _166_ <= inp_pipe_aux_q[14:10];
  assign inp_pipe_aux_q[9:5] = _166_;
  reg [1:0] _167_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _167_ <= 2'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _167_ <= inp_pipe_tag_q[5:4];
  assign inp_pipe_tag_q[3:2] = _167_;
  reg [1:0] _168_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _168_ <= 2'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _168_ <= inp_pipe_int_fmt_q[5:4];
  assign inp_pipe_int_fmt_q[3:2] = _168_;
  reg [2:0] _169_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _169_ <= 3'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _169_ <= inp_pipe_dst_fmt_q[8:6];
  assign inp_pipe_dst_fmt_q[5:3] = _169_;
  reg [2:0] _170_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _170_ <= 3'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _170_ <= inp_pipe_src_fmt_q[8:6];
  assign inp_pipe_src_fmt_q[5:3] = _170_;
  reg \inp_pipe_op_mod_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[1]  <= 1'h0;
    else if (\gen_input_pipeline[2].reg_ena ) \inp_pipe_op_mod_q_reg[1]  <= inp_pipe_op_mod_q[2];
  assign inp_pipe_op_mod_q[3] = \inp_pipe_op_mod_q_reg[1] ;
  reg [3:0] _172_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _172_ <= 4'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _172_ <= inp_pipe_op_q[11:8];
  assign inp_pipe_op_q[7:4] = _172_;
  reg [2:0] _173_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _173_ <= 3'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _173_ <= inp_pipe_rnd_mode_q[8:6];
  assign inp_pipe_rnd_mode_q[5:3] = _173_;
  reg [4:0] _174_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _174_ <= 5'h00;
    else if (\gen_input_pipeline[2].reg_ena ) _174_ <= inp_pipe_is_boxed_q[14:10];
  assign inp_pipe_is_boxed_q[9:5] = _174_;
  reg [31:0] _175_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _175_ <= 32'd0;
    else if (\gen_input_pipeline[2].reg_ena ) _175_ <= inp_pipe_operands_q[95:64];
  assign inp_pipe_operands_q[63:32] = _175_;
  reg \inp_pipe_valid_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[1]  <= 1'h0;
    else if (_040_) \inp_pipe_valid_q_reg[1]  <= _002_;
  assign inp_pipe_valid_q[3] = \inp_pipe_valid_q_reg[1] ;
  assign _037_ = | { in_ready_o, flush_i };
  assign _038_ = | { inp_pipe_ready[1], flush_i };
  assign _039_ = | { inp_pipe_ready[3], flush_i };
  ...
  assign _041_ = $signed(input_exp) >= $signed(_029_);
  assign _042_ = $signed(destination_exp_q) >= $signed(_099_);
  assign _043_ = $signed(destination_exp_q) >= $signed(_053_);
  assign _044_ = _060_ && info_q[4];
  assign _045_ = _048_ && _043_;
  assign _046_ = _042_ || _044_;
  assign _047_ = $signed(input_exp) < $signed(32'd4294967295);
  assign _048_ = $signed(destination_exp_q) < $signed(32'd1);
  assign _049_ = $signed(destination_exp_q) < $signed(_053_);
  ...
  assign _052_ = - int_value;
  assign _053_ = - $signed(_000_);
  assign _054_ = - rounded_abs;
  assign _055_ = ~ inp_pipe_valid_q[1];
  assign _056_ = ~ inp_pipe_valid_q[2];
  assign _057_ = ~ inp_pipe_valid_q[3];
  assign _058_ = ~ inp_pipe_valid_q[4];
  assign _059_ = ~ inp_pipe_op_mod_q[4];
  assign _061_ = ~ info_q[0];
  assign _062_ = ~ rounded_int_res_zero;
  assign _060_ = ~ src_is_int;
  assign _063_ = ~ info_q[4];
  assign in_ready_o = inp_pipe_ready[1] | _055_;
  assign inp_pipe_ready[1] = inp_pipe_ready[2] | _056_;
  assign inp_pipe_ready[2] = inp_pipe_ready[3] | _057_;
  assign inp_pipe_ready[3] = out_ready_i | _058_;
  assign _064_ = info_q[5] | info_q[3];
  assign _065_ = _064_ | _061_;
  assign _066_ = info_q[3] | info_q[4];
  assign _067_ = _066_ | of_before_round;
  assign _068_ = _067_ | _061_;
  assign int_result_is_special = _068_ | _035_;
  assign _069_ = of_before_round | of_after_round;
  assign _070_ = _076_ | _036_;
  assign _016_ = _049_ ? _032_[4:0] : _096_[4:0];
  assign _014_ = _049_ ? 9'h000 : destination_exp_q;
  assign _015_ = _045_ ? _101_[4:0] : _016_;
  assign _011_ = _045_ ? 9'h000 : _014_;
  assign _012_ = _046_ ? 1'h1 : 1'h0;
  assign _009_ = _046_ ? 49'h1ffffffffffff : { input_mant, 25'h0000000 };
  assign _006_ = _046_ ? _100_[8:0] : _011_;
  assign _013_ = _046_ ? _096_[4:0] : _015_;
  assign _010_ = _047_ ? 5'h01 : _097_[4:0];
  assign _008_ = _041_ ? 1'h1 : 1'h0;
  assign _005_ = _041_ ? 5'h00 : _010_;
  function [31:0] _233_;
    input [31:0] a;
    input [127:0] b;
    input [3:0] s;
  ...
  assign _071_ = _233_(32'hxxxxxxxx, 128'h00000008000000100000002000000040, { _075_, _074_, _073_, _072_ });
  assign _072_ = inp_pipe_int_fmt_q[1:0] == 2'h3;
  assign _073_ = inp_pipe_int_fmt_q[1:0] == 2'h2;
  assign _074_ = inp_pipe_int_fmt_q[1:0] == 2'h1;
  assign _075_ = ! inp_pipe_int_fmt_q[1:0];
  assign _007_ = dst_is_int_q ? _071_ : 32'hxxxxxxxx;
  assign of_before_round = dst_is_int_q ? _008_ : _012_;
  assign denorm_shamt = dst_is_int_q ? _005_ : _013_;
  assign preshift_mant = dst_is_int_q ? { input_mant, 25'h0000000 } : _009_;
  assign final_exp = dst_is_int_q ? destination_exp_q : _006_;
  assign fp_round_sticky_bits[0] = | destination_mant[23:0];
  assign int_round_sticky_bits[0] = | destination_mant[47:0];
  assign _076_ = | destination_mant[24:0];
  assign int_regular_status[0] = | destination_mant;
  assign busy_o = | { inp_pipe_valid_q[1:4], in_valid_i };
  wire [95:0] _312_ = 96'hffffffffffffffffffffffff;
  assign int_value = _312_[$signed({ _017_[31:3], 3'h0 }) +: 24];
  wire [119:0] _313_ = { 96'hffffffffffffffffffffffff, fmt_mantissa[23], inp_pipe_operands_q[22:0] };
  assign _077_ = _313_[$signed({ _018_[31:3], 3'h0 }) +: 24];
  wire [44:0] _314_ = { 37'h1ffffffffe, inp_pipe_operands_q[30:23] };
  assign src_exp = _314_[$signed(_019_) +: 9];
  wire [39:0] _315_ = { 32'hffffffff, fmt_mantissa[23], info[6:0] };
  assign src_subnormal[0] = _315_[$signed(_026_) +: 1];
  wire [44:0] _316_ = 45'h1ffffffffe00;
  assign src_offset = _316_[$signed(_019_) +: 9];
  wire [4:0] _317_ = { 4'hf, inp_pipe_operands_q[31] };
  assign _078_ = _317_[inp_pipe_src_fmt_q[2:0] +: 1];
  wire [39:0] _318_ = { 32'hffffffff, fmt_mantissa[23], info[6:0] };
  assign info_q = _318_[$signed({ 26'h0000000, inp_pipe_src_fmt_q[2:0], 3'h0 }) +: 8];
  wire [319:0] _319_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _000_ = _319_[$signed(_086_) +: 32];
  wire [159:0] _320_ = { 129'h1fffffffffffffffffffffffffffffffe, final_exp[7:0], destination_mant[47:25] };
  assign _080_ = _320_[$signed({ 24'h000000, inp_pipe_dst_fmt_q[2:0], 5'h00 }) +: 32];
  wire [4:0] _321_ = { 4'hf, fmt_uf_after_round[0] };
  assign uf_after_round = _321_[inp_pipe_dst_fmt_q[2:0] +: 1];
  wire [4:0] _322_ = { 4'hf, fmt_of_after_round[0] };
  assign of_after_round = _322_[inp_pipe_dst_fmt_q[2:0] +: 1];
  wire [159:0] _323_ = { 128'hffffffffffffffffffffffffffffffff, \gen_special_results[0].active_format.special_results.special_res  };
  assign fp_special_result = _323_[$signed({ 24'h000000, inp_pipe_dst_fmt_q[2:0], 5'h00 }) +: 32];
  wire [127:0] _324_ = 128'hffffffffffffffffffffffffffffffff;
  assign int_special_result = _324_[$signed({ 25'h0000000, inp_pipe_int_fmt_q[1:0], 5'h00 }) +: 32];
  wire [159:0] _325_ = { 128'hffffffffffffffffffffffffffffffff, fmt_result[31:0] };
  assign _081_ = _325_[$signed({ 24'h000000, inp_pipe_dst_fmt_q[2:0], 5'h00 }) +: 32];
  wire [319:0] _326_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _082_ = _326_[$signed(_088_) +: 32];
  wire [319:0] _327_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _079_ = _327_[$signed(_087_) +: 32];
  assign _083_ = $signed(32'd1) << _091_;
  assign _084_ = $signed(32'd1) << _092_;
  assign input_mant = encoded_mant << renorm_shamt;
  assign _085_ = $signed(32'd1) << _079_;
  assign destination_mant = preshift_mant >> denorm_shamt;
  assign _086_ = _020_ - 32'd32;
  assign _088_ = _022_ - 32'd32;
  assign _087_ = _021_ - 32'd32;
  assign { _090_[31:26], _051_[31:6] } = 32'd4 - inp_pipe_src_fmt_q[2:0];
  assign _091_ = _082_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3749$4342.$result  = $signed(_083_) - $signed(32'd1);
  assign { _089_[31:26], _050_[31:6] } = 32'd4 - inp_pipe_dst_fmt_q[2:0];
  assign _092_ = _079_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3776$4343.$result  = $signed(_084_) - $signed(32'd1);
  assign _093_ = _027_ - \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3749$4342.$result [8:0];
  assign _094_ = _093_ - { 1'h0, renorm_shamt };
  assign { _095_[31:9], int_input_exp } = 32'd23 - { 1'h0, renorm_shamt };
  assign _096_ = 32'd23 - _000_;
  assign _097_ = 32'd4294967295 - input_exp;
  assign _098_ = _007_ - 32'd1;
  assign _099_ = $signed(_085_) - $signed(32'd1);
  assign _100_ = $signed(_085_) - $signed(32'd2);
  assign _101_ = _030_ - destination_exp_q;
  assign _102_ = in_ready_o ? in_valid_i : 1'hx;
  assign _004_ = flush_i ? 1'h0 : _102_;
  assign _103_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _003_ = flush_i ? 1'h0 : _103_;
  assign _104_ = inp_pipe_ready[2] ? inp_pipe_valid_q[2] : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _104_;
  assign _105_ = inp_pipe_ready[3] ? inp_pipe_valid_q[3] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _105_;
  assign int_mantissa = int_sign ? _052_ : int_value;
  assign encoded_mant = src_is_int ? int_mantissa : _077_;
  assign input_sign_q = src_is_int ? int_sign : _078_;
  ...
  assign pre_round_abs = dst_is_int_q ? int_special_result : _080_;
  assign fmt_result[31:0] = _033_ ? 32'd0 : { rounded_sign, rounded_abs[30:0] };
  assign rounded_int_res = rounded_sign ? _054_ : rounded_abs;
  assign \gen_special_results[0].active_format.special_results.special_res  = info_q[5] ? { input_sign_q, 31'h00000000 } : 32'd2143289344;
  assign fp_regular_status[0] = src_is_int ? _076_ : _070_;
  ...
  assign _028_[8:0] = destination_exp_q;
  assign _050_[5:0] = 6'h00;
  assign _051_[5:0] = 6'h00;
  assign _089_[25:0] = _050_[31:6];
  assign _090_[25:0] = _051_[31:6];
  assign _095_[8:0] = int_input_exp;
  ...
  assign \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3749$4477.fmt  = 3'hx;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3776$4478.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_4s.preprocessed.v:3985$4351.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_4s.preprocessed.v:3986$4352.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_4s.preprocessed.v:3976$4345.ifmt  = 2'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_4s.preprocessed.v:3970$4344.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_4s.preprocessed.v:3990$4353.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_4s.preprocessed.v:3995$4354.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_4s.preprocessed.v:3997$4355.fmt  = 3'hx;
  ...
  assign inp_pipe_aux_q[24:20] = aux_i;
  assign inp_pipe_dst_fmt_q[14:12] = dst_fmt_i;
  assign inp_pipe_int_fmt_q[9:8] = int_fmt_i;
  assign inp_pipe_is_boxed_q[24:20] = is_boxed_i;
  assign inp_pipe_op_mod_q[0] = op_mod_i;
  assign inp_pipe_op_q[19:16] = op_i;
  assign inp_pipe_operands_q[159:128] = operands_i;
  assign { inp_pipe_ready[0], inp_pipe_ready[4] } = { in_ready_o, out_ready_i };
  assign inp_pipe_rnd_mode_q[14:12] = rnd_mode_i;
  assign inp_pipe_src_fmt_q[14:12] = src_fmt_i;
  assign inp_pipe_tag_q[9:8] = tag_i;
  ...
  assign mid_pipe_op_mod_q = inp_pipe_op_mod_q[4];
  ...
  assign mid_pipe_valid_q = inp_pipe_valid_q[4];
  assign op_mod_q = inp_pipe_op_mod_q[4];
  assign op_mod_q2 = inp_pipe_op_mod_q[4];
  ...
  assign out_pipe_valid_q = inp_pipe_valid_q[4];
  assign out_valid_o = inp_pipe_valid_q[4];
  assign renorm_shamt_sgn = { 1'h0, renorm_shamt };
  assign result_d = result_o;
  assign rnd_mode_q = inp_pipe_rnd_mode_q[2:0];
  assign src_bias = \fpnew_pkg_bias$func$FPNewBlackbox_4s.preprocessed.v:3749$4342.$result [8:0];
  ...
  assign sv2v_tmp_25EE6 = inp_pipe_valid_q[4];
  ...
  assign sv2v_tmp_88AB6 = inp_pipe_op_mod_q[4];
  ...
  assign sv2v_tmp_CB10A = inp_pipe_valid_q[4];
...
module \$paramod$17a466c092bb1c5e5f9a742462077ced9fe9abf2\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  ...
  \$paramod$8dc4d45d629d00a6e5a3847b03a706db9029b2ef\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$2afffce860085372ff5e558e391f98a4d7624c82\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire _01_;
  wire _02_;
  ...
  \$paramod$45bf7eecc1c70d60743ca75974981e3b589c54c6\fpnew_opgroup_multifmt_slice_607F1_85D30  \gen_merged_slice.i_multifmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .extension_bit_o(fmt_outputs[2]),
...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:149$2561.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:149$2562.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2545.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2546.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2555.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2556.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2557.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2558.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2559.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2560.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2545.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2546.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2546.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2545.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2545.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2546.$result [1:0], idx_o };
  ...
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:149$2561.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:149$2562.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2545.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2546.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2555.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2556.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2557.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2558.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2559.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_4s.preprocessed.v:169$2560.inp  = 3'hx;
endmodule
...
module \$paramod$39276a4e351b8f35aab5e3162b943e6d7e0c2b51\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  wire [71:0] arbiter_output;
  ...
  wire [4:0] _6_ = { 4'h0, fmt_in_ready[0] };
  assign _1_ = _6_[dst_fmt_i +: 1];
  \$paramod$f71409120a2c0685621825fa4df9ed68dc8ee9f1\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .extension_bit_o(fmt_outputs[2]),
    .flush_i(flush_i),
...
, busy_o);
  ...
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$2180.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$2181.fmt ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$588.$result ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$589.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7334$2182.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7334$2183.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1003.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1100.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1197.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1775.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1872.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1969.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7473$1270.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7473$2042.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_4s.preprocessed.v:7470$1231.ifmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_4s.preprocessed.v:7470$2003.ifmt ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$588.$result  = _012_ + 32'd1;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$589.$result  = _015_ + 32'd1;
  assign _013_ = { _024_[31:6], 6'h00 } + 32'd63;
  assign _014_ = { _024_[31:6], 6'h00 } + 32'd31;
  assign _015_ = _034_ + _035_;
  assign _016_ = \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$589.$result  + 32'd16;
  ...
  assign is_up_cast = \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$588.$result  > \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$589.$result ;
  ...
  assign _036_ = operands_i[63:0] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$589.$result ;
  ...
  \$paramod$016932e8d2bfb13ee311efa9d51f98d5c15c9e98\fpnew_cast_multi_BB75A_A18A7  \gen_num_lanes[0].active_lane.genblk1.genblk1.genblk1.lane_instance.i_fpnew_cast_multi  (
  ...
  \$paramod$016932e8d2bfb13ee311efa9d51f98d5c15c9e98\fpnew_cast_multi_BB75A_A18A7  \gen_num_lanes[1].active_lane.genblk1.genblk1.genblk1.lane_instance.i_fpnew_cast_multi  (
    .aux_i({ dst_fmt_is_int, vectorial_op_i, dst_fmt }),
    .aux_o(lane_aux[9:5]),
    .busy_o(lane_busy[1]),
    .clk_i(clk_i),
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$2180.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$2181.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7334$2182.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7334$2183.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1003.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1100.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1197.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1775.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1872.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$1969.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7473$1270.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7473$2042.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_4s.preprocessed.v:7470$1231.ifmt  = 2'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_4s.preprocessed.v:7470$2003.ifmt  = 2'hx;
...
module \$paramod$480715fa5720b34929d30f033e3c952da00ab7dc\fpnew_opgroup_multifmt_slice_607F1_85D30 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire [31:0] _01_;
  wire [31:0] _02_;
  ...
  wire flush_i;
  wire [319:0] fmt_slice_result;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$2788.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$3971.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$3972.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7334$3973.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7334$3974.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$3202.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$3299.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$3786.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$3883.fmt ;
  wire \gen_num_lanes[0].active_lane.in_valid ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$2788.$result  = _04_ + 32'd1;
  assign \gen_num_lanes[1].active_lane.in_valid  = in_valid_i & vectorial_op_i;
  assign \gen_num_lanes[1].active_lane.out_ready  = out_ready_i & lane_aux[3];
  assign lane_out_valid[1] = \gen_num_lanes[1].active_lane.out_valid  & lane_aux[3];
  assign status_o = lane_status[4:0] | lane_status[9:5];
  ...
  assign { _10_[63:32], \gen_num_lanes[1].active_lane.local_operands [31:0] } = operands_i[63:0] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$2788.$result ;
  assign { _11_[63:32], \gen_num_lanes[1].active_lane.local_operands [63:32] } = operands_i[127:64] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$2788.$result ;
  ...
  \$paramod$4db9f8af800cb303c2f508ce95b54b0f3a13a37f\fpnew_divsqrt_multi_1A2E7_2C16F  \gen_num_lanes[0].active_lane.genblk1.lane_instance.i_fpnew_divsqrt_multi  (
  ...
  \$paramod$4db9f8af800cb303c2f508ce95b54b0f3a13a37f\fpnew_divsqrt_multi_1A2E7_2C16F  \gen_num_lanes[1].active_lane.genblk1.lane_instance.i_fpnew_divsqrt_multi  (
    .aux_i({ 1'h0, vectorial_op_i, dst_fmt_i }),
    .aux_o(lane_aux[9:5]),
    .busy_o(lane_busy[1]),
    .clk_i(clk_i),
  ...
  assign { fmt_slice_result[319:288], fmt_slice_result[286:0] } = { extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, \gen_num_lanes[1].local_result , \gen_num_lanes[0].local_result  };
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$3971.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7333$3972.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7334$3973.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7334$3974.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$3202.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$3299.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$3786.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_4s.preprocessed.v:7466$3883.fmt  = 3'hx;
  assign \gen_num_lanes[0].active_lane.in_valid  = in_valid_i;
...
module \$paramod$4db9f8af800cb303c2f508ce95b54b0f3a13a37f\fpnew_divsqrt_multi_1A2E7_2C16F (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, dst_fmt_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire [14:0] inp_pipe_dst_fmt_q;
  wire [19:0] inp_pipe_op_q;
  wire [319:0] inp_pipe_operands_q;
  wire [0:4] inp_pipe_ready;
  wire [14:0] inp_pipe_rnd_mode_q;
  wire [9:0] inp_pipe_tag_q;
  wire [0:4] inp_pipe_valid_q;
  ...
  assign \gen_input_pipeline[2].reg_ena  = inp_pipe_ready[2] & inp_pipe_valid_q[2];
  assign \gen_input_pipeline[3].reg_ena  = inp_pipe_ready[3] & inp_pipe_valid_q[3];
  assign _018_ = inp_pipe_valid_q[4] & _031_;
  assign _019_ = _018_ & in_ready;
  assign div_valid = _019_ & _038_;
  assign _020_ = inp_pipe_valid_q[4] & _033_;
  assign _021_ = _020_ & in_ready;
  assign sqrt_valid = _021_ & _038_;
  always @(posedge clk_i, negedge rst_ni)
  ...
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[1]  <= 1'h0;
    else if (_025_) \inp_pipe_valid_q_reg[1]  <= _001_;
  assign inp_pipe_valid_q[3] = \inp_pipe_valid_q_reg[1] ;
  reg [3:0] _064_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _064_ <= 4'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _064_ <= inp_pipe_op_q[15:12];
  assign inp_pipe_op_q[11:8] = _064_;
  reg [3:0] _065_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _065_ <= 4'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _065_ <= inp_pipe_op_q[11:8];
  assign inp_pipe_op_q[7:4] = _065_;
  reg [2:0] _066_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _066_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _066_ <= inp_pipe_rnd_mode_q[11:9];
  assign inp_pipe_rnd_mode_q[8:6] = _066_;
  reg [2:0] _067_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _067_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _067_ <= inp_pipe_dst_fmt_q[11:9];
  assign inp_pipe_dst_fmt_q[8:6] = _067_;
  always @(posedge clk_i)
    if (hold_result) held_status_q <= unit_status;
  reg [63:0] _069_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _069_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[1].reg_ena ) _069_ <= inp_pipe_operands_q[255:192];
  assign inp_pipe_operands_q[191:128] = _069_;
  reg \inp_pipe_valid_q_reg[2] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[2]  <= 1'h0;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[3].reg_ena ) _078_ <= inp_pipe_aux_q[9:5];
  assign inp_pipe_aux_q[4:0] = _078_;
  reg [1:0] _079_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _079_ <= 2'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _079_ <= inp_pipe_tag_q[3:2];
  assign inp_pipe_tag_q[1:0] = _079_;
  reg [2:0] _080_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _080_ <= 3'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _080_ <= inp_pipe_dst_fmt_q[5:3];
  assign inp_pipe_dst_fmt_q[2:0] = _080_;
  reg [3:0] _081_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _081_ <= 4'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _081_ <= inp_pipe_op_q[7:4];
  assign inp_pipe_op_q[3:0] = _081_;
  reg [2:0] _082_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _082_ <= 3'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _082_ <= inp_pipe_rnd_mode_q[5:3];
  assign inp_pipe_rnd_mode_q[2:0] = _082_;
  reg [1:0] _083_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _083_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _083_ <= inp_pipe_tag_q[7:6];
  assign inp_pipe_tag_q[5:4] = _083_;
  reg [63:0] _084_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _084_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[3].reg_ena ) _084_ <= inp_pipe_operands_q[127:64];
  assign inp_pipe_operands_q[63:0] = _084_;
  reg [2:0] _085_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _085_ <= 3'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _085_ <= inp_pipe_rnd_mode_q[8:6];
  assign inp_pipe_rnd_mode_q[5:3] = _085_;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[1].reg_ena ) _087_ <= inp_pipe_aux_q[19:15];
  assign inp_pipe_aux_q[14:10] = _087_;
  reg [4:0] _088_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _088_ <= 5'h00;
    else if (\gen_input_pipeline[2].reg_ena ) _088_ <= inp_pipe_aux_q[14:10];
  assign inp_pipe_aux_q[9:5] = _088_;
  reg [1:0] _089_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _089_ <= 2'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _089_ <= inp_pipe_tag_q[5:4];
  assign inp_pipe_tag_q[3:2] = _089_;
  reg [63:0] _090_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _090_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[2].reg_ena ) _090_ <= inp_pipe_operands_q[191:128];
  assign inp_pipe_operands_q[127:64] = _090_;
  reg [2:0] _091_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _091_ <= 3'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _091_ <= inp_pipe_dst_fmt_q[8:6];
  assign inp_pipe_dst_fmt_q[5:3] = _091_;
  assign _022_ = { _039_, out_ready_i, flush_i } != 3'h4;
  assign _023_ = { _040_, unit_done, flush_i } != 3'h4;
  assign _024_ = { _041_, _032_, flush_i } != 3'h4;
  assign _025_ = | { inp_pipe_ready[2], flush_i };
  assign _026_ = | { inp_pipe_ready[1], flush_i };
  assign _027_ = | { in_ready_o, flush_i };
  assign _028_ = | { inp_pipe_ready[3], flush_i };
  assign _029_ = & { _024_, _023_, _022_ };
  assign _030_ = | { _040_, _039_ };
  assign _031_ = inp_pipe_op_q[3:0] == 4'h4;
  assign _032_ = inp_pipe_valid_q[4] && unit_ready;
  ...
  assign inp_pipe_ready[3] = in_ready | _037_;
  assign op_starting = div_valid | sqrt_valid;
  assign state_d = flush_i ? 2'h0 : _005_;
  assign out_valid_o = flush_i ? 1'h0 : _004_;
  assign unit_busy = flush_i ? 1'h0 : _006_;
  assign _017_ = out_ready_i ? _016_ : 2'hx;
  assign _012_ = out_ready_i ? _014_ : 1'h0;
  assign _016_ = _032_ ? 2'h1 : 2'h0;
  assign _014_ = _032_ ? 1'h1 : 1'h0;
  assign _015_ = out_ready_i ? _016_ : 2'h2;
  assign _011_ = out_ready_i ? 1'h0 : 1'h1;
  ...
  assign _005_ = _128_(2'h0, { _010_, _013_, _017_ }, { _041_, _040_, _039_ });
  function [0:0] _129_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign in_ready = _129_(1'h0, { 1'h1, _008_, _012_ }, { _041_, _040_, _039_ });
  ...
  assign _004_ = _134_(1'h0, { _009_, 1'h1 }, { _040_, _039_ });
  ...
  assign divsqrt_fmt = _137_(2'h2, 6'h07, { _044_, _043_, _042_ });
  assign _042_ = inp_pipe_dst_fmt_q[2:0] == 3'h4;
  assign _043_ = inp_pipe_dst_fmt_q[2:0] == 3'h1;
  assign _044_ = ! inp_pipe_dst_fmt_q[2:0];
  assign busy_o = | { unit_busy, inp_pipe_valid_q[1:4], out_valid_o, in_valid_i };
  assign _045_ = in_ready_o ? in_valid_i : 1'hx;
  assign _003_ = flush_i ? 1'h0 : _045_;
  assign _046_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _046_;
  assign _047_ = inp_pipe_ready[2] ? inp_pipe_valid_q[2] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _047_;
  assign _048_ = inp_pipe_ready[3] ? inp_pipe_valid_q[3] : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _048_;
  ...
  assign in_valid_q = inp_pipe_valid_q[4];
  assign inp_pipe_aux_q[24:20] = aux_i;
  assign inp_pipe_dst_fmt_q[14:12] = dst_fmt_i;
  assign inp_pipe_op_q[19:16] = op_i;
  assign inp_pipe_operands_q[319:256] = operands_i;
  assign { inp_pipe_ready[0], inp_pipe_ready[4] } = { in_ready_o, in_ready };
  assign inp_pipe_rnd_mode_q[14:12] = rnd_mode_i;
  assign inp_pipe_tag_q[9:8] = tag_i;
  assign inp_pipe_valid_q[0] = in_valid_i;
...
module \$paramod$8dc4d45d629d00a6e5a3847b03a706db9029b2ef\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
  ...
  assign lane_status[4:0] = \gen_num_lanes[0].active_lane.out_valid  ? \gen_num_lanes[0].active_lane.op_status  : 5'h00;
  assign lane_status[9:5] = lane_out_valid[1] ? \gen_num_lanes[1].active_lane.op_status  : 5'h00;
  \$paramod$e67b771112b52550702da183e5d1671fb52b292f\fpnew_fma_FC83A_5615B  \gen_num_lanes[0].active_lane.lane_instance.i_fma  (
  ...
  \$paramod$e67b771112b52550702da183e5d1671fb52b292f\fpnew_fma_FC83A_5615B  \gen_num_lanes[1].active_lane.lane_instance.i_fma  (
    .aux_i(vectorial_op_i),
...
module \$paramod$ab72f4fd2899455a665e964f635289d4a18a5bbf\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire _01_;
  wire _02_;
  ...
  assign _03_ = _12_[$signed({ _00_[31:1], 1'h0 }) +: 2];
  assign { _04_[31], _00_[31:1] } = 32'd4 - dst_fmt_i;
  \$paramod$480715fa5720b34929d30f033e3c952da00ab7dc\fpnew_opgroup_multifmt_slice_607F1_85D30  \gen_merged_slice.i_multifmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .extension_bit_o(fmt_outputs[2]),
...
module \$paramod$aed3427b969ae608fbd22f3dfc56ffd7a78e042d\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$198.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$41.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7876$214.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7876$230.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7876$246.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7876$262.op ;
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$41.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$41.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$41.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$41.$result  == 2'h3;
  assign _14_ = | _13_;
  assign _18_ = | _17_;
  assign _16_ = | _15_;
  function [1:0] _41_;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$41.$result  = _41_(2'h2, 6'h07, { _18_, _16_, _14_ });
  ...
  assign _19_ = _64_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$41.$result  +: 1];
  ...
  \$paramod$17a466c092bb1c5e5f9a742462077ced9fe9abf2\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$ab72f4fd2899455a665e964f635289d4a18a5bbf\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$39276a4e351b8f35aab5e3162b943e6d7e0c2b51\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$2afffce860085372ff5e558e391f98a4d7624c82\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7827$198.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7876$214.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7876$230.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7876$246.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_4s.preprocessed.v:7876$262.op  = 4'hx;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_4s.preprocessed.v:327$496.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_4s.preprocessed.v:327$497.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_4s.preprocessed.v:347$494.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_4s.preprocessed.v:347$495.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_4s.preprocessed.v:327$496.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_4s.preprocessed.v:327$497.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_4s.preprocessed.v:347$494.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_4s.preprocessed.v:347$495.inp  = 2'hx;
endmodule

module \$paramod$e67b771112b52550702da183e5d1671fb52b292f\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire [0:4] inp_pipe_aux_q;
  wire [14:0] inp_pipe_is_boxed_q;
  wire [0:4] inp_pipe_op_mod_q;
  wire [19:0] inp_pipe_op_q;
  wire [479:0] inp_pipe_operands_q;
  wire [0:4] inp_pipe_ready;
  wire [14:0] inp_pipe_rnd_mode_q;
  wire [9:0] inp_pipe_tag_q;
  wire [0:4] inp_pipe_valid_q;
  ...
  assign _029_ = $signed(32'd26) + $signed(exponent_product);
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[2].reg_ena ) \inp_pipe_aux_q_reg[1]  <= inp_pipe_aux_q[2];
  assign inp_pipe_aux_q[3] = \inp_pipe_aux_q_reg[1] ;
  reg \inp_pipe_valid_q_reg[3] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[3]  <= 1'h0;
    else if (_032_) \inp_pipe_valid_q_reg[3]  <= _003_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[3] ;
  reg [95:0] _109_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _109_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _109_ <= operands_i;
  assign inp_pipe_operands_q[383:288] = _109_;
  reg [1:0] _110_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _110_ <= 2'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _110_ <= inp_pipe_tag_q[5:4];
  assign inp_pipe_tag_q[3:2] = _110_;
  reg [95:0] _111_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _111_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[3].reg_ena ) _111_ <= inp_pipe_operands_q[191:96];
  assign inp_pipe_operands_q[95:0] = _111_;
  reg [2:0] _112_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _112_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _112_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[11:9] = _112_;
  reg [2:0] _113_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _113_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _113_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[11:9] = _113_;
  reg \inp_pipe_op_mod_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[1]  <= 1'h0;
    else if (\gen_input_pipeline[2].reg_ena ) \inp_pipe_op_mod_q_reg[1]  <= inp_pipe_op_mod_q[2];
  ...
  reg [3:0] _115_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _115_ <= 4'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _115_ <= inp_pipe_op_q[11:8];
  assign inp_pipe_op_q[7:4] = _115_;
  reg [2:0] _116_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _116_ <= 3'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _116_ <= inp_pipe_rnd_mode_q[8:6];
  assign inp_pipe_rnd_mode_q[5:3] = _116_;
  reg [2:0] _117_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _117_ <= 3'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _117_ <= inp_pipe_is_boxed_q[8:6];
  assign inp_pipe_is_boxed_q[5:3] = _117_;
  reg [95:0] _118_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _118_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[2].reg_ena ) _118_ <= inp_pipe_operands_q[287:192];
  assign inp_pipe_operands_q[191:96] = _118_;
  reg \inp_pipe_valid_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[1]  <= 1'h0;
    else if (_033_) \inp_pipe_valid_q_reg[1]  <= _001_;
  assign inp_pipe_valid_q[3] = \inp_pipe_valid_q_reg[1] ;
  reg \inp_pipe_aux_q_reg[2] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_aux_q_reg[2]  <= 1'h0;
    else if (\gen_input_pipeline[1].reg_ena ) \inp_pipe_aux_q_reg[2]  <= inp_pipe_aux_q[1];
  assign inp_pipe_aux_q[2] = \inp_pipe_aux_q_reg[2] ;
  reg [1:0] _121_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _121_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _121_ <= inp_pipe_tag_q[7:6];
  assign inp_pipe_tag_q[5:4] = _121_;
  reg \inp_pipe_op_mod_q_reg[2] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[2]  <= 1'h0;
    else if (\gen_input_pipeline[1].reg_ena ) \inp_pipe_op_mod_q_reg[2]  <= inp_pipe_op_mod_q[1];
  ...
  reg [3:0] _123_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _123_ <= 4'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _123_ <= inp_pipe_op_q[15:12];
  assign inp_pipe_op_q[11:8] = _123_;
  reg [2:0] _124_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _124_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _124_ <= inp_pipe_rnd_mode_q[11:9];
  assign inp_pipe_rnd_mode_q[8:6] = _124_;
  reg [2:0] _125_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _125_ <= 3'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _125_ <= inp_pipe_is_boxed_q[11:9];
  assign inp_pipe_is_boxed_q[8:6] = _125_;
  reg [95:0] _126_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _126_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[1].reg_ena ) _126_ <= inp_pipe_operands_q[383:288];
  assign inp_pipe_operands_q[287:192] = _126_;
  reg \inp_pipe_valid_q_reg[2] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[2]  <= 1'h0;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_aux_q_reg[3]  <= aux_i;
  assign inp_pipe_aux_q[1] = \inp_pipe_aux_q_reg[3] ;
  reg [1:0] _129_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _129_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _129_ <= tag_i;
  assign inp_pipe_tag_q[7:6] = _129_;
  reg \inp_pipe_op_mod_q_reg[3] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[3]  <= 1'h0;
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_op_mod_q_reg[3]  <= op_mod_i;
  ...
  reg [3:0] _131_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _131_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _131_ <= op_i;
  assign inp_pipe_op_q[15:12] = _131_;
  reg \inp_pipe_aux_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_aux_q_reg[0]  <= 1'h0;
    else if (\gen_input_pipeline[3].reg_ena ) \inp_pipe_aux_q_reg[0]  <= inp_pipe_aux_q[3];
  assign inp_pipe_aux_q[4] = \inp_pipe_aux_q_reg[0] ;
  reg [1:0] _133_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _133_ <= 2'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _133_ <= inp_pipe_tag_q[3:2];
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[3].reg_ena ) _135_ <= inp_pipe_op_q[7:4];
  assign inp_pipe_op_q[3:0] = _135_;
  reg [2:0] _136_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _136_ <= 3'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _136_ <= inp_pipe_is_boxed_q[5:3];
  assign inp_pipe_is_boxed_q[2:0] = _136_;
  reg [2:0] _137_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _137_ <= 3'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _137_ <= inp_pipe_rnd_mode_q[5:3];
  assign inp_pipe_rnd_mode_q[2:0] = _137_;
  assign _031_ = | { inp_pipe_ready[3], flush_i };
  ...
  assign _045_ = $signed(exponent_difference) <= $signed(32'd0);
  assign _046_ = $signed(exponent_difference) <= $signed(32'd2);
  ...
  assign _051_ = effective_subtraction && _069_;
  assign _052_ = effective_subtraction && _039_;
  assign _053_ = effective_subtraction && _046_;
  ...
  assign _062_ = ~ inp_pipe_valid_q[2];
  assign _063_ = ~ inp_pipe_valid_q[3];
  assign _064_ = ~ inp_pipe_valid_q[4];
  ...
  assign inp_pipe_ready[1] = inp_pipe_ready[2] | _062_;
  assign inp_pipe_ready[2] = inp_pipe_ready[3] | _063_;
  assign inp_pipe_ready[3] = out_ready_i | _064_;
  assign sticky_after_norm = _075_ | sticky_before_add;
  ...
  assign normalized_exponent = _059_ ? _008_ : mid_pipe_tent_exp_q;
  assign norm_shamt = _059_ ? _007_ : addend_shamt;
  ...
  assign special_status_q[4] = _056_ ? 1'h1 : _011_;
  assign result_is_special_q = _056_ ? 1'h1 : _009_;
  assign special_result_q = _056_ ? 32'd2143289344 : _010_;
  function [0:0] _217_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign operand_a[31] = _217_(1'h1, { _065_, 1'h0, inp_pipe_operands_q[31] }, { _073_, _072_, _035_ });
  function [30:0] _218_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[22:0] } = _218_(31'h00800001, { 31'h3f800000, inp_pipe_operands_q[30:0] }, { _072_, _038_ });
  ...
  assign info_a = _220_(8'hff, { 8'h81, info_q[7:0] }, { _072_, _038_ });
  function [31:0] _221_;
    input [31:0] a;
    input [63:0] b;
    input [1:0] s;
  ...
  assign operand_c = _221_(32'd2155872257, { _089_, inp_pipe_operands_q[94:64], 32'h80000000 }, { _036_, _071_ });
  ...
  assign info_c = _223_(8'hff, { info_q[23:16], 8'h21 }, { _036_, _071_ });
  ...
  assign _079_ = $signed(exponent_product) - $signed({ 1'h0, leading_zero_count });
  assign _080_ = $signed(normalized_exponent) - $signed(32'd1);
  assign _081_ = in_ready_o ? in_valid_i : 1'hx;
  assign _003_ = flush_i ? 1'h0 : _081_;
  assign _082_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _082_;
  assign _083_ = inp_pipe_ready[2] ? inp_pipe_valid_q[2] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _083_;
  assign _084_ = inp_pipe_ready[3] ? inp_pipe_valid_q[3] : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _084_;
  assign { _085_[31:10], exponent_product } = _058_ ? 32'd4294967171 : _077_;
  assign mid_pipe_tent_exp_q = _041_ ? exponent_addend : exponent_product;
  assign addend_shifted = effective_subtraction ? _067_ : addend_after_shift;
  assign { _086_[76], sum_q[75:51], sum_lower } = _051_ ? _060_ : sum_raw;
  assign _087_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign pre_round_sign = _052_ ? 1'h1 : _087_;
  assign { _088_[31:8], pre_round_abs[30:23] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign _089_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[4];
  ...
  assign _085_[9:0] = exponent_product;
  assign _086_[75:0] = { sum_q[75:51], sum_lower };
  assign _088_[7:0] = pre_round_abs[30:23];
  assign addend_shamt_q = addend_shamt;
  assign aux_o = inp_pipe_aux_q[4];
  ...
  assign inp_pipe_is_boxed_q[14:12] = is_boxed_i;
  assign inp_pipe_op_mod_q[0] = op_mod_i;
  assign inp_pipe_op_q[19:16] = op_i;
  assign inp_pipe_operands_q[479:384] = operands_i;
  assign { inp_pipe_ready[0], inp_pipe_ready[4] } = { in_ready_o, out_ready_i };
  assign inp_pipe_rnd_mode_q[14:12] = rnd_mode_i;
  assign inp_pipe_tag_q[9:8] = tag_i;
  assign inp_pipe_valid_q[0] = in_valid_i;
  ...
  assign mid_pipe_aux_q = inp_pipe_aux_q[4];
  ...
  assign out_pipe_aux_q = inp_pipe_aux_q[4];
  assign out_pipe_ready = out_ready_i;
  assign out_pipe_result_q = result_o;
  assign out_pipe_status_q = status_o;
  assign out_pipe_tag_q = inp_pipe_tag_q[1:0];
  ...
  assign sv2v_tmp_9E262 = inp_pipe_aux_q[4];
  ...
  assign sv2v_tmp_CDA0E = inp_pipe_aux_q[4];
...
module \$paramod$e67b771112b52550702da183e5d1671fb52b292f\fpnew_noncomp_8EF6A_8033C (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, class_mask_o, is_class_o, tag_o, aux_o, out_valid_o, out_ready_i
, busy_o);
  wire _000_;
  wire _001_;
  wire _002_;
  ...
  assign _018_ = operand_a_smaller & _037_;
  reg [3:0] _068_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _068_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _068_ <= op_i;
  assign inp_pipe_op_q[15:12] = _068_;
  reg [1:0] _069_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _069_ <= 2'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _069_ <= inp_pipe_tag_q[7:6];
  assign inp_pipe_tag_q[5:4] = _069_;
  reg [63:0] _070_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _070_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[1].reg_ena ) _070_ <= inp_pipe_operands_q[255:192];
  assign inp_pipe_operands_q[191:128] = _070_;
  reg \inp_pipe_op_mod_q_reg[2] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[2]  <= 1'h0;
    else if (\gen_input_pipeline[1].reg_ena ) \inp_pipe_op_mod_q_reg[2]  <= inp_pipe_op_mod_q[1];
  ...
  assign inp_pipe_rnd_mode_q[11:9] = _072_;
  reg [1:0] _073_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _073_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _073_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[7:6] = _073_;
  reg [63:0] _074_;
  always @(posedge clk_i, negedge rst_ni)
  ...
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[3]  <= 1'h0;
    else if (_019_) \inp_pipe_valid_q_reg[3]  <= _003_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[3] ;
  reg \inp_pipe_aux_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_aux_q_reg[0]  <= 1'h0;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[3].reg_ena ) _077_ <= inp_pipe_tag_q[3:2];
  assign inp_pipe_tag_q[1:0] = _077_;
  reg \inp_pipe_op_mod_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[0]  <= 1'h0;
    else if (\gen_input_pipeline[3].reg_ena ) \inp_pipe_op_mod_q_reg[0]  <= inp_pipe_op_mod_q[3];
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[3].reg_ena ) _079_ <= inp_pipe_op_q[7:4];
  assign inp_pipe_op_q[3:0] = _079_;
  reg [2:0] _080_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _080_ <= 3'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _080_ <= inp_pipe_rnd_mode_q[5:3];
  assign inp_pipe_rnd_mode_q[2:0] = _080_;
  reg [1:0] _081_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _081_ <= 2'h0;
    else if (\gen_input_pipeline[3].reg_ena ) _081_ <= inp_pipe_is_boxed_q[3:2];
  assign inp_pipe_is_boxed_q[1:0] = _081_;
  reg [63:0] _082_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _082_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[3].reg_ena ) _082_ <= inp_pipe_operands_q[127:64];
  assign inp_pipe_operands_q[63:0] = _082_;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[2].reg_ena ) _085_ <= inp_pipe_tag_q[5:4];
  assign inp_pipe_tag_q[3:2] = _085_;
  reg \inp_pipe_op_mod_q_reg[1] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[1]  <= 1'h0;
    else if (\gen_input_pipeline[2].reg_ena ) \inp_pipe_op_mod_q_reg[1]  <= inp_pipe_op_mod_q[2];
  ...
  reg [3:0] _087_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _087_ <= 4'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _087_ <= inp_pipe_op_q[11:8];
  assign inp_pipe_op_q[7:4] = _087_;
  reg [2:0] _088_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _088_ <= 3'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _088_ <= inp_pipe_rnd_mode_q[8:6];
  assign inp_pipe_rnd_mode_q[5:3] = _088_;
  reg [1:0] _089_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _089_ <= 2'h0;
    else if (\gen_input_pipeline[2].reg_ena ) _089_ <= inp_pipe_is_boxed_q[5:4];
  assign inp_pipe_is_boxed_q[3:2] = _089_;
  reg [63:0] _090_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _090_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[2].reg_ena ) _090_ <= inp_pipe_operands_q[191:128];
  ...
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[1]  <= 1'h0;
    else if (_021_) \inp_pipe_valid_q_reg[1]  <= _001_;
  assign inp_pipe_valid_q[3] = \inp_pipe_valid_q_reg[1] ;
  reg \inp_pipe_valid_q_reg[2] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[2]  <= 1'h0;
    else if (_022_) \inp_pipe_valid_q_reg[2]  <= _002_;
  assign inp_pipe_valid_q[2] = \inp_pipe_valid_q_reg[2] ;
  reg [3:0] _093_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _093_ <= 4'h0;
    else if (\gen_input_pipeline[1].reg_ena ) _093_ <= inp_pipe_op_q[15:12];
  assign inp_pipe_op_q[11:8] = _093_;
  reg \inp_pipe_aux_q_reg[3] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_aux_q_reg[3]  <= 1'h0;
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_aux_q_reg[3]  <= aux_i;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[1].reg_ena ) _096_ <= inp_pipe_rnd_mode_q[11:9];
  assign inp_pipe_rnd_mode_q[8:6] = _096_;
  reg \inp_pipe_op_mod_q_reg[3] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_op_mod_q_reg[3]  <= 1'h0;
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_op_mod_q_reg[3]  <= op_mod_i;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[1].reg_ena ) _099_ <= inp_pipe_is_boxed_q[7:6];
  assign inp_pipe_is_boxed_q[5:4] = _099_;
  assign _019_ = | { in_ready_o, flush_i };
  assign _020_ = | { inp_pipe_ready[3], flush_i };
  assign _021_ = | { inp_pipe_ready[2], flush_i };
  assign _022_ = | { inp_pipe_ready[1], flush_i };
  assign _023_ = | { _040_, is_class_o };
  assign _024_ = | { _039_, is_class_o };
  ...
  assign _034_ = ~ inp_pipe_valid_q[3];
  assign _035_ = ~ inp_pipe_valid_q[4];
  assign _036_ = ~ \sign_injections.sign_b ;
  assign _037_ = ~ { 31'h00000000, operands_equal };
  assign in_ready_o = inp_pipe_ready[1] | _032_;
  assign inp_pipe_ready[1] = inp_pipe_ready[2] | _033_;
  assign inp_pipe_ready[2] = inp_pipe_ready[3] | _034_;
  assign inp_pipe_ready[3] = out_ready_i | _035_;
  ...
  assign extension_bit_o = _125_(1'h1, { sgnj_extension_bit, 1'h0 }, { _040_, _024_ });
  function [4:0] _126_;
    input [4:0] a;
    input [14:0] b;
    input [2:0] s;
  ...
  assign status_o = _126_(5'h1f, { signalling_nan, 4'h0, cmp_status[4], 9'h000 }, { _041_, _039_, _023_ });
  ...
  assign result_o = _128_(32'd2155872257, { sgnj_result, minmax_result, cmp_result }, { _040_, _041_, _039_ });
  assign _039_ = inp_pipe_op_q[3:0] == 4'h8;
  assign _041_ = inp_pipe_op_q[3:0] == 4'h7;
  assign _040_ = inp_pipe_op_q[3:0] == 4'h6;
  assign _016_ = info_q[3] ? _056_ : 10'h200;
  assign _013_ = info_q[4] ? _055_ : _016_;
  assign _009_ = info_q[5] ? _054_ : _013_;
  assign _005_ = info_q[6] ? _053_ : _009_;
  assign class_mask_o = info_q[7] ? _052_ : _005_;
  assign _017_ = any_operand_nan ? { 31'h00000000, inp_pipe_op_mod_q[4] } : _060_;
  ...
  assign _015_ = _145_(32'd2155872257, { _050_, _051_ }, { _044_, _043_ });
  ...
  assign sgnj_result[31] = _149_(1'h1, { \sign_injections.sign_b , _036_, _057_, inp_pipe_operands_q[31] }, { _044_, _043_, _042_, _045_ });
  function [30:0] _150_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign _003_ = flush_i ? 1'h0 : _046_;
  assign _047_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _047_;
  assign _048_ = inp_pipe_ready[2] ? inp_pipe_valid_q[2] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _048_;
  assign _049_ = inp_pipe_ready[3] ? inp_pipe_valid_q[3] : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _049_;
  assign sgnj_extension_bit = inp_pipe_op_mod_q[4] ? sgnj_result[31] : 1'h1;
  assign _050_ = operand_a_smaller ? inp_pipe_operands_q[31:0] : inp_pipe_operands_q[63:32];
  assign _051_ = operand_a_smaller ? inp_pipe_operands_q[63:32] : inp_pipe_operands_q[31:0];
  assign _052_ = inp_pipe_operands_q[31] ? 10'h002 : 10'h040;
  assign _053_ = inp_pipe_operands_q[31] ? 10'h004 : 10'h020;
  assign _054_ = inp_pipe_operands_q[31] ? 10'h008 : 10'h010;
  assign _055_ = inp_pipe_operands_q[31] ? 10'h001 : 10'h080;
  assign _056_ = info_q[2] ? 10'h100 : 10'h200;
  assign operand_a_smaller = _031_ ^ _030_;
  assign _057_ = \sign_injections.sign_a  ^ \sign_injections.sign_b ;
  assign _058_ = _038_ ^ inp_pipe_op_mod_q[4];
  assign _059_ = _018_ ^ inp_pipe_op_mod_q[4];
  assign _060_ = operands_equal ^ inp_pipe_op_mod_q[4];
  ...
  assign inp_pipe_aux_q[0] = aux_i;
  assign inp_pipe_is_boxed_q[9:8] = is_boxed_i;
  assign inp_pipe_op_mod_q[0] = op_mod_i;
  assign inp_pipe_op_q[19:16] = op_i;
  assign inp_pipe_operands_q[319:256] = operands_i;
  assign { inp_pipe_ready[0], inp_pipe_ready[4] } = { in_ready_o, out_ready_i };
  ...
  assign sv2v_tmp_2CB8C = inp_pipe_valid_q[4];
  ...
  assign sv2v_tmp_D1C37 = op_mod_i;
  assign sv2v_tmp_FA930 = inp_pipe_aux_q[4];
  assign tag_o = inp_pipe_tag_q[1:0];
endmodule
...
module \$paramod$f71409120a2c0685621825fa4df9ed68dc8ee9f1\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  \$paramod$e67b771112b52550702da183e5d1671fb52b292f\fpnew_noncomp_8EF6A_8033C  \gen_num_lanes[0].active_lane.genblk1.genblk1.lane_instance.i_noncomp  (
    .aux_i(vectorial_op_i),
    .aux_o(result_is_vector),
    .busy_o(lane_busy[0]),
  ...
  \$paramod$e67b771112b52550702da183e5d1671fb52b292f\fpnew_noncomp_8EF6A_8033C  \gen_num_lanes[1].active_lane.genblk1.genblk1.lane_instance.i_noncomp  (
    .aux_i(vectorial_op_i),
    .aux_o(lane_vectorial[1]),
    .busy_o(lane_busy[1]),
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$aed3427b969ae608fbd22f3dfc56ffd7a78e042d\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),

...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:149$554.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:149$555.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$538.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$539.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$548.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$549.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$550.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$551.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$552.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$553.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$538.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$539.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$539.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$538.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$538.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$539.$result [1:0], idx_o };
  ...
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:149$554.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:149$555.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$538.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$539.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$548.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$549.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$550.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$551.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$552.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D1l5s.preprocessed.v:169$553.inp  = 3'hx;
endmodule
...
module \$paramod$3c84444d350ef0a80fa24c7eeb3fa4f9857a30c8\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  ...
  assign _070_ = ~ mid_pipe_valid_q[2];
  assign _071_ = ~ mid_pipe_valid_q[1];
  assign _072_ = ~ out_pipe_valid_q[1];
  assign in_ready_o = inp_pipe_ready[1] | _063_;
  assign inp_pipe_ready[1] = inp_pipe_ready[2] | _064_;
  assign mid_pipe_ready[1] = mid_pipe_ready[2] | _070_;
  assign inp_pipe_ready[2] = mid_pipe_ready[1] | _071_;
  ...
  assign _089_ = mid_pipe_ready[1] ? mid_pipe_valid_q[1] : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _089_;
  assign _090_ = inp_pipe_ready[2] ? inp_pipe_valid_q[2] : 1'hx;
  assign _003_ = flush_i ? 1'h0 : _090_;
...
module \$paramod$574be1c4be69e884de315457b18762457f519be8\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
...
module \$paramod$870ad271dc673f6e68bd24d9fcd2b52fbf016ee5\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  \$paramod$d55b3a3e7c29ec88c07875672bcca89f4caf74f0\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$8bba073673cd5e3797d0e9618d11e07b86a647c7\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$574be1c4be69e884de315457b18762457f519be8\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
...
module \$paramod$8bba073673cd5e3797d0e9618d11e07b86a647c7\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D1l5s.preprocessed.v:327$466.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D1l5s.preprocessed.v:327$467.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D1l5s.preprocessed.v:347$464.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D1l5s.preprocessed.v:347$465.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D1l5s.preprocessed.v:327$466.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D1l5s.preprocessed.v:327$467.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D1l5s.preprocessed.v:347$464.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D1l5s.preprocessed.v:347$465.inp  = 2'hx;
endmodule
...
module \$paramod$d55b3a3e7c29ec88c07875672bcca89f4caf74f0\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;

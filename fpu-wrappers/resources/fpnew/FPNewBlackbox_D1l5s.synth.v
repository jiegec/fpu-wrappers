...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:149$610.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:149$611.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$594.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$595.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$604.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$605.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$606.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$607.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$608.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$609.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$594.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$595.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$595.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$594.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:149$610.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:149$611.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$594.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$595.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$604.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$605.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$606.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$607.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$608.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:169$609.inp  = 3'hx;
endmodule
...
, busy_o);
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[62:52] }) + $signed({ 12'h000, _068_ });
  ...
  assign _029_ = $signed(_084_) + $signed(32'd1);
  ...
  assign inject_carry_in = effective_subtraction & _070_;
  ...
  reg [7:0] _113_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _113_ <= 8'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _113_ <= addend_shamt;
  assign mid_pipe_add_shamt_q[15:8] = _113_;
  reg [12:0] _114_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _114_ <= 13'h0000;
    else if (\gen_inside_pipeline[0].reg_ena ) _114_ <= sv2v_tmp_B4C85;
  assign mid_pipe_tent_exp_q[25:13] = _114_;
  ...
  reg [191:0] _116_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _116_ <= 192'h000000000000000000000000000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _116_ <= operands_i;
  assign inp_pipe_operands_q[383:192] = _116_;
  reg [12:0] _117_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _117_ <= 13'h0000;
    else if (\gen_inside_pipeline[0].reg_ena ) _117_ <= exponent_difference;
  assign mid_pipe_exp_diff_q[25:13] = _117_;
  ...
  reg [2:0] _119_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _119_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _119_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[5:3] = _119_;
  reg [2:0] _120_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _120_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _120_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[5:3] = _120_;
  reg [12:0] _121_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _121_ <= 13'h0000;
    else if (\gen_inside_pipeline[0].reg_ena ) _121_ <= exponent_product;
  assign mid_pipe_exp_prod_q[25:13] = _121_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (_034_) \mid_pipe_valid_q_reg[1]  <= _003_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (_035_) \inp_pipe_valid_q_reg[0]  <= _000_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_output_pipeline[0].reg_ena ) _140_ <= mid_pipe_tag_q[1:0];
  assign out_pipe_tag_q[1:0] = _140_;
  reg [4:0] _141_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _141_ <= 5'h00;
    else if (\gen_output_pipeline[0].reg_ena ) _141_ <= status_d;
  assign out_pipe_status_q[4:0] = _141_;
  reg [63:0] _142_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _142_ <= 64'h0000000000000000;
    else if (\gen_output_pipeline[0].reg_ena ) _142_ <= result_d;
  assign out_pipe_result_q[63:0] = _142_;
  reg \out_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \out_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_036_) \out_pipe_valid_q_reg[0]  <= _004_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[1].reg_ena ) _146_ <= mid_pipe_tag_q[3:2];
  assign mid_pipe_tag_q[1:0] = _146_;
  reg [63:0] _147_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _147_ <= 64'h0000000000000000;
    else if (\gen_inside_pipeline[1].reg_ena ) _147_ <= mid_pipe_spec_res_q[127:64];
  assign mid_pipe_spec_res_q[63:0] = _147_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[1].reg_ena ) _149_ <= mid_pipe_rnd_mode_q[5:3];
  ...
  reg [162:0] _151_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _151_ <= 163'h00000000000000000000000000000000000000000;
    else if (\gen_inside_pipeline[1].reg_ena ) _151_ <= mid_pipe_sum_q[325:163];
  assign mid_pipe_sum_q[162:0] = _151_;
  ...
  reg [7:0] _153_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _153_ <= 8'h00;
    else if (\gen_inside_pipeline[1].reg_ena ) _153_ <= mid_pipe_add_shamt_q[15:8];
  assign mid_pipe_add_shamt_q[7:0] = _153_;
  reg [12:0] _154_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _154_ <= 13'h0000;
    else if (\gen_inside_pipeline[1].reg_ena ) _154_ <= mid_pipe_tent_exp_q[25:13];
  assign mid_pipe_tent_exp_q[12:0] = _154_;
  reg [12:0] _155_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _155_ <= 13'h0000;
    else if (\gen_inside_pipeline[1].reg_ena ) _155_ <= mid_pipe_exp_diff_q[25:13];
  assign mid_pipe_exp_diff_q[12:0] = _155_;
  reg [12:0] _156_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _156_ <= 13'h0000;
    else if (\gen_inside_pipeline[1].reg_ena ) _156_ <= mid_pipe_exp_prod_q[25:13];
  assign mid_pipe_exp_prod_q[12:0] = _156_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (_037_) \mid_pipe_valid_q_reg[0]  <= _002_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _161_ <= inp_pipe_tag_q[1:0];
  assign mid_pipe_tag_q[3:2] = _161_;
  reg [63:0] _162_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _162_ <= 64'h0000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _162_ <= special_result;
  assign mid_pipe_spec_res_q[127:64] = _162_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _164_ <= inp_pipe_rnd_mode_q[2:0];
  assign mid_pipe_rnd_mode_q[5:3] = _164_;
  ...
  reg [162:0] _166_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _166_ <= 163'h00000000000000000000000000000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _166_ <= mid_pipe_sum_q[488:326];
  assign mid_pipe_sum_q[325:163] = _166_;
  ...
  assign _036_ = | { mid_pipe_ready[2], flush_i };
  assign _037_ = | { mid_pipe_ready[1], flush_i };
  assign _038_ = | { _079_, _076_ };
  assign _039_ = | { _079_, _078_, _077_ };
  assign _040_ = | { _079_, _078_, _077_, _076_ };
  assign _041_ = | { _079_, _078_, _076_ };
  assign _042_ = inp_pipe_rnd_mode_q[2:0] == 3'h2;
  assign _043_ = sum_raw[163] == tentative_sign;
  assign uf_after_round = ! rounded_abs[62:52];
  assign of_after_round = rounded_abs[62:52] == 11'h7ff;
  assign _044_ = $signed(_029_) >= $signed(32'd0);
  assign of_before_round = $signed(final_exponent) >= $signed(32'd2047);
  assign _045_ = $signed(exponent_difference) > $signed(32'd0);
  assign _046_ = $signed(normalized_exponent) > $signed(32'd1);
  assign _047_ = $signed(exponent_difference) <= $signed(32'd4294967189);
  assign _048_ = $signed(exponent_difference) <= $signed(32'd55);
  assign _049_ = $signed(mid_pipe_exp_diff_q[12:0]) <= $signed(32'd0);
  assign _050_ = $signed(mid_pipe_exp_diff_q[12:0]) <= $signed(32'd2);
  assign _051_ = info_a[4] && info_b[5];
  assign _052_ = info_a[5] && info_b[4];
  assign _053_ = _061_ && info_c[4];
  assign _054_ = _053_ && effective_subtraction;
  assign _055_ = effective_subtraction && _071_;
  assign _056_ = effective_subtraction && _043_;
  assign _057_ = mid_pipe_eff_sub_q[2] && _050_;
  assign _058_ = _044_ && _059_;
  assign _059_ = ! lzc_zeroes;
  assign _060_ = _051_ || _052_;
  assign _061_ = info_a[4] || info_b[4];
  assign _062_ = info_a[5] || info_b[5];
  assign _063_ = _049_ || _057_;
  assign product = { info_a[7], mantissa_a[51:0] } * { info_b[7], operand_b[51:0] };
  assign _064_ = - sum_raw;
  assign _065_ = ~ inp_pipe_valid_q[1];
  assign _066_ = ~ inp_pipe_valid_q[2];
  assign _067_ = ~ inp_pipe_operands_q[63];
  assign _068_ = ~ info_c[7];
  assign _069_ = ~ addend_after_shift;
  assign _070_ = ~ sticky_before_add;
  assign _071_ = ~ sum_raw[163];
  assign _072_ = ~ mid_pipe_valid_q[1];
  assign _073_ = ~ mid_pipe_valid_q[2];
  assign _074_ = ~ out_pipe_valid_q[1];
  assign in_ready_o = inp_pipe_ready[1] | _065_;
  assign inp_pipe_ready[1] = inp_pipe_ready[2] | _066_;
  assign inp_pipe_ready[2] = mid_pipe_ready[1] | _072_;
  assign mid_pipe_ready[1] = mid_pipe_ready[2] | _073_;
  assign sticky_after_norm = _080_ | mid_pipe_sticky_q[2];
  assign regular_status[2] = of_before_round | of_after_round;
  assign _075_ = _081_ | of_before_round;
  assign regular_status[0] = _075_ | of_after_round;
  assign mid_pipe_ready[2] = out_ready_i | _074_;
  assign _016_ = _046_ ? sum_shifted[161:108] : { 1'h0, sum_shifted[161:109] };
  assign _020_ = _046_ ? { sum_shifted[107:0], 1'h0 } : sum_shifted[108:0];
  assign _015_ = _046_ ? _085_[12:0] : 13'h0000;
  ...
  assign _009_ = _058_ ? _029_[12:0] : 13'h0000;
  assign _008_ = _058_ ? _030_[7:0] : _031_[7:0];
  assign normalized_exponent = _063_ ? _009_ : mid_pipe_tent_exp_q[12:0];
  assign norm_shamt = _063_ ? _008_ : mid_pipe_add_shamt_q[7:0];
  assign _005_ = _048_ ? _083_[7:0] : 8'h00;
  assign addend_shamt = _047_ ? 8'ha3 : _005_;
  assign _024_ = info_c[4] ? { operand_c[63], 63'h7ff0000000000000 } : 64'h7ff0000000000000;
  assign _023_ = _061_ ? { tentative_sign, 63'h7ff0000000000000 } : _024_;
  assign _022_ = _054_ ? 1'h1 : 1'h0;
  assign _021_ = _054_ ? 64'h7ff0000000000000 : _023_;
  ...
  assign mid_pipe_spec_stat_q[14] = _060_ ? 1'h1 : _013_;
  assign result_is_special = _060_ ? 1'h1 : _011_;
  assign special_result = _060_ ? 64'h7ff0000000000000 : _012_;
  function [0:0] _252_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign operand_a[63] = _252_(1'h1, { _067_, 1'h0, inp_pipe_operands_q[63] }, { _078_, _077_, _038_ });
  function [62:0] _253_;
    input [62:0] a;
    input [125:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[10:0], mantissa_a[51:0] } = _253_(63'h0010000000000001, { 63'h3ff0000000000000, inp_pipe_operands_q[62:0] }, { _077_, _041_ });
  assign _010_ = _042_ ? 64'h0000000000000000 : 64'h8000000000000000;
  assign info_b = _040_ ? info_q[15:8] : 8'hff;
  function [7:0] _256_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign info_a = _256_(8'hff, { 8'h81, info_q[7:0] }, { _077_, _041_ });
  function [63:0] _257_;
    input [63:0] a;
    input [127:0] b;
    input [1:0] s;
  ...
  assign operand_c = _257_(64'h8010000000000001, { _095_, inp_pipe_operands_q[190:128], _010_ }, { _039_, _076_ });
  assign operand_b = _040_ ? inp_pipe_operands_q[127:64] : 64'h8010000000000001;
  function [7:0] _259_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign info_c = _259_(8'hff, { info_q[23:16], 8'h21 }, { _039_, _076_ });
  assign _076_ = inp_pipe_op_q[3:0] == 4'h3;
  assign _077_ = inp_pipe_op_q[3:0] == 4'h2;
  assign _078_ = inp_pipe_op_q[3:0] == 4'h1;
  assign _079_ = ! inp_pipe_op_q[3:0];
  ...
  assign _080_ = | sum_sticky_bits;
  assign _081_ = | round_sticky_bits;
  ...
  assign _082_ = _027_ - 32'd1023;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _083_ = $signed(32'd56) - $signed(exponent_difference);
  assign _084_ = $signed(mid_pipe_exp_prod_q[12:0]) - $signed({ 1'h0, leading_zero_count });
  assign _085_ = $signed(normalized_exponent) - $signed(32'd1);
  assign _086_ = in_ready_o ? in_valid_i : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _086_;
  assign _087_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _087_;
  assign { _088_[31:13], exponent_product } = _062_ ? 32'd4294966275 : _082_;
  assign sv2v_tmp_B4C85 = _045_ ? exponent_addend : exponent_product;
  assign addend_shifted = effective_subtraction ? _069_ : addend_after_shift;
  assign { _089_[163], mid_pipe_sum_q[488:326] } = _055_ ? _064_ : sum_raw;
  assign _090_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign final_sign = _056_ ? 1'h1 : _090_;
  assign _091_ = inp_pipe_ready[2] ? inp_pipe_valid_q[2] : 1'hx;
  assign _003_ = flush_i ? 1'h0 : _091_;
  assign _092_ = mid_pipe_ready[1] ? mid_pipe_valid_q[1] : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _092_;
  assign { _093_[31:11], pre_round_abs[62:52] } = of_before_round ? 32'd2046 : { 21'h000000, final_exponent[10:0] };
  ...
  assign _094_ = mid_pipe_ready[2] ? mid_pipe_valid_q[2] : 1'hx;
  assign _004_ = flush_i ? 1'h0 : _094_;
  assign _095_ = inp_pipe_operands_q[191] ^ inp_pipe_op_mod_q[2];
  ...
  assign _088_[12:0] = exponent_product;
  assign _089_[162:0] = mid_pipe_sum_q[488:326];
  assign _093_[10:0] = pre_round_abs[62:52];
...
module \$paramod$6dacf04e9a55e0c44d8681480f4eb8057e3385a9\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
module \$paramod$86bcebd72b50ed412034875a483b93d3c0f511d5\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
...
module \$paramod$870ad271dc673f6e68bd24d9fcd2b52fbf016ee5\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$213.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$55.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:8042$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:8042$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:8042$261.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:8042$277.op ;
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$55.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$55.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$55.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$55.$result  == 2'h3;
  assign _18_ = | _17_;
  assign _14_ = | _13_;
  assign _16_ = | _15_;
  function [1:0] _41_;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$55.$result  = _41_(2'h2, 6'h07, { _18_, _16_, _14_ });
  ...
  assign _19_ = _64_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$55.$result  +: 1];
  ...
  \$paramod$cb15ddc5b9f959b3b49878fe77962d87fc7fcc54\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$d4c5b3ad5240fe0b57ea52adac3f2295d545a515\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$9a1079317fa0628f73574a84e4c8f3d3c9a6c2e8\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$6dacf04e9a55e0c44d8681480f4eb8057e3385a9\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:7996$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:8042$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:8042$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:8042$261.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l5s.preprocessed.v:8042$277.op  = 4'hx;
...
module \$paramod$9a1079317fa0628f73574a84e4c8f3d3c9a6c2e8\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:327$522.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:327$523.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:347$520.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:347$521.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:327$522.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:327$523.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:347$520.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l5s.preprocessed.v:347$521.inp  = 2'hx;
endmodule
...
module \$paramod$cb15ddc5b9f959b3b49878fe77962d87fc7fcc54\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [71:0] arbiter_output;
...
module \$paramod$d4c5b3ad5240fe0b57ea52adac3f2295d545a515\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;

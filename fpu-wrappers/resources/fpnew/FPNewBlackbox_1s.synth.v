...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:149$2522.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:149$2523.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2506.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2507.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2516.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2517.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2518.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2519.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2520.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2521.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2506.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2507.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2507.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2506.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2506.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2507.$result [1:0], idx_o };
  ...
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:149$2522.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:149$2523.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2506.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2507.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2516.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2517.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2518.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2519.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2520.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_1s.preprocessed.v:169$2521.inp  = 3'hx;
endmodule
...
module \$paramod$6d8b9e1a9ce9a9fa6c378e58eae11f821dd49832\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[30:23] }) + $signed({ 9'h000, _057_ });
  ...
  assign _040_ = $signed(exponent_difference) <= $signed(32'd2);
  ...
  assign _045_ = effective_subtraction && _060_;
  assign _046_ = effective_subtraction && _033_;
  assign _047_ = effective_subtraction && _040_;
  ...
  assign _056_ = ~ inp_pipe_operands_q[31];
  assign _057_ = ~ info_c[7];
  assign _058_ = ~ addend_after_shift;
  assign _059_ = ~ sticky_before_add;
  assign _060_ = ~ sum_raw[76];
  assign in_ready_o = out_ready_i | _055_;
  assign sticky_after_norm = _066_ | sticky_before_add;
  ...
  assign normalized_exponent = _053_ ? _005_ : mid_pipe_tent_exp_q;
  assign norm_shamt = _053_ ? _004_ : addend_shamt;
  ...
  assign special_status_q[4] = _050_ ? 1'h1 : _008_;
  assign result_is_special_q = _050_ ? 1'h1 : _006_;
  assign special_result_q = _050_ ? 32'd2143289344 : _007_;
  function [0:0] _169_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign info_b = _031_ ? info_q[15:8] : 8'hff;
  function [7:0] _172_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign operand_b = _031_ ? inp_pipe_operands_q[63:32] : 32'd2155872257;
  function [7:0] _175_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign _062_ = inp_pipe_op_q[3:0] == 4'h3;
  assign _063_ = inp_pipe_op_q[3:0] == 4'h2;
  assign _064_ = inp_pipe_op_q[3:0] == 4'h1;
  assign _065_ = ! inp_pipe_op_q[3:0];
  ...
  assign _070_ = $signed(exponent_product) - $signed({ 1'h0, leading_zero_count });
  assign _071_ = $signed(normalized_exponent) - $signed(32'd1);
  assign _072_ = in_ready_o ? in_valid_i : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _072_;
  assign { _073_[31:10], exponent_product } = _052_ ? 32'd4294967171 : _068_;
  assign mid_pipe_tent_exp_q = _035_ ? exponent_addend : exponent_product;
  assign addend_shifted = effective_subtraction ? _058_ : addend_after_shift;
  assign { _074_[76], sum_q[75:51], sum_lower } = _045_ ? _054_ : sum_raw;
  assign _075_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign pre_round_sign = _046_ ? 1'h1 : _075_;
  ...
  assign _077_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[1];
...
, busy_o);
  ...
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$2749.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$3932.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$3933.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7334$3934.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7334$3935.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$3163.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$3260.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$3747.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$3844.fmt ;
  wire \gen_num_lanes[0].active_lane.in_valid ;
  wire [63:0] \gen_num_lanes[0].active_lane.local_operands ;
  wire [31:0] \gen_num_lanes[0].active_lane.op_result ;
  wire [4:0] \gen_num_lanes[0].active_lane.op_status ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$2749.$result  = _04_ + 32'd1;
  assign \gen_num_lanes[1].active_lane.in_valid  = in_valid_i & vectorial_op_i;
  ...
  assign { _10_[63:32], \gen_num_lanes[1].active_lane.local_operands [31:0] } = operands_i[63:0] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$2749.$result ;
  assign { _11_[63:32], \gen_num_lanes[1].active_lane.local_operands [63:32] } = operands_i[127:64] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$2749.$result ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$3932.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$3933.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7334$3934.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7334$3935.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$3163.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$3260.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$3747.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$3844.fmt  = 3'hx;
  assign \gen_num_lanes[0].active_lane.in_valid  = in_valid_i;
  assign \gen_num_lanes[0].active_lane.local_operands  = { operands_i[95:64], operands_i[31:0] };
  assign \gen_num_lanes[0].active_lane.out_ready  = out_ready_i;
...
module \$paramod$a5bdbc9899e3bac0f3e285776bfd67a1a2425e90\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$198.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$41.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7876$214.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7876$230.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7876$246.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7876$262.op ;
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$41.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$41.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$41.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$41.$result  == 2'h3;
  assign _14_ = | _13_;
  assign _18_ = | _17_;
  assign _16_ = | _15_;
  function [1:0] _41_;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$41.$result  = _41_(2'h2, 6'h07, { _18_, _16_, _14_ });
  ...
  assign _19_ = _64_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$41.$result  +: 1];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7827$198.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7876$214.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7876$230.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7876$246.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_1s.preprocessed.v:7876$262.op  = 4'hx;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_1s.preprocessed.v:327$496.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_1s.preprocessed.v:327$497.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_1s.preprocessed.v:347$494.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_1s.preprocessed.v:347$495.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_1s.preprocessed.v:327$496.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_1s.preprocessed.v:327$497.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_1s.preprocessed.v:347$494.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_1s.preprocessed.v:347$495.inp  = 2'hx;
endmodule
...
, out_ready_i, busy_o);
  ...
  wire [4:0] fp_status;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3749$4285.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3749$4420.fmt ;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3776$4286.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3776$4421.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_1s.preprocessed.v:3985$4294.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_1s.preprocessed.v:3986$4295.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_1s.preprocessed.v:3976$4288.ifmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_1s.preprocessed.v:3970$4287.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_1s.preprocessed.v:3990$4296.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_1s.preprocessed.v:3995$4297.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_1s.preprocessed.v:3997$4298.fmt ;
  wire \gen_input_pipeline[0].reg_ena ;
  ...
  wire [1:0] tag_o;
  wire uf_after_round;
  assign _017_ = _021_ + 32'd1;
  assign _019_ = _022_ + 32'd1;
  assign _018_ = _020_ + 32'd1;
  assign _021_ = { _044_[31:6], 6'h00 } + 32'd31;
  assign _022_ = { _045_[31:6], 6'h00 } + 32'd63;
  assign _020_ = { _044_[31:6], 6'h00 } + 32'd63;
  assign _023_ = { 26'h0000000, inp_pipe_src_fmt_q[2:0], 3'h0 } + 32'd6;
  assign _024_ = src_exp + { 8'h00, src_subnormal[0] };
  assign fp_input_exp = _085_ + src_offset;
  assign { _025_[31:9], destination_exp_q } = $signed(input_exp) + $signed(\fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3776$4286.$result );
  assign _026_ = _089_ + inp_pipe_op_mod_q[1];
  assign _027_ = _087_[4:0] + 32'd1;
  assign _028_ = _087_[4:0] + 32'd2;
  assign _029_ = _028_ + _000_;
  assign \gen_input_pipeline[0].reg_ena  = in_ready_o & in_valid_i;
  assign int_sign = int_value[23] & _050_;
  assign _030_ = src_is_int & mant_is_zero;
  assign fp_result_is_special = _051_ & _056_;
  assign _031_ = input_sign_q & inp_pipe_op_mod_q[1];
  assign _032_ = _031_ & _053_;
  assign fp_regular_status[4] = src_is_int & _060_;
  assign fp_regular_status[2] = _051_ & _033_;
  assign fp_regular_status[1] = uf_after_round & fp_regular_status[0];
  assign _033_ = _054_ & _060_;
  reg [4:0] _118_;
  always @(posedge clk_i, negedge rst_ni)
  ...
  assign _035_ = $signed(input_exp) >= $signed(_026_);
  assign _036_ = $signed(destination_exp_q) >= $signed(_090_);
  assign _037_ = $signed(destination_exp_q) >= $signed(_047_);
  assign _038_ = _051_ && info_q[4];
  assign _039_ = _042_ && _037_;
  assign _040_ = _036_ || _038_;
  assign _041_ = $signed(input_exp) < $signed(32'd4294967295);
  assign _042_ = $signed(destination_exp_q) < $signed(32'd1);
  assign _043_ = $signed(destination_exp_q) < $signed(_047_);
  assign _014_[31:3] = inp_pipe_int_fmt_q[1:0] * 29'h00000003;
  assign _015_[31:3] = inp_pipe_src_fmt_q[2:0] * 29'h00000003;
  assign _016_ = inp_pipe_src_fmt_q[2:0] * 32'd9;
  assign _046_ = - int_value;
  assign _047_ = - $signed(_000_);
  assign _048_ = - rounded_abs;
  assign _049_ = ~ inp_pipe_valid_q[1];
  assign _050_ = ~ inp_pipe_op_mod_q[1];
  assign _052_ = ~ info_q[0];
  assign _053_ = ~ rounded_int_res_zero;
  assign _051_ = ~ src_is_int;
  assign _054_ = ~ info_q[4];
  assign in_ready_o = out_ready_i | _049_;
  assign _055_ = info_q[5] | info_q[3];
  assign _056_ = _055_ | _052_;
  assign _057_ = info_q[3] | info_q[4];
  assign _058_ = _057_ | of_before_round;
  assign _059_ = _058_ | _052_;
  assign int_result_is_special = _059_ | _032_;
  assign _060_ = of_before_round | of_after_round;
  assign _061_ = _067_ | _033_;
  assign _013_ = _043_ ? _029_[4:0] : _087_[4:0];
  assign _011_ = _043_ ? 9'h000 : destination_exp_q;
  assign _012_ = _039_ ? _092_[4:0] : _013_;
  assign _008_ = _039_ ? 9'h000 : _011_;
  assign _009_ = _040_ ? 1'h1 : 1'h0;
  assign _006_ = _040_ ? 49'h1ffffffffffff : { input_mant, 25'h0000000 };
  assign _003_ = _040_ ? _091_[8:0] : _008_;
  assign _010_ = _040_ ? _087_[4:0] : _012_;
  assign _007_ = _041_ ? 5'h01 : _088_[4:0];
  assign _005_ = _035_ ? 1'h1 : 1'h0;
  assign _002_ = _035_ ? 5'h00 : _007_;
  function [31:0] _176_;
    input [31:0] a;
    input [127:0] b;
    input [3:0] s;
  ...
  assign _063_ = inp_pipe_int_fmt_q[1:0] == 2'h3;
  assign _064_ = inp_pipe_int_fmt_q[1:0] == 2'h2;
  assign _065_ = inp_pipe_int_fmt_q[1:0] == 2'h1;
  assign _066_ = ! inp_pipe_int_fmt_q[1:0];
  assign _004_ = dst_is_int_q ? _062_ : 32'hxxxxxxxx;
  assign of_before_round = dst_is_int_q ? _005_ : _009_;
  assign denorm_shamt = dst_is_int_q ? _002_ : _010_;
  assign preshift_mant = dst_is_int_q ? { input_mant, 25'h0000000 } : _006_;
  assign final_exp = dst_is_int_q ? destination_exp_q : _003_;
  assign fp_round_sticky_bits[0] = | destination_mant[23:0];
  assign int_round_sticky_bits[0] = | destination_mant[47:0];
  assign _067_ = | destination_mant[24:0];
  ...
  assign _074_ = $signed(32'd1) << _082_;
  assign _075_ = $signed(32'd1) << _083_;
  assign input_mant = encoded_mant << renorm_shamt;
  assign _076_ = $signed(32'd1) << _070_;
  assign destination_mant = preshift_mant >> denorm_shamt;
  assign _077_ = _017_ - 32'd32;
  assign _079_ = _019_ - 32'd32;
  assign _078_ = _018_ - 32'd32;
  assign { _081_[31:26], _045_[31:6] } = 32'd4 - inp_pipe_src_fmt_q[2:0];
  assign _082_ = _073_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3749$4285.$result  = $signed(_074_) - $signed(32'd1);
  assign { _080_[31:26], _044_[31:6] } = 32'd4 - inp_pipe_dst_fmt_q[2:0];
  assign _083_ = _070_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3776$4286.$result  = $signed(_075_) - $signed(32'd1);
  assign _084_ = _024_ - \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3749$4285.$result [8:0];
  assign _085_ = _084_ - { 1'h0, renorm_shamt };
  assign { _086_[31:9], int_input_exp } = 32'd23 - { 1'h0, renorm_shamt };
  assign _087_ = 32'd23 - _000_;
  assign _088_ = 32'd4294967295 - input_exp;
  assign _089_ = _004_ - 32'd1;
  assign _090_ = $signed(_076_) - $signed(32'd1);
  assign _091_ = $signed(_076_) - $signed(32'd2);
  assign _092_ = _027_ - destination_exp_q;
  assign _093_ = in_ready_o ? in_valid_i : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _093_;
  assign int_mantissa = int_sign ? _046_ : int_value;
  assign encoded_mant = src_is_int ? int_mantissa : _068_;
  assign input_sign_q = src_is_int ? int_sign : _069_;
  ...
  assign pre_round_abs = dst_is_int_q ? int_special_result : _071_;
  assign fmt_result[31:0] = _030_ ? 32'd0 : { rounded_sign, rounded_abs[30:0] };
  assign rounded_int_res = rounded_sign ? _048_ : rounded_abs;
  assign \gen_special_results[0].active_format.special_results.special_res  = info_q[5] ? { input_sign_q, 31'h00000000 } : 32'd2143289344;
  assign fp_regular_status[0] = src_is_int ? _067_ : _061_;
  assign fp_result = fp_result_is_special ? fp_special_result : _072_;
  ...
  assign \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3749$4420.fmt  = 3'hx;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3776$4421.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_1s.preprocessed.v:3985$4294.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_1s.preprocessed.v:3986$4295.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_1s.preprocessed.v:3976$4288.ifmt  = 2'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_1s.preprocessed.v:3970$4287.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_1s.preprocessed.v:3990$4296.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_1s.preprocessed.v:3995$4297.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_1s.preprocessed.v:3997$4298.fmt  = 3'hx;
  ...
  assign result_d = result_o;
  assign rnd_mode_q = inp_pipe_rnd_mode_q[2:0];
  assign src_bias = \fpnew_pkg_bias$func$FPNewBlackbox_1s.preprocessed.v:3749$4285.$result [8:0];
...
, busy_o);
  ...
  wire flush_i;
  wire [319:0] fmt_slice_result;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$2180.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$2181.fmt ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$588.$result ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$589.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7334$2182.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7334$2183.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1003.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1100.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1197.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1775.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1872.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1969.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7473$1270.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7473$2042.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_1s.preprocessed.v:7470$1231.ifmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_1s.preprocessed.v:7470$2003.ifmt ;
  wire \gen_num_lanes[0].active_lane.in_valid ;
  wire [95:0] \gen_num_lanes[0].active_lane.local_operands ;
  wire [31:0] \gen_num_lanes[0].active_lane.op_result ;
  wire [4:0] \gen_num_lanes[0].active_lane.op_status ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$588.$result  = _012_ + 32'd1;
  assign _015_ = _034_ + _035_;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$589.$result  = _015_ + 32'd1;
  assign _014_ = { _024_[31:6], 6'h00 } + 32'd31;
  assign _013_ = { _024_[31:6], 6'h00 } + 32'd63;
  assign _016_ = \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$589.$result  + 32'd16;
  assign lane_out_valid[1] = \gen_num_lanes[1].active_lane.out_valid  & lane_aux[3];
  assign \gen_num_lanes[1].active_lane.in_valid  = in_valid_i & vectorial_op_i;
  assign \gen_num_lanes[1].active_lane.out_ready  = out_ready_i & lane_aux[3];
  ...
  assign is_up_cast = \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$588.$result  > \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$589.$result ;
  ...
  assign _036_ = operands_i[63:0] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$589.$result ;
  ...
  assign \boxed_2op.sv2v_autoblock_4.fmt  = 32'd5;
  assign { fmt_slice_result[319:288], fmt_slice_result[286:0] } = { extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], fmt_slice_result[287], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, \gen_num_lanes[1].local_result , \gen_num_lanes[0].local_result  };
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$2180.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7333$2181.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7334$2182.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7334$2183.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1003.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1100.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1197.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1775.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1872.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7466$1969.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7473$1270.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_1s.preprocessed.v:7473$2042.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_1s.preprocessed.v:7470$1231.ifmt  = 2'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_1s.preprocessed.v:7470$2003.ifmt  = 2'hx;
  assign \gen_num_lanes[0].active_lane.in_valid  = in_valid_i;
...
module \$paramod$f6673df41972a38bb7f5225f99782dfef82340fd\fpnew_divsqrt_multi_1A2E7_2C16F (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, dst_fmt_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  ...
  assign \gen_input_pipeline[0].reg_ena  = in_ready_o & in_valid_i;
  assign _015_ = inp_pipe_valid_q[1] & _025_;
  assign _016_ = _015_ & in_ready;
  assign div_valid = _016_ & _029_;
  assign _017_ = inp_pipe_valid_q[1] & _027_;
  assign _018_ = _017_ & in_ready;
  assign sqrt_valid = _018_ & _029_;
  always @(posedge clk_i, negedge rst_ni)
  ...
  assign _025_ = inp_pipe_op_q[3:0] == 4'h4;
  assign _026_ = inp_pipe_valid_q[1] && unit_ready;
  assign _027_ = inp_pipe_op_q[3:0] != 4'h4;
  assign _028_ = ~ inp_pipe_valid_q[1];
  assign _029_ = ~ flush_i;
  assign in_ready_o = in_ready | _028_;
  assign op_starting = div_valid | sqrt_valid;
  assign state_d = flush_i ? 2'h0 : _002_;
  assign out_valid_o = flush_i ? 1'h0 : _001_;
  assign unit_busy = flush_i ? 1'h0 : _003_;
  assign _014_ = out_ready_i ? _013_ : 2'hx;
  assign _009_ = out_ready_i ? _011_ : 1'h0;
  assign _013_ = _026_ ? 2'h1 : 2'h0;
  assign _011_ = _026_ ? 1'h1 : 1'h0;
  assign _012_ = out_ready_i ? _013_ : 2'h2;
  assign _008_ = out_ready_i ? 1'h0 : 1'h1;
  assign _010_ = unit_done ? _012_ : 2'hx;
  assign _004_ = unit_done ? _008_ : 1'h0;
  assign _005_ = unit_done ? _009_ : 1'h0;
  assign _006_ = unit_done ? 1'h1 : 1'h0;
  assign _007_ = _026_ ? 2'h1 : 2'hx;
  function [1:0] _083_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign _032_ = ! state_q;
  assign _003_ = _024_ ? 1'h1 : 1'h0;
  assign data_is_held = _030_ ? 1'h1 : 1'h0;
  assign hold_result = _031_ ? _004_ : 1'h0;
  function [0:0] _089_;
    input [0:0] a;
    input [1:0] b;
    input [1:0] s;
  ...
  assign _030_ = state_q == 2'h2;
  assign _031_ = state_q == 2'h1;
  function [1:0] _092_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign _033_ = inp_pipe_dst_fmt_q[2:0] == 3'h4;
  assign _034_ = inp_pipe_dst_fmt_q[2:0] == 3'h1;
  assign _035_ = ! inp_pipe_dst_fmt_q[2:0];
  assign busy_o = | { unit_busy, inp_pipe_valid_q[1], out_valid_o, in_valid_i };
  assign _036_ = in_ready_o ? in_valid_i : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _036_;

...
module \$paramod$1e04ab30af27cf3287de8ea68d898c2bdb7f0ed0\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
module \$paramod$362358be950b89a031e7568872234c62e60e732a\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire [4:0] _00_;
  wire [4:0] _01_;
  output busy_o;
  wire busy_o;
...
module \$paramod$4dffaaa76975fa9a810a1a53bbd409e4982e6ede\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:327$532.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:327$533.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:347$530.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:347$531.inp ;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:327$532.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:327$533.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:347$530.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:347$531.inp  = 2'hx;
endmodule
...
module \$paramod$511dce93d93831b8dd0fec36634d8b20a0fa90c1\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$214.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$55.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:8042$230.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:8042$246.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:8042$262.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:8042$278.op ;
  ...
  assign _12_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$55.$result ;
  assign _13_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$55.$result  == 2'h1;
  assign _14_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$55.$result  == 2'h2;
  assign _15_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$55.$result  == 2'h3;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$55.$result  = _47_(2'h2, 6'h07, { _21_, _19_, _17_ });
  assign _21_ = | _20_;
  ...
  assign _22_ = _74_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$55.$result  +: 1];
  ...
  \$paramod$7adf4921dbfc3290d4847e1976e12ce44f170c5e\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$1e04ab30af27cf3287de8ea68d898c2bdb7f0ed0\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$fcaac9ee1aa528270a19d0b5fe16b9a22c1d3a4b\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$e67cc1f666fe7241a0971a6ac6bfb9796d49f25c\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:7996$214.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:8042$230.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:8042$246.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:8042$262.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l2s.preprocessed.v:8042$278.op  = 4'hx;
...
module \$paramod$62b97f2c24fbd0ec64efd8c0255d5867594e9cd9\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:149$620.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:149$621.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$604.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$605.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$614.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$615.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$616.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$617.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$618.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$619.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$604.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$605.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$605.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$604.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$604.$result [1:0], \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$605.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:149$620.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:149$621.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$604.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$605.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$614.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$615.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$616.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$617.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$618.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l2s.preprocessed.v:169$619.inp  = 3'hx;
endmodule
...
module \$paramod$7adf4921dbfc3290d4847e1976e12ce44f170c5e\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [135:0] arbiter_output;
...
module \$paramod$e67cc1f666fe7241a0971a6ac6bfb9796d49f25c\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module \$paramod$fcaac9ee1aa528270a19d0b5fe16b9a22c1d3a4b\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;

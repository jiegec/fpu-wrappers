...
module \$paramod$029cea825487e9968d2e5675ba5c1594062a8cd3\fpnew_divsqrt_multi_1A2E7_2C16F (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, dst_fmt_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire _002_;
  wire [1:0] _003_;
  ...
  assign _016_ = inp_pipe_valid_q[1] & _027_;
  assign _017_ = _016_ & in_ready;
  assign div_valid = _017_ & _031_;
  assign _018_ = inp_pipe_valid_q[1] & _029_;
  assign _019_ = _018_ & in_ready;
  assign sqrt_valid = _019_ & _031_;
  assign \gen_output_pipeline[0].reg_ena  = out_ready & out_valid;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) state_q <= 2'h0;
    else if (_025_) state_q <= state_d;
  always @(posedge clk_i, negedge rst_ni)
  ...
  reg [1:0] _053_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _053_ <= 2'h0;
    else if (\gen_output_pipeline[0].reg_ena ) _053_ <= result_tag_q;
  assign out_pipe_tag_q[1:0] = _053_;
  reg [4:0] _054_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _054_ <= 5'h00;
    else if (\gen_output_pipeline[0].reg_ena ) _054_ <= status_d;
  assign out_pipe_status_q[4:0] = _054_;
  reg [4:0] _055_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _055_ <= 5'h00;
    else if (\gen_output_pipeline[0].reg_ena ) _055_ <= result_aux_q;
  assign out_pipe_aux_q[4:0] = _055_;
  always @(posedge clk_i)
    if (hold_result) held_status_q <= unit_status;
  reg [63:0] _057_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _057_ <= 64'h0000000000000000;
    else if (\gen_output_pipeline[0].reg_ena ) _057_ <= result_d;
  assign out_pipe_result_q[63:0] = _057_;
  reg \out_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \out_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_023_) \out_pipe_valid_q_reg[0]  <= _001_;
  assign out_pipe_valid_q[1] = \out_pipe_valid_q_reg[0] ;
  reg [4:0] _059_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _059_ <= 5'h00;
    else if (\gen_input_pipeline[0].reg_ena ) _059_ <= aux_i;
  assign inp_pipe_aux_q[4:0] = _059_;
  reg [1:0] _060_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _060_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _060_ <= tag_i;
  assign inp_pipe_tag_q[1:0] = _060_;
  reg [2:0] _061_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _061_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _061_ <= dst_fmt_i;
  assign inp_pipe_dst_fmt_q[2:0] = _061_;
  reg [3:0] _062_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _062_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _062_ <= op_i;
  assign inp_pipe_op_q[3:0] = _062_;
  reg [2:0] _063_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _063_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _063_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[2:0] = _063_;
  reg [127:0] _064_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _064_ <= 128'h00000000000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _064_ <= operands_i;
  assign inp_pipe_operands_q[127:0] = _064_;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_024_) \inp_pipe_valid_q_reg[0]  <= _000_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[0] ;
  assign _020_ = { _034_, unit_done, flush_i } != 3'h4;
  assign _021_ = { _035_, _028_, flush_i } != 3'h4;
  assign _022_ = { _033_, out_ready, flush_i } != 3'h4;
  assign _023_ = | { out_ready, flush_i };
  assign _024_ = | { in_ready_o, flush_i };
  assign _025_ = & { _020_, _022_, _021_ };
  assign _026_ = | { _034_, _033_ };
  assign _027_ = inp_pipe_op_q[3:0] == 4'h4;
  assign _028_ = inp_pipe_valid_q[1] && unit_ready;
  assign _029_ = inp_pipe_op_q[3:0] != 4'h4;
  assign _030_ = ~ inp_pipe_valid_q[1];
  assign _031_ = ~ flush_i;
  assign _032_ = ~ out_pipe_valid_q[1];
  assign in_ready_o = in_ready | _030_;
  assign op_starting = div_valid | sqrt_valid;
  assign out_ready = out_ready_i | _032_;
  assign state_d = flush_i ? 2'h0 : _003_;
  assign out_valid = flush_i ? 1'h0 : _002_;
  assign unit_busy = flush_i ? 1'h0 : _004_;
  assign _015_ = out_ready ? _014_ : 2'hx;
  assign _010_ = out_ready ? _012_ : 1'h0;
  assign _014_ = _028_ ? 2'h1 : 2'h0;
  assign _012_ = _028_ ? 1'h1 : 1'h0;
  assign _013_ = out_ready ? _014_ : 2'h2;
  assign _009_ = out_ready ? 1'h0 : 1'h1;
  assign _011_ = unit_done ? _013_ : 2'hx;
  assign _005_ = unit_done ? _009_ : 1'h0;
  assign _006_ = unit_done ? _010_ : 1'h0;
  assign _007_ = unit_done ? 1'h1 : 1'h0;
  assign _008_ = _028_ ? 2'h1 : 2'hx;
  function [1:0] _096_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign _003_ = _096_(2'h0, { _008_, _011_, _015_ }, { _035_, _034_, _033_ });
  function [0:0] _097_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign in_ready = _097_(1'h0, { 1'h1, _006_, _010_ }, { _035_, _034_, _033_ });
  assign _035_ = ! state_q;
  assign _004_ = _026_ ? 1'h1 : 1'h0;
  assign data_is_held = _033_ ? 1'h1 : 1'h0;
  assign hold_result = _034_ ? _005_ : 1'h0;
  function [0:0] _102_;
    input [0:0] a;
    input [1:0] b;
    input [1:0] s;
  ...
  assign _002_ = _102_(1'h0, { _007_, 1'h1 }, { _034_, _033_ });
  assign _033_ = state_q == 2'h2;
  assign _034_ = state_q == 2'h1;
  function [1:0] _105_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign divsqrt_fmt = _105_(2'h2, 6'h07, { _038_, _037_, _036_ });
  assign _036_ = inp_pipe_dst_fmt_q[2:0] == 3'h4;
  assign _037_ = inp_pipe_dst_fmt_q[2:0] == 3'h1;
  assign _038_ = ! inp_pipe_dst_fmt_q[2:0];
  assign busy_o = | { unit_busy, out_valid, out_pipe_valid_q[1], inp_pipe_valid_q[1], in_valid_i };
  assign _039_ = in_ready_o ? in_valid_i : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _039_;
  assign result_d = data_is_held ? held_result_q : adjusted_result;
  assign status_d = data_is_held ? held_status_q : unit_status;
  assign _040_ = out_ready ? out_valid : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _040_;
...
module \$paramod$1d23ede96667e057a8938607f03d7f88deff6827\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  \$paramod$6313957f3f8e5ac0edbd3470c2d5deb9a757f657\fpnew_noncomp_8EF6A_8033C  \gen_num_lanes[0].active_lane.genblk1.genblk1.lane_instance.i_noncomp  (
    .aux_i(vectorial_op_i),
    .aux_o(result_is_vector),
    .busy_o(lane_busy[0]),
  ...
  \$paramod$6313957f3f8e5ac0edbd3470c2d5deb9a757f657\fpnew_noncomp_8EF6A_8033C  \gen_num_lanes[1].active_lane.genblk1.genblk1.lane_instance.i_noncomp  (
    .aux_i(vectorial_op_i),
    .aux_o(lane_vectorial[1]),
    .busy_o(lane_busy[1]),
...
module \$paramod$1e8f8b69f5d743788e1fca06c5ecf89639a79a5f\fpnew_cast_multi_BB75A_A18A7 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o
, out_ready_i, busy_o);
  wire [31:0] _000_;
  wire _001_;
  wire _002_;
  ...
  wire [4:0] fp_status;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3749$4308.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3749$4448.fmt ;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3776$4309.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3776$4449.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3985$4322.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3986$4323.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_D2l2s.preprocessed.v:3976$4316.ifmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3970$4315.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3990$4324.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3995$4325.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3997$4326.fmt ;
  wire \gen_input_pipeline[0].reg_ena ;
  ...
  wire [1:0] tag_o;
  wire uf_after_round;
  assign _019_ = _022_ + 32'd1;
  assign _018_ = _023_ + 32'd1;
  assign _020_ = _024_ + 32'd1;
  assign _021_ = _025_ + 32'd1;
  assign _022_ = { _048_[31:6], 6'h00 } + 32'd63;
  assign _023_ = { _048_[31:6], 6'h00 } + 32'd31;
  assign _024_ = { _049_[31:6], 6'h00 } + 32'd63;
  assign _025_ = { _050_[31:6], 6'h00 } + 32'd63;
  assign _026_ = { 26'h0000000, inp_pipe_src_fmt_q[2:0], 3'h0 } + 32'd6;
  assign _027_ = src_exp + { 11'h000, src_subnormal[0] };
  assign fp_input_exp = _094_ + src_offset;
  assign { _028_[31:12], mid_pipe_dest_exp_q[23:12] } = $signed(input_exp) + $signed(\fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3776$4309.$result );
  assign _029_ = _098_ + mid_pipe_op_mod_q[1];
  assign _030_ = _096_[5:0] + 32'd1;
  assign _031_ = _096_[5:0] + 32'd2;
  assign _032_ = _031_ + _000_;
  assign \gen_input_pipeline[0].reg_ena  = in_ready_o & in_valid_i;
  assign int_sign = int_value[52] & _055_;
  assign \gen_inside_pipeline[0].reg_ena  = inp_pipe_ready[1] & inp_pipe_valid_q[1];
  assign _033_ = mid_pipe_src_is_int_q[1] & mid_pipe_mant_zero_q[1];
  assign fp_result_is_special = _057_ & _062_;
  assign _034_ = mid_pipe_input_sign_q[1] & mid_pipe_op_mod_q[1];
  assign _035_ = _034_ & _059_;
  assign fp_regular_status[4] = mid_pipe_src_is_int_q[1] & _066_;
  assign fp_regular_status[2] = _057_ & _036_;
  assign fp_regular_status[1] = uf_after_round & fp_regular_status[0];
  assign _036_ = _060_ & _066_;
  reg [4:0] _131_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _131_ <= 5'h00;
    else if (\gen_input_pipeline[0].reg_ena ) _131_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[4:0] = _131_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[0].reg_ena ) _133_ <= src_fmt_i;
  assign inp_pipe_src_fmt_q[2:0] = _133_;
  reg [4:0] _134_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _134_ <= 5'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _134_ <= inp_pipe_aux_q[4:0];
  assign mid_pipe_aux_q[4:0] = _134_;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_037_) \inp_pipe_valid_q_reg[0]  <= _001_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[0] ;
  reg [1:0] _136_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _136_ <= 2'h0;
    else if (\gen_inside_pipeline[0].reg_ena ) _136_ <= inp_pipe_tag_q[1:0];
  assign mid_pipe_tag_q[1:0] = _136_;
  reg [2:0] _137_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _137_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _137_ <= dst_fmt_i;
  assign inp_pipe_dst_fmt_q[2:0] = _137_;
  reg [1:0] _138_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _138_ <= 2'h0;
    else if (\gen_inside_pipeline[0].reg_ena ) _138_ <= inp_pipe_int_fmt_q[1:0];
  assign mid_pipe_int_fmt_q[1:0] = _138_;
  reg [2:0] _139_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _139_ <= 3'h0;
    else if (\gen_inside_pipeline[0].reg_ena ) _139_ <= inp_pipe_dst_fmt_q[2:0];
  assign mid_pipe_dst_fmt_q[2:0] = _139_;
  reg [1:0] _140_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _140_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _140_ <= int_fmt_i;
  assign inp_pipe_int_fmt_q[1:0] = _140_;
  reg [1:0] _141_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _141_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _141_ <= tag_i;
  assign inp_pipe_tag_q[1:0] = _141_;
  reg [2:0] _142_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _142_ <= 3'h0;
    else if (\gen_inside_pipeline[0].reg_ena ) _142_ <= inp_pipe_rnd_mode_q[2:0];
  assign mid_pipe_rnd_mode_q[2:0] = _142_;
  ...
  reg [4:0] _144_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _144_ <= 5'h00;
    else if (\gen_input_pipeline[0].reg_ena ) _144_ <= aux_i;
  assign inp_pipe_aux_q[4:0] = _144_;
  ...
  reg [7:0] _146_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _146_ <= 8'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _146_ <= sv2v_tmp_48E57;
  assign mid_pipe_info_q[7:0] = _146_;
  reg \mid_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \mid_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_038_) \mid_pipe_valid_q_reg[0]  <= _002_;
  ...
  reg [11:0] _150_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _150_ <= 12'h000;
    else if (\gen_inside_pipeline[0].reg_ena ) _150_ <= input_exp;
  assign mid_pipe_input_exp_q[11:0] = _150_;
  reg [52:0] _151_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _151_ <= 53'h00000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _151_ <= input_mant;
  assign mid_pipe_input_mant_q[52:0] = _151_;
  reg [11:0] _152_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _152_ <= 12'h000;
    else if (\gen_inside_pipeline[0].reg_ena ) _152_ <= mid_pipe_dest_exp_q[23:12];
  assign mid_pipe_dest_exp_q[11:0] = _152_;
  ...
  reg [63:0] _154_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _154_ <= 64'h0000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _154_ <= operands_i;
  assign inp_pipe_operands_q[63:0] = _154_;
  reg [2:0] _155_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _155_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _155_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[2:0] = _155_;
  reg [3:0] _156_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _156_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _156_ <= op_i;
  assign inp_pipe_op_q[3:0] = _156_;
  assign _037_ = | { in_ready_o, flush_i };
  assign _038_ = | { inp_pipe_ready[1], flush_i };
  ...
  assign _039_ = $signed(mid_pipe_input_exp_q[11:0]) >= $signed(_029_);
  assign _040_ = $signed(mid_pipe_dest_exp_q[11:0]) >= $signed(_099_);
  assign _041_ = $signed(mid_pipe_dest_exp_q[11:0]) >= $signed(_052_);
  assign _042_ = _057_ && mid_pipe_info_q[4];
  assign _043_ = _046_ && _041_;
  assign _044_ = _040_ || _042_;
  assign _045_ = $signed(mid_pipe_input_exp_q[11:0]) < $signed(32'd4294967295);
  assign _046_ = $signed(mid_pipe_dest_exp_q[11:0]) < $signed(32'd1);
  assign _047_ = $signed(mid_pipe_dest_exp_q[11:0]) < $signed(_052_);
  assign _015_ = inp_pipe_int_fmt_q[1:0] * 32'd53;
  assign _016_ = inp_pipe_src_fmt_q[2:0] * 32'd53;
  assign _017_[31:2] = inp_pipe_src_fmt_q[2:0] * 30'h00000003;
  assign _051_ = - int_value;
  assign _052_ = - $signed(_000_);
  assign _053_ = - rounded_abs;
  assign _054_ = ~ inp_pipe_valid_q[1];
  assign _055_ = ~ inp_pipe_op_mod_q[1];
  assign _056_ = ~ mid_pipe_valid_q[1];
  assign _058_ = ~ mid_pipe_info_q[0];
  assign _059_ = ~ rounded_int_res_zero;
  assign _057_ = ~ mid_pipe_src_is_int_q[1];
  assign _060_ = ~ mid_pipe_info_q[4];
  assign in_ready_o = inp_pipe_ready[1] | _054_;
  assign inp_pipe_ready[1] = out_ready_i | _056_;
  assign _061_ = mid_pipe_info_q[5] | mid_pipe_info_q[3];
  assign _062_ = _061_ | _058_;
  assign _063_ = mid_pipe_info_q[3] | mid_pipe_info_q[4];
  assign _064_ = _063_ | of_before_round;
  assign _065_ = _064_ | _058_;
  assign int_result_is_special = _065_ | _035_;
  assign _066_ = of_before_round | of_after_round;
  assign _067_ = _073_ | _036_;
  assign _014_ = _047_ ? _032_[5:0] : _096_[5:0];
  assign _012_ = _047_ ? 12'h000 : mid_pipe_dest_exp_q[11:0];
  assign _013_ = _043_ ? _101_[5:0] : _014_;
  assign _009_ = _043_ ? 12'h000 : _012_;
  assign _010_ = _044_ ? 1'h1 : 1'h0;
  assign _007_ = _044_ ? 107'h7ffffffffffffffffffffffffff : { mid_pipe_input_mant_q[52:0], 54'h00000000000000 };
  assign _004_ = _044_ ? _100_[11:0] : _009_;
  assign _011_ = _044_ ? _096_[5:0] : _013_;
  assign _008_ = _045_ ? 6'h01 : _097_[5:0];
  assign _006_ = _039_ ? 1'h1 : 1'h0;
  assign _003_ = _039_ ? 6'h00 : _008_;
  function [31:0] _207_;
    input [31:0] a;
    input [127:0] b;
    input [3:0] s;
  ...
  assign _068_ = _207_(32'hxxxxxxxx, 128'h00000008000000100000002000000040, { _072_, _071_, _070_, _069_ });
  assign _069_ = mid_pipe_int_fmt_q[1:0] == 2'h3;
  assign _070_ = mid_pipe_int_fmt_q[1:0] == 2'h2;
  assign _071_ = mid_pipe_int_fmt_q[1:0] == 2'h1;
  assign _072_ = ! mid_pipe_int_fmt_q[1:0];
  assign _005_ = mid_pipe_dst_is_int_q[1] ? _068_ : 32'hxxxxxxxx;
  assign of_before_round = mid_pipe_dst_is_int_q[1] ? _006_ : _010_;
  assign denorm_shamt = mid_pipe_dst_is_int_q[1] ? _003_ : _011_;
  assign preshift_mant = mid_pipe_dst_is_int_q[1] ? { mid_pipe_input_mant_q[52:0], 54'h00000000000000 } : _007_;
  assign final_exp = mid_pipe_dst_is_int_q[1] ? mid_pipe_dest_exp_q[11:0] : _004_;
  assign fp_round_sticky_bits[0] = | destination_mant[52:0];
  assign int_round_sticky_bits[0] = | destination_mant[105:0];
  assign _073_ = | destination_mant[53:0];
  assign int_regular_status[0] = | destination_mant;
  assign busy_o = | { mid_pipe_valid_q[1], inp_pipe_valid_q[1], in_valid_i };
  wire [211:0] _285_ = 212'hfffffffffffffffffffffffffffffffffffffffffffffffffffff;
  assign int_value = _285_[$signed(_015_) +: 53];
  wire [264:0] _286_ = { 159'h7fffffffffffffffffffffffffffffffffffffff, fmt_mantissa[105], inp_pipe_operands_q[51:0], 53'h1fffffffffffff };
  assign _074_ = _286_[$signed(_016_) +: 53];
  wire [59:0] _287_ = { 37'h1ffffffffe, inp_pipe_operands_q[62:52], 12'hfff };
  assign src_exp = _287_[$signed({ _017_[31:2], 2'h0 }) +: 12];
  wire [39:0] _288_ = { 24'hffffff, fmt_mantissa[105], info[14:8], 8'hff };
  assign src_subnormal[0] = _288_[$signed(_026_) +: 1];
  wire [59:0] _289_ = 60'hfffffffff000fff;
  assign src_offset = _289_[$signed({ _017_[31:2], 2'h0 }) +: 12];
  wire [4:0] _290_ = { 3'h7, inp_pipe_operands_q[63], 1'h1 };
  assign _075_ = _290_[inp_pipe_src_fmt_q[2:0] +: 1];
  wire [39:0] _291_ = { 24'hffffff, fmt_mantissa[105], info[14:8], 8'hff };
  assign sv2v_tmp_48E57 = _291_[$signed({ 26'h0000000, inp_pipe_src_fmt_q[2:0], 3'h0 }) +: 8];
  wire [319:0] _292_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _076_ = _292_[$signed(_085_) +: 32];
  wire [319:0] _293_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _000_ = _293_[$signed(_084_) +: 32];
  wire [319:0] _294_ = { 193'h1fffffffffffffffffffffffffffffffffffffffffffffffe, final_exp[10:0], destination_mant[105:54], 64'hffffffffffffffff };
  assign _077_ = _294_[$signed({ 23'h000000, mid_pipe_dst_fmt_q[2:0], 6'h00 }) +: 64];
  wire [4:0] _295_ = { 3'h7, fmt_uf_after_round[1], 1'h1 };
  assign uf_after_round = _295_[mid_pipe_dst_fmt_q[2:0] +: 1];
  wire [4:0] _296_ = { 3'h7, fmt_of_after_round[1], 1'h1 };
  assign of_after_round = _296_[mid_pipe_dst_fmt_q[2:0] +: 1];
  wire [319:0] _297_ = { 192'hffffffffffffffffffffffffffffffffffffffffffffffff, \gen_special_results[1].active_format.special_results.special_res , 64'hffffffffffffffff };
  assign fp_special_result = _297_[$signed({ 23'h000000, mid_pipe_dst_fmt_q[2:0], 6'h00 }) +: 64];
  wire [255:0] _298_ = 256'hffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
  assign int_special_result = _298_[$signed({ 24'h000000, mid_pipe_int_fmt_q[1:0], 6'h00 }) +: 64];
  wire [319:0] _299_ = { 192'hffffffffffffffffffffffffffffffffffffffffffffffff, fmt_result[127:64], 64'hffffffffffffffff };
  assign _078_ = _299_[$signed({ 23'h000000, mid_pipe_dst_fmt_q[2:0], 6'h00 }) +: 64];
  wire [319:0] _300_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _079_ = _300_[$signed(_086_) +: 32];
  wire [319:0] _301_ = 320'h00000008000000170000000b00000034000000050000000a00000005000000020000000800000007;
  assign _080_ = _301_[$signed(_087_) +: 32];
  assign _081_ = $signed(32'd1) << _090_;
  assign _082_ = $signed(32'd1) << _092_;
  assign input_mant = encoded_mant << renorm_shamt;
  assign _083_ = $signed(32'd1) << _076_;
  assign destination_mant = preshift_mant >> denorm_shamt;
  assign _085_ = _019_ - 32'd32;
  assign _084_ = _018_ - 32'd32;
  assign _086_ = _020_ - 32'd32;
  assign _087_ = _021_ - 32'd32;
  assign { _088_[31:26], _048_[31:6] } = 32'd4 - mid_pipe_dst_fmt_q[2:0];
  assign { _089_[31:26], _049_[31:6] } = 32'd4 - inp_pipe_src_fmt_q[2:0];
  assign _090_ = _079_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3749$4308.$result  = $signed(_081_) - $signed(32'd1);
  assign { _091_[31:26], _050_[31:6] } = 32'd4 - inp_pipe_dst_fmt_q[2:0];
  assign _092_ = _080_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3776$4309.$result  = $signed(_082_) - $signed(32'd1);
  assign _093_ = _027_ - \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3749$4308.$result [11:0];
  assign _094_ = _093_ - { 1'h0, renorm_shamt };
  assign { _095_[31:12], int_input_exp } = 32'd52 - { 1'h0, renorm_shamt };
  assign _096_ = 32'd52 - _000_;
  assign _097_ = 32'd4294967295 - mid_pipe_input_exp_q[11:0];
  assign _098_ = _005_ - 32'd1;
  assign _099_ = $signed(_083_) - $signed(32'd1);
  assign _100_ = $signed(_083_) - $signed(32'd2);
  assign _101_ = _030_ - mid_pipe_dest_exp_q[11:0];
  assign _102_ = in_ready_o ? in_valid_i : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _102_;
  assign int_mantissa = int_sign ? _051_ : int_value;
  assign encoded_mant = src_is_int ? int_mantissa : _074_;
  assign input_sign = src_is_int ? int_sign : _075_;
  ...
  assign pre_round_abs = mid_pipe_dst_is_int_q[1] ? int_special_result : _077_;
  assign fmt_result[127:64] = _033_ ? 64'h0000000000000000 : { rounded_sign, rounded_abs[62:0] };
  assign rounded_int_res = rounded_sign ? _053_ : rounded_abs;
  ...
  assign fp_regular_status[0] = mid_pipe_src_is_int_q[1] ? _073_ : _067_;
  assign fp_result = fp_result_is_special ? fp_special_result : _078_;
  ...
  assign extension_bit_o = mid_pipe_dst_is_int_q[1] ? int_result[63] : 1'h1;
  ...
  assign _028_[11:0] = mid_pipe_dest_exp_q[23:12];
  assign _048_[5:0] = 6'h00;
  assign _049_[5:0] = 6'h00;
  assign _050_[5:0] = 6'h00;
  assign _088_[25:0] = _048_[31:6];
  assign _089_[25:0] = _049_[31:6];
  assign _091_[25:0] = _050_[31:6];
  assign _095_[11:0] = int_input_exp;
  ...
  assign \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3749$4448.fmt  = 3'hx;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3776$4449.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3985$4322.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3986$4323.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_D2l2s.preprocessed.v:3976$4316.ifmt  = 2'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3970$4315.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3990$4324.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3995$4325.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_D2l2s.preprocessed.v:3997$4326.fmt  = 3'hx;
  ...
  assign src_bias = \fpnew_pkg_bias$func$FPNewBlackbox_D2l2s.preprocessed.v:3749$4308.$result [11:0];
...
, busy_o);
  ...
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$2190.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$2191.fmt ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$598.$result ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$599.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7334$2192.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7334$2193.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1013.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1110.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1207.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1785.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1882.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1979.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7473$1280.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7473$2052.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7470$1241.ifmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7470$2013.ifmt ;
  wire \gen_num_lanes[0].active_lane.in_valid ;
  wire [191:0] \gen_num_lanes[0].active_lane.local_operands ;
  wire [63:0] \gen_num_lanes[0].active_lane.op_result ;
  wire [4:0] \gen_num_lanes[0].active_lane.op_status ;
  ...
  wire [8:0] \target_regs.byp_pipe_aux_q ;
  wire [0:2] \target_regs.byp_pipe_ready ;
  wire [0:2] \target_regs.byp_pipe_valid_q ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$598.$result  = _012_ + 32'd1;
  assign _015_ = _034_ + _035_;
  assign _013_ = { _024_[31:6], 6'h00 } + 32'd63;
  assign _014_ = { _024_[31:6], 6'h00 } + 32'd31;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$599.$result  = _015_ + 32'd1;
  assign _016_ = \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$599.$result  + 32'd32;
  ...
  assign is_up_cast = \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$598.$result  > \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$599.$result ;
  ...
  assign _036_ = operands_i[127:0] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$599.$result ;
  ...
  \$paramod$1e8f8b69f5d743788e1fca06c5ecf89639a79a5f\fpnew_cast_multi_BB75A_A18A7  \gen_num_lanes[0].active_lane.genblk1.genblk1.genblk1.lane_instance.i_fpnew_cast_multi  (
  ...
  \$paramod$1e8f8b69f5d743788e1fca06c5ecf89639a79a5f\fpnew_cast_multi_BB75A_A18A7  \gen_num_lanes[1].active_lane.genblk1.genblk1.genblk1.lane_instance.i_fpnew_cast_multi  (
    .aux_i({ dst_fmt_is_int, vectorial_op_i, dst_fmt }),
    .aux_o(lane_aux[9:5]),
    .busy_o(lane_busy[1]),
    .clk_i(clk_i),
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$2190.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$2191.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7334$2192.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7334$2193.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1013.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1110.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1207.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1785.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1882.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$1979.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7473$1280.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7473$2052.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7470$1241.ifmt  = 2'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7470$2013.ifmt  = 2'hx;
  assign \gen_num_lanes[0].active_lane.in_valid  = in_valid_i;
  ...
  assign \target_regs.byp_pipe_aux_q [6] = dst_is_cpk;
  assign \target_regs.byp_pipe_ready [2] = \gen_num_lanes[1].active_lane.out_ready ;
...
module \$paramod$424cd87dd6fb01d457bc51999ae3da8810854b04\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  ...
  \$paramod$1d23ede96667e057a8938607f03d7f88deff6827\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[1].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
, busy_o);
  ...
  wire flush_i;
  wire [639:0] fmt_slice_result;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$2772.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$3955.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$3956.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7334$3957.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7334$3958.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$3186.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$3283.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$3770.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$3867.fmt ;
  wire \gen_num_lanes[0].active_lane.in_valid ;
  wire [127:0] \gen_num_lanes[0].active_lane.local_operands ;
  wire [63:0] \gen_num_lanes[0].active_lane.op_result ;
  wire [4:0] \gen_num_lanes[0].active_lane.op_status ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$2772.$result  = _04_ + 32'd1;
  assign \gen_num_lanes[1].active_lane.in_valid  = in_valid_i & vectorial_op_i;
  assign \gen_num_lanes[1].active_lane.out_ready  = out_ready_i & lane_aux[3];
  assign lane_out_valid[1] = \gen_num_lanes[1].active_lane.out_valid  & lane_aux[3];
  assign status_o = lane_status[4:0] | lane_status[9:5];
  ...
  assign { _10_[127:64], \gen_num_lanes[1].active_lane.local_operands [63:0] } = operands_i[127:0] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$2772.$result ;
  assign { _11_[127:64], \gen_num_lanes[1].active_lane.local_operands [127:64] } = operands_i[255:128] >> \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$2772.$result ;
  ...
  \$paramod$029cea825487e9968d2e5675ba5c1594062a8cd3\fpnew_divsqrt_multi_1A2E7_2C16F  \gen_num_lanes[0].active_lane.genblk1.lane_instance.i_fpnew_divsqrt_multi  (
  ...
  \$paramod$029cea825487e9968d2e5675ba5c1594062a8cd3\fpnew_divsqrt_multi_1A2E7_2C16F  \gen_num_lanes[1].active_lane.genblk1.lane_instance.i_fpnew_divsqrt_multi  (
    .aux_i({ 1'h0, vectorial_op_i, dst_fmt_i }),
    .aux_o(lane_aux[9:5]),
    .busy_o(lane_busy[1]),
    .clk_i(clk_i),
  ...
  assign { fmt_slice_result[639:544], fmt_slice_result[542:0] } = { extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, \gen_num_lanes[1].local_result , \gen_num_lanes[0].local_result , extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], fmt_slice_result[543], extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o, extension_bit_o };
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$3955.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7333$3956.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7334$3957.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7334$3958.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$3186.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$3283.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$3770.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_D2l2s.preprocessed.v:7466$3867.fmt  = 3'hx;
  assign \gen_num_lanes[0].active_lane.in_valid  = in_valid_i;
  assign \gen_num_lanes[0].active_lane.local_operands  = { operands_i[191:128], operands_i[63:0] };
  assign \gen_num_lanes[0].active_lane.out_ready  = out_ready_i;
...
module \$paramod$4dffaaa76975fa9a810a1a53bbd409e4982e6ede\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D2l2s.preprocessed.v:327$506.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D2l2s.preprocessed.v:327$507.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D2l2s.preprocessed.v:347$504.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_D2l2s.preprocessed.v:347$505.inp ;
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D2l2s.preprocessed.v:327$506.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D2l2s.preprocessed.v:327$507.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D2l2s.preprocessed.v:347$504.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_D2l2s.preprocessed.v:347$505.inp  = 2'hx;
endmodule
...
module \$paramod$62b97f2c24fbd0ec64efd8c0255d5867594e9cd9\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:149$2545.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:149$2546.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2529.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2530.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2539.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2540.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2541.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2542.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2543.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2544.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2529.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2530.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2530.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2529.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2529.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2530.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:149$2545.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:149$2546.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2529.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2530.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2539.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2540.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2541.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2542.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2543.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_D2l2s.preprocessed.v:169$2544.inp  = 3'hx;
endmodule
...
module \$paramod$6313957f3f8e5ac0edbd3470c2d5deb9a757f657\fpnew_noncomp_8EF6A_8033C (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, class_mask_o, is_class_o, tag_o, aux_o, out_valid_o, out_ready_i
, busy_o);
  wire _000_;
  wire _001_;
  wire [63:0] _002_;
  ...
  assign _016_ = operand_a_smaller & _030_;
  assign \gen_output_pipeline[0].reg_ena  = inp_pipe_ready[1] & inp_pipe_valid_q[1];
  reg [3:0] _058_;
  always @(posedge clk_i, negedge rst_ni)
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_output_pipeline[0].reg_ena ) _059_ <= inp_pipe_tag_q[1:0];
  assign out_pipe_tag_q[1:0] = _059_;
  reg [63:0] _060_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _060_ <= 64'h0000000000000000;
    else if (\gen_output_pipeline[0].reg_ena ) _060_ <= result_d;
  assign out_pipe_result_q[63:0] = _060_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_017_) \inp_pipe_valid_q_reg[0]  <= _000_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[0] ;
  reg \out_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \out_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_018_) \out_pipe_valid_q_reg[0]  <= _001_;
  assign out_pipe_valid_q[1] = \out_pipe_valid_q_reg[0] ;
  reg [9:0] _067_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _067_ <= 10'h200;
    else if (\gen_output_pipeline[0].reg_ena ) _067_ <= class_mask_d;
  assign out_pipe_class_mask_q[9:0] = _067_;
  reg \inp_pipe_aux_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_aux_q_reg[0]  <= 1'h0;
    else if (\gen_input_pipeline[0].reg_ena ) \inp_pipe_aux_q_reg[0]  <= aux_i;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[0].reg_ena ) _069_ <= tag_i;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_output_pipeline[0].reg_ena ) \out_pipe_aux_q_reg[0]  <= inp_pipe_aux_q[1];
  assign out_pipe_aux_q[1] = \out_pipe_aux_q_reg[0] ;
  reg [4:0] _073_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _073_ <= 5'h00;
    else if (\gen_output_pipeline[0].reg_ena ) _073_ <= status_d;
  assign out_pipe_status_q[4:0] = _073_;
  ...
  assign _023_ = inp_pipe_operands_q[63:0] == inp_pipe_operands_q[127:64];
  assign _024_ = info_q[5] && info_q[13];
  assign _025_ = info_q[3] && info_q[11];
  assign operands_equal = _023_ || _024_;
  assign _026_ = inp_pipe_operands_q[63] || inp_pipe_operands_q[127];
  assign _027_ = inp_pipe_operands_q[63:0] < inp_pipe_operands_q[127:64];
  assign _028_ = ~ inp_pipe_valid_q[1];
  assign _029_ = ~ \sign_injections.sign_b ;
  assign _030_ = ~ { 63'h0000000000000000, operands_equal };
  assign _031_ = ~ out_pipe_valid_q[1];
  assign in_ready_o = inp_pipe_ready[1] | _028_;
  assign _032_ = operand_a_smaller | operands_equal;
  assign inp_pipe_ready[1] = out_ready_i | _031_;
  function [0:0] _093_;
    input [0:0] a;
    input [1:0] b;
    input [1:0] s;
  ...
  assign result_d = _096_(64'h8010000000000001, { sgnj_result, minmax_result, cmp_result }, { _034_, _035_, _033_ });
  assign _033_ = inp_pipe_op_q[3:0] == 4'h8;
  assign _035_ = inp_pipe_op_q[3:0] == 4'h7;
  assign _034_ = inp_pipe_op_q[3:0] == 4'h6;
  assign _014_ = info_q[3] ? _047_ : 10'h200;
  assign _011_ = info_q[4] ? _046_ : _014_;
  assign _007_ = info_q[5] ? _045_ : _011_;
  assign _003_ = info_q[6] ? _044_ : _007_;
  assign class_mask_d = info_q[7] ? _043_ : _003_;
  assign _015_ = any_operand_nan ? { 63'h0000000000000000, inp_pipe_op_mod_q[1] } : _052_;
  assign _012_ = any_operand_nan ? 64'h0000000000000000 : _051_;
  assign _009_ = any_operand_nan ? 1'h1 : 1'h0;
  assign _008_ = any_operand_nan ? 64'h0000000000000000 : _050_;
  assign _005_ = _022_ ? _009_ : 1'h0;
  function [63:0] _110_;
    input [63:0] a;
    input [191:0] b;
    input [2:0] s;
  ...
  assign _004_ = _110_(64'h8010000000000001, { _008_, _012_, _015_ }, { _038_, _037_, _036_ });
  assign cmp_status[4] = signalling_nan ? 1'h1 : _005_;
  assign cmp_result = signalling_nan ? 64'h0000000000000000 : _004_;
  function [63:0] _113_;
    input [63:0] a;
    input [127:0] b;
    input [1:0] s;
  ...
  assign _013_ = _113_(64'h8010000000000001, { _041_, _042_ }, { _038_, _037_ });
  assign _010_ = info_q[11] ? inp_pipe_operands_q[63:0] : _013_;
  assign _006_ = info_q[3] ? inp_pipe_operands_q[127:64] : _010_;
  assign minmax_result = _025_ ? 64'h7ff0000000000000 : _006_;
  function [0:0] _117_;
    input [0:0] a;
    input [3:0] b;
    input [3:0] s;
  ...
  assign sgnj_result[63] = _117_(1'h1, { \sign_injections.sign_b , _029_, _049_, inp_pipe_operands_q[63] }, { _038_, _037_, _036_, _039_ });
  function [62:0] _118_;
    input [62:0] a;
    input [125:0] b;
    input [1:0] s;
  ...
  assign sgnj_result[62:0] = _118_(63'h0010000000000001, { _002_[62:0], inp_pipe_operands_q[62:0] }, { _020_, _039_ });
  assign _039_ = inp_pipe_rnd_mode_q[2:0] == 3'h3;
  assign _036_ = inp_pipe_rnd_mode_q[2:0] == 3'h2;
  assign _037_ = inp_pipe_rnd_mode_q[2:0] == 3'h1;
  assign _038_ = ! inp_pipe_rnd_mode_q[2:0];
  assign _002_ = info_q[0] ? inp_pipe_operands_q[63:0] : 64'h7ff0000000000000;
  assign any_operand_nan = | { info_q[11], info_q[3] };
  assign signalling_nan = | { info_q[10], info_q[2] };
  assign busy_o = | { out_pipe_valid_q[1], inp_pipe_valid_q[1], in_valid_i };
  assign _040_ = in_ready_o ? in_valid_i : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _040_;
  assign sgnj_extension_bit = inp_pipe_op_mod_q[1] ? sgnj_result[63] : 1'h1;
  assign _041_ = operand_a_smaller ? inp_pipe_operands_q[63:0] : inp_pipe_operands_q[127:64];
  assign _042_ = operand_a_smaller ? inp_pipe_operands_q[127:64] : inp_pipe_operands_q[63:0];
  assign _043_ = inp_pipe_operands_q[63] ? 10'h002 : 10'h040;
  assign _044_ = inp_pipe_operands_q[63] ? 10'h004 : 10'h020;
  assign _045_ = inp_pipe_operands_q[63] ? 10'h008 : 10'h010;
  assign _046_ = inp_pipe_operands_q[63] ? 10'h001 : 10'h080;
  assign _047_ = info_q[2] ? 10'h100 : 10'h200;
  assign _048_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _048_;
  assign operand_a_smaller = _027_ ^ _026_;
  assign _049_ = \sign_injections.sign_a  ^ \sign_injections.sign_b ;
  assign _050_ = _032_ ^ inp_pipe_op_mod_q[1];
  assign _051_ = _016_ ^ inp_pipe_op_mod_q[1];
  assign _052_ = operands_equal ^ inp_pipe_op_mod_q[1];
  ...
  assign out_pipe_aux_q[0] = inp_pipe_aux_q[1];
  assign out_pipe_class_mask_q[19:10] = class_mask_d;
  assign out_pipe_extension_bit_q[0] = extension_bit_d;
  assign out_pipe_is_class_q[0] = is_class_d;
  assign out_pipe_ready = { inp_pipe_ready[1], out_ready_i };
  assign out_pipe_result_q[127:64] = result_d;
  assign out_pipe_status_q[9:5] = status_d;
  assign out_pipe_tag_q[3:2] = inp_pipe_tag_q[1:0];
  assign out_pipe_valid_q[0] = inp_pipe_valid_q[1];
  assign out_valid_o = out_pipe_valid_q[1];
  assign result_o = out_pipe_result_q[63:0];
...
module \$paramod$d10ac9f5cba08fed6e99c32b98579afabc6ddc73\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire _01_;
  wire _02_;
  ...
  \$paramod$4066713e3a5336d4108804af5a02e39468f1cad8\fpnew_opgroup_multifmt_slice_607F1_85D30  \gen_merged_slice.i_multifmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .extension_bit_o(fmt_outputs[138]),
...
module \$paramod$e1945c10e82c3ae2ee25c152581b240291e0c431\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  \$paramod$f60b87b2095f99ef7cbd83bd50160c8a810690c6\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$424cd87dd6fb01d457bc51999ae3da8810854b04\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$d10ac9f5cba08fed6e99c32b98579afabc6ddc73\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
...
module \$paramod$f60b87b2095f99ef7cbd83bd50160c8a810690c6\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire _01_;
  wire _02_;
  ...
  assign _03_ = _12_[$signed({ _00_[31:1], 1'h0 }) +: 2];
  assign { _04_[31], _00_[31:1] } = 32'd4 - dst_fmt_i;
  \$paramod$449c9ed29f8ff9783f347592baf8611cf93b143c\fpnew_opgroup_multifmt_slice_607F1_85D30  \gen_merged_slice.i_multifmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .extension_bit_o(fmt_outputs[138]),
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$e1945c10e82c3ae2ee25c152581b240291e0c431\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
...
module norm_div_sqrt_mvp(Mant_in_DI, Exp_in_DI, Sign_in_DI, Div_enable_SI, Sqrt_enable_SI, Inf_a_SI, Inf_b_SI, Zero_a_SI, Zero_b_SI, NaN_a_SI, NaN_b_SI, SNaN_SI, RM_SI, Full_precision_SI, FP32_SI, FP64_SI, FP16_SI, FP16ALT_SI, Result_DO, Fflags_SO);
  ...
  assign Mant_roundUp_S = _284_(1'h0, { _120_, _097_, _098_ }, { _139_, _138_, _137_ });

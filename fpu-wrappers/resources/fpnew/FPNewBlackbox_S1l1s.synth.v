...
module \$paramod$1ec311d8bbb78d5b213c030ce705238a3ade6dbb\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:149$1604.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:149$1605.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1588.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1589.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1598.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1599.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1600.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1601.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1602.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1603.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1588.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1589.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1589.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1588.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1588.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1589.$result [1:0], idx_o };
  ...
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:149$1604.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:149$1605.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1588.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1589.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1598.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1599.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1600.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1601.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1602.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l1s.preprocessed.v:169$1603.inp  = 3'hx;
endmodule

module \$paramod$2161f2878f587c71b1cb6fb04d7bde04162d1249\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire _01_;
  wire _02_;
  ...
  \$paramod$85515075752fb2f85e514ef0daa9f4478d8c1bbc\fpnew_opgroup_multifmt_slice_607F1_85D30  \gen_merged_slice.i_multifmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .extension_bit_o(fmt_outputs[2]),
...
module \$paramod$4b918de69dcd218cd5910703264e623352cb07ac\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l1s.preprocessed.v:327$486.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l1s.preprocessed.v:327$487.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l1s.preprocessed.v:347$484.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l1s.preprocessed.v:347$485.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l1s.preprocessed.v:327$486.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l1s.preprocessed.v:327$487.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l1s.preprocessed.v:347$484.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l1s.preprocessed.v:347$485.inp  = 2'hx;
endmodule
...
module \$paramod$85515075752fb2f85e514ef0daa9f4478d8c1bbc\fpnew_opgroup_multifmt_slice_607F1_85D30 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire [31:0] _01_;
  wire [31:0] _02_;
  ...
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$1366.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$1367.fmt ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$578.$result ;
  wire [31:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$579.$result ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7334$1368.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7334$1369.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$1090.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$1187.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$993.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7473$1260.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7470$1221.ifmt ;
  wire \gen_num_lanes[0].active_lane.in_valid ;
  wire [95:0] \gen_num_lanes[0].active_lane.local_operands ;
  wire [31:0] \gen_num_lanes[0].active_lane.op_result ;
  wire [4:0] \gen_num_lanes[0].active_lane.op_status ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$578.$result  = _08_ + 32'd1;
  assign _11_ = _22_ + _23_;
  assign _10_ = { _17_[31:6], 6'h00 } + 32'd31;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$579.$result  = _11_ + 32'd1;
  assign _09_ = { _17_[31:6], 6'h00 } + 32'd63;
  assign dst_fmt_is_int = op_i == 4'hb;
  assign _12_ = op_i == 4'hc;
  assign _13_ = op_i == 4'ha;
  assign is_up_cast = \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$578.$result  > \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$579.$result ;
  ...
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$1366.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$1367.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7334$1368.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7334$1369.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$1090.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$1187.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$993.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7473$1260.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7470$1221.ifmt  = 2'hx;
  assign \gen_num_lanes[0].active_lane.in_valid  = in_valid_i;
...
, out_ready_i, busy_o);
  ...
  wire [4:0] fp_status;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3749$2665.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3749$2805.fmt ;
  wire [31:0] \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3776$2666.$result ;
  wire [2:0] \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3776$2806.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3985$2679.fmt ;
  wire [2:0] \fpnew_pkg_exp_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3986$2680.fmt ;
  wire [1:0] \fpnew_pkg_int_width$func$FPNewBlackbox_S1l1s.preprocessed.v:3976$2673.ifmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3970$2672.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3990$2681.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3995$2682.fmt ;
  wire [2:0] \fpnew_pkg_man_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3997$2683.fmt ;
  ...
  assign { _027_[31:9], mid_pipe_dest_exp_q[17:9] } = $signed(input_exp) + $signed(\fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3776$2666.$result );
  ...
  assign \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3749$2665.$result  = $signed(_078_) - $signed(32'd1);
  assign { _088_[31:26], _048_[31:6] } = 32'd4 - dst_fmt_i;
  assign _089_ = _077_ - 32'd1;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3776$2666.$result  = $signed(_079_) - $signed(32'd1);
  assign _090_ = _026_ - \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3749$2665.$result [8:0];
  ...
  assign \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3749$2805.fmt  = 3'hx;
  assign \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3776$2806.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3985$2679.fmt  = 3'hx;
  assign \fpnew_pkg_exp_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3986$2680.fmt  = 3'hx;
  assign \fpnew_pkg_int_width$func$FPNewBlackbox_S1l1s.preprocessed.v:3976$2673.ifmt  = 2'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3970$2672.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3990$2681.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3995$2682.fmt  = 3'hx;
  assign \fpnew_pkg_man_bits$func$FPNewBlackbox_S1l1s.preprocessed.v:3997$2683.fmt  = 3'hx;
  ...
  assign src_bias = \fpnew_pkg_bias$func$FPNewBlackbox_S1l1s.preprocessed.v:3749$2665.$result [8:0];
...
module \$paramod$8d4a3ed20d37640ce6f3b4284abbe03eb13acef1\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$197.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$41.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7876$213.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7876$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7876$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7876$261.op ;
  ...
  assign _06_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$41.$result ;
  assign _07_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$41.$result  == 2'h1;
  assign _08_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$41.$result  == 2'h2;
  assign _09_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$41.$result  == 2'h3;
  function [1:0] _32_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$41.$result  = _32_(2'h2, 6'h07, { _15_, _13_, _11_ });
  assign _13_ = | _12_;
  assign _15_ = | _14_;
  assign _11_ = | _10_;
  ...
  assign _16_ = _55_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$41.$result  +: 1];
  ...
  \$paramod$c2cc82fc1029ebc442f82eef7d2dad370c7a4c77\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$e7881d279689f67f3e7e176346bbacd985179917\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$2161f2878f587c71b1cb6fb04d7bde04162d1249\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7827$197.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7876$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7876$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7876$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l1s.preprocessed.v:7876$261.op  = 4'hx;
...
module \$paramod$c2cc82fc1029ebc442f82eef7d2dad370c7a4c77\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _00_;
  wire _01_;
  wire _02_;
  ...
  assign _03_ = _12_[$signed({ _00_[31:1], 1'h0 }) +: 2];
  assign { _04_[31], _00_[31:1] } = 32'd4 - dst_fmt_i;
  \$paramod$d5cd87b37c6ccba1e23311fa20021bdcbb419c6c\fpnew_opgroup_multifmt_slice_607F1_85D30  \gen_merged_slice.i_multifmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .extension_bit_o(fmt_outputs[2]),
...
module \$paramod$d5cd87b37c6ccba1e23311fa20021bdcbb419c6c\fpnew_opgroup_multifmt_slice_607F1_85D30 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire [31:0] _0_;
  wire [31:0] _1_;
  wire [4:0] aux_data;
  ...
  wire flush_i;
  wire [159:0] fmt_slice_result;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$2397.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$2398.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7334$2399.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7334$2400.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$2212.fmt ;
  wire [2:0] \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$2309.fmt ;
  wire \gen_num_lanes[0].active_lane.in_valid ;
  ...
  assign extension_bit_o = lane_ext_bit;
  assign fmt_slice_result = { lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, lane_ext_bit, \gen_num_lanes[0].local_result  };
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$2397.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7333$2398.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7334$2399.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7334$2400.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$2212.fmt  = 3'hx;
  assign \fpnew_pkg_fp_width$func$FPNewBlackbox_S1l1s.preprocessed.v:7466$2309.fmt  = 3'hx;
  assign \gen_num_lanes[0].active_lane.in_valid  = in_valid_i;
  assign \gen_num_lanes[0].active_lane.local_operands  = operands_i;
  assign \gen_num_lanes[0].active_lane.out_ready  = out_ready_i;
...
module \$paramod$e7881d279689f67f3e7e176346bbacd985179917\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  wire [39:0] arbiter_output;
  ...
  wire [4:0] _6_ = { 4'h0, fmt_in_ready[0] };
  assign _1_ = _6_[dst_fmt_i +: 1];
  \$paramod$f749fde19c6596e22e7fa7b7480239a34db799d0\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .extension_bit_o(fmt_outputs[2]),
    .flush_i(flush_i),
...
module \$paramod$f749fde19c6596e22e7fa7b7480239a34db799d0\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$8d4a3ed20d37640ce6f3b4284abbe03eb13acef1\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
...
module norm_div_sqrt_mvp(Mant_in_DI, Exp_in_DI, Sign_in_DI, Div_enable_SI, Sqrt_enable_SI, Inf_a_SI, Inf_b_SI, Zero_a_SI, Zero_b_SI, NaN_a_SI, NaN_b_SI, SNaN_SI, RM_SI, Full_precision_SI, FP32_SI, FP64_SI, FP16_SI, FP16ALT_SI, Result_DO, Fflags_SO);
  ...
  assign Mant_roundUp_S = _201_(1'h0, { _120_, _097_, _098_ }, { _139_, _138_, _137_ });

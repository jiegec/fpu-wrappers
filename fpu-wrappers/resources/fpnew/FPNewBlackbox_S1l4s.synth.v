...
module \$paramod$1ec311d8bbb78d5b213c030ce705238a3ade6dbb\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:149$600.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:149$601.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$584.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$585.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$594.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$595.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$596.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$597.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$598.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$599.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$584.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$585.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$585.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$584.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:149$600.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:149$601.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$584.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$585.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$594.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$595.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$596.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$597.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$598.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:169$599.inp  = 3'hx;
endmodule

module \$paramod$3adbcc95cb24e07eae5dbe87715fe076d8ee00c2\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
module \$paramod$3e485bcd3322051a1dbe5a1eafc806f2f175cf76\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [39:0] arbiter_output;
...
module \$paramod$4607ab34192b267ee8d39b74fc7bca3fe5d45abd\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
...
module \$paramod$4b918de69dcd218cd5910703264e623352cb07ac\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:327$512.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:327$513.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:347$510.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:347$511.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:327$512.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:327$513.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:347$510.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l4s.preprocessed.v:347$511.inp  = 2'hx;
endmodule
...
module \$paramod$52ab3e2f3d540d3f1c55d27e24e02ed25f8d28c5\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$212.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$55.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:8042$228.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:8042$244.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:8042$260.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:8042$276.op ;
  ...
  assign _06_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$55.$result ;
  assign _07_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$55.$result  == 2'h1;
  assign _08_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$55.$result  == 2'h2;
  assign _09_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$55.$result  == 2'h3;
  function [1:0] _32_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$55.$result  = _32_(2'h2, 6'h07, { _15_, _13_, _11_ });
  assign _11_ = | _10_;
  assign _13_ = | _12_;
  assign _15_ = | _14_;
  ...
  assign _16_ = _55_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$55.$result  +: 1];
  ...
  \$paramod$3e485bcd3322051a1dbe5a1eafc806f2f175cf76\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$3adbcc95cb24e07eae5dbe87715fe076d8ee00c2\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f72c98f11573cea369aff8afc67a89791bc02bc4\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$7b90d51dce92ca74d64f7c6e97ef9b829079a755\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7996$212.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:8042$228.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:8042$244.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:8042$260.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:8042$276.op  = 4'hx;
...
module \$paramod$7b90d51dce92ca74d64f7c6e97ef9b829079a755\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module \$paramod$f72c98f11573cea369aff8afc67a89791bc02bc4\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;

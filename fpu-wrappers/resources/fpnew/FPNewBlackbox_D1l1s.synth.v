...
module \$paramod$00d08a949a6ee2e2e719285cb6c1ac4c5748aa63\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:149$610.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:149$611.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$594.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$595.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$604.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$605.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$606.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$607.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$608.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$609.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$594.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$595.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$595.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$594.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:149$610.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:149$611.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$594.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$595.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$604.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$605.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$606.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$607.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$608.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:169$609.inp  = 3'hx;
endmodule
...
, busy_o);
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[62:52] }) + $signed({ 12'h000, _058_ });
  ...
  reg [7:0] _094_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _094_ <= 8'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _094_ <= addend_shamt;
  assign mid_pipe_add_shamt_q[7:0] = _094_;
  reg \mid_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \mid_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_029_) \mid_pipe_valid_q_reg[0]  <= _000_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _097_ <= sv2v_tmp_B4C85;
  assign mid_pipe_tent_exp_q[12:0] = _097_;
  reg [12:0] _098_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _098_ <= 13'h0000;
    else if (\gen_inside_pipeline[0].reg_ena ) _098_ <= exponent_product;
  assign mid_pipe_exp_prod_q[12:0] = _098_;
  reg [12:0] _099_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _099_ <= 13'h0000;
    else if (\gen_inside_pipeline[0].reg_ena ) _099_ <= exponent_difference;
  assign mid_pipe_exp_diff_q[12:0] = _099_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _102_ <= tag_i;
  assign mid_pipe_tag_q[1:0] = _102_;
  reg [63:0] _103_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _103_ <= 64'h0000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _103_ <= special_result;
  assign mid_pipe_spec_res_q[63:0] = _103_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _105_ <= rnd_mode_i;
  assign mid_pipe_rnd_mode_q[2:0] = _105_;
  ...
  reg [162:0] _107_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _107_ <= 163'h00000000000000000000000000000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _107_ <= mid_pipe_sum_q[325:163];
  assign mid_pipe_sum_q[162:0] = _107_;
  ...
  assign _030_ = | { _067_, _064_ };
  assign _031_ = | { _067_, _066_, _065_ };
  assign _033_ = | { _067_, _066_, _065_, _064_ };
  assign _032_ = | { _067_, _066_, _064_ };
  assign _034_ = rnd_mode_i == 3'h2;
  ...
  assign _047_ = effective_subtraction && _061_;
  ...
  assign _057_ = ~ operands_i[63];
  assign _058_ = ~ info_c[7];
  assign _059_ = ~ addend_after_shift;
  assign _060_ = ~ sticky_before_add;
  assign _061_ = ~ sum_raw[163];
  assign _062_ = ~ mid_pipe_valid_q[1];
  assign in_ready_o = out_ready_i | _062_;
  assign sticky_after_norm = _068_ | mid_pipe_sticky_q[1];
  assign regular_status[2] = of_before_round | of_after_round;
  assign _063_ = _069_ | of_before_round;
  assign regular_status[0] = _063_ | of_after_round;
  ...
  assign _011_ = _038_ ? _073_[12:0] : 13'h0000;
  ...
  assign _005_ = _050_ ? _025_[12:0] : 13'h0000;
  assign _004_ = _050_ ? _026_[7:0] : _027_[7:0];
  assign normalized_exponent = _055_ ? _005_ : mid_pipe_tent_exp_q[12:0];
  assign norm_shamt = _055_ ? _004_ : mid_pipe_add_shamt_q[7:0];
  assign _001_ = _040_ ? _071_[7:0] : 8'h00;
  assign addend_shamt = _039_ ? 8'ha3 : _001_;
  ...
  assign operand_a[63] = _180_(1'h1, { _057_, 1'h0, operands_i[63] }, { _066_, _065_, _030_ });
  function [62:0] _181_;
    input [62:0] a;
    input [125:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[10:0], mantissa_a[51:0] } = _181_(63'h0010000000000001, { 63'h3ff0000000000000, operands_i[62:0] }, { _065_, _032_ });
  assign _006_ = _034_ ? 64'h0000000000000000 : 64'h8000000000000000;
  ...
  assign info_a = _184_(8'hff, { 8'h81, info_q[7:0] }, { _065_, _032_ });
  function [63:0] _185_;
    input [63:0] a;
    input [127:0] b;
    input [1:0] s;
  ...
  assign operand_c = _185_(64'h8010000000000001, { _079_, operands_i[190:128], _006_ }, { _031_, _064_ });
  assign operand_b = _033_ ? operands_i[127:64] : 64'h8010000000000001;
  function [7:0] _187_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign info_c = _187_(8'hff, { info_q[23:16], 8'h21 }, { _031_, _064_ });
  assign _064_ = op_i == 4'h3;
  assign _065_ = op_i == 4'h2;
  assign _066_ = op_i == 4'h1;
  assign _067_ = ! op_i;
  ...
  assign _068_ = | sum_sticky_bits;
  assign _069_ = | round_sticky_bits;
  ...
  assign _070_ = _023_ - 32'd1023;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _071_ = $signed(32'd56) - $signed(exponent_difference);
  assign _072_ = $signed(mid_pipe_exp_prod_q[12:0]) - $signed({ 1'h0, leading_zero_count });
  assign _073_ = $signed(normalized_exponent) - $signed(32'd1);
  assign { _074_[31:13], exponent_product } = _054_ ? 32'd4294966275 : _070_;
  assign sv2v_tmp_B4C85 = _037_ ? exponent_addend : exponent_product;
  assign addend_shifted = effective_subtraction ? _059_ : addend_after_shift;
  assign { _075_[163], mid_pipe_sum_q[325:163] } = _047_ ? _056_ : sum_raw;
  assign _076_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign final_sign = _048_ ? 1'h1 : _076_;
  assign _077_ = in_ready_o ? in_valid_i : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _077_;
  assign { _078_[31:11], pre_round_abs[62:52] } = of_before_round ? 32'd2046 : { 21'h000000, final_exponent[10:0] };
  ...
  assign _079_ = operands_i[191] ^ op_mod_i;
  ...
  assign _074_[12:0] = exponent_product;
  assign _075_[162:0] = mid_pipe_sum_q[325:163];
  assign _078_[10:0] = pre_round_abs[62:52];
...
module \$paramod$49a7d07c04b7fb32f05e86c20c7129468babc152\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$786e72a629feca8ebb141cbe1e8360b55817b767\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$b67c46536067e94415cc6c2226b66b183800d33d\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:327$522.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:327$523.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:347$520.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:347$521.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:327$522.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:327$523.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:347$520.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D1l1s.preprocessed.v:347$521.inp  = 2'hx;
endmodule
...
module \$paramod$d5aad8ad851046901df1dd49fbf1e254716d9ec5\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$d5b9c9b54becef5d82660258e6426947892218c5\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$213.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$55.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:8042$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:8042$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:8042$261.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:8042$277.op ;
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$55.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$55.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$55.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$55.$result  == 2'h3;
  assign _18_ = | _17_;
  assign _14_ = | _13_;
  assign _16_ = | _15_;
  function [1:0] _41_;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$55.$result  = _41_(2'h2, 6'h07, { _18_, _16_, _14_ });
  ...
  assign _19_ = _64_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$55.$result  +: 1];
  ...
  \$paramod$00d08a949a6ee2e2e719285cb6c1ac4c5748aa63\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$d5aad8ad851046901df1dd49fbf1e254716d9ec5\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$49a7d07c04b7fb32f05e86c20c7129468babc152\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$786e72a629feca8ebb141cbe1e8360b55817b767\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:7996$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:8042$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:8042$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:8042$261.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D1l1s.preprocessed.v:8042$277.op  = 4'hx;

...
module FMA_S(clk, A, B, C, negateAB, negateC, RndMode, R);
  reg _000_;
  reg [8:0] _001_;
  wire _002_;
  wire _003_;
  ...
  wire [5:0] \ieeefma_8_23_f250_uid2leadingzerocounter:636 ;
  wire [30:0] inf;
  wire [30:0] inf_d1;
  wire [30:0] inf_d2;
  wire [30:0] inf_d3;
  ...
  always @(posedge clk)
    _278_ <= paligned;
  lzc_52_f250_uid6 ieeefma_8_23_f250_uid2leadingzerocounter (
    .clk(clk),
    .i(bigsumabslowerbits),
    .o(_201_)
  );
  leftshifter76_by_max_75_f250_uid8 normalizationshifter (
    .clk(clk),
    .r(_227_),
    .s(normshiftvalue),
    .x(bigsumabs)
  );
  rightshifter24_by_max_76_f250_uid4 rightshiftercomponent (
    .clk(clk),
    .r(_160_),
    .s(shiftvalue),
    .x(csig)
  ...
  assign l = \ieeefma_8_23_f250_uid2leadingzerocounter:636 ;
  ...
  assign \ieeefma_8_23_f250_uid2leadingzerocounter:636  = _201_;
  assign \normalizationshifter:700  = _227_;
  assign R = _336_;
endmodule

module leftshifter76_by_max_75_f250_uid8(clk, x, s, r);
  reg [6:0] _00_;
  reg [6:0] _01_;
  reg [75:0] _02_;
  reg [82:0] _03_;
  ...
  assign _06_ = ps[1] ? { level1, 2'h0 } : { 2'h0, level1 };
  assign _07_ = ps[2] ? { level2, 4'h0 } : { 4'h0, level2 };
  assign _08_ = ps_d1[3] ? { level3_d1, 8'h00 } : { 8'h00, level3_d1 };
...
module lzc_52_f250_uid6(clk, i, o);
  reg _00_;
  reg _01_;
  reg _02_;
  reg [6:0] _03_;
  ...
  always @(posedge clk)
    _03_ <= level3;
  assign _04_ = level6[62:31] == 32'd0;
  assign _05_ = _04_ ? 1'h1 : 1'h0;
  assign _06_ = digit5 ? level6[30:0] : level6[62:32];
  assign _07_ = level5[30:15] == 16'h0000;
  assign _08_ = _07_ ? 1'h1 : 1'h0;
  assign _09_ = digit4 ? level5[14:0] : level5[30:16];
  assign _10_ = level4[14:7] == 8'h00;
  assign _11_ = _10_ ? 1'h1 : 1'h0;
  assign _12_ = digit3 ? level4[6:0] : level4[14:8];
  assign _13_ = level3_d1[6:3] == 4'h0;
  assign _14_ = _13_ ? 1'h1 : 1'h0;
  assign _15_ = digit2 ? level3_d1[2:0] : level3_d1[6:4];
  assign _16_ = level2 == 3'h0;
  assign _17_ = level2 == 3'h1;
  assign _18_ = level2 == 3'h2;
  assign _19_ = level2 == 3'h3;
  function [1:0] \1111 ;
    input [1:0] a;
    input [7:0] b;
    input [3:0] s;
  ...
  assign _20_ = \1111 (2'h0, 8'h5b, { _19_, _18_, _17_, _16_ });
...
module rightshifter24_by_max_76_f250_uid4(clk, x, s, r);
  reg [6:0] _0_;
  reg [54:0] _1_;
  wire [24:0] _2_;
  wire [26:0] _3_;
